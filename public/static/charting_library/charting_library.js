!(function (e, t) {
	...
	(e.ActionId = void 0),
		...
		(($ = e.OrderTicketFocusControl || (e.OrderTicketFocusControl = {}))[($.LimitPrice = 1)] = 'LimitPrice'),
		...
		((Z = e.OrderOrPositionMessageType || (e.OrderOrPositionMessageType = {})).Information = 'information'),
		(Z.Warning = 'warning'),
		(Z.Error = 'error'),
		(function (e) {
		...
		((ue = e.TradedGroupHorizontalAlignment || (e.TradedGroupHorizontalAlignment = {}))[(ue.Left = 0)] = 'Left'),
	...
	'undefined' != typeof window && ((window.TradingView = window.TradingView || {}), (window.TradingView.version = Fe));
	const We =
