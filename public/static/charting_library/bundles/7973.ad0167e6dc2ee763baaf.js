(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[7973],
	{
			...
			function p(e) {
				...
				return s.createElement(
					...
					s.createElement(
						...
						s.createElement('div', { className: m, style: { left: 100 * i[0].value + '%', width: `${v}%` } }, f)
					)
				);
			}
			function E(e) {
				...
				return s.createElement(
					...
					s.createElement('div', { className: r(l.timezone, a, i && l.largePadding) }, `${m}: ${n}`)
				);
			}
			!(function (e) {
		...
		53350: (e, t, n) => {
			...
			var w = n(58683);
			function k(e) {
				for ((0, m.assert)(Number.isInteger(e), 'timeMinutes expected to be integer number'); e > i.minutesPerDay; )
					e -= i.minutesPerDay;
				const t = e % 60,
					n = (e - t) / 60;
				return (0, w.numberToStringWithLeadingZero)(n, 2) + ':' + (0, w.numberToStringWithLeadingZero)(t, 2);
			}
			function P(e, t) {
				return `${e} — ${t}`;
			}
			...
			function M(e, t, n, s) {
				(0, m.assert)(
					...
					(0, m.assert)(0 !== s, 'End time expected to be normalized (00:00 as range end is not allowed)');
			...
			function W(e, t, n, s, r) {
				const [i, a] = O(e, t, r),
					[o, u] = F(n, s, r);
				(0, m.assert)(t !== n || i < o, `Days are same (${t}) but prev entry time (${i}) >= next entry time (${o})`);
				const c = l(i),
					d = l(o);
				...
				return (
					(function ({ thisDay: e, prevDay: t, nextDay: n }) {
						if (0 === e.entries.length)
							return [B((0, v.default)(t.entries), t.dayIndex, c(n.entries), n.dayIndex, e.dayIndex)];
					})(n) ??
					(function ({ thisDay: e, prevDay: t, nextDay: n }) {
						const s = e.dayIndex;
			...
			function ne(e, t) {
				const n = (function (e) {
					...
					if (void 0 === e.subsessions)
						return new Map([[0, new j.SessionsSpec(e.timezone, e.session, e.session_holidays, e.corrections)]]);
					const t = 'regular',
						n = 'premarket',
						s = 'postmarket',
						r = [t, n, s],
				...
				return (
					...
					(function (e) {
						for (const t of h) {
							...
							te(s, (0, m.ensureDefined)((0, v.default)(e[E(t)].entries))) && (s.start.isFirstOrLastPoint = !1);
