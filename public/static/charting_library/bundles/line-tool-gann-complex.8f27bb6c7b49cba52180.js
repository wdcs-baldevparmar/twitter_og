	...
	[1963],
	{
			...
			class _ extends l.DefaultProperty {
				constructor(e) {
					const { levelsIterator: t = d, map: s = {}, ...i } = e,
						r = { ...c, ...s };
					i.state && (i.state = f(i.state, r, t)), super(i), (this._map = r), (this._levelsIterator = t);
				}
				state(e, t, s) {
		...
		99083: (e, t, s) => {
			...
			class p extends o.LineDataSource {
				...
				setPoint(e, t, s) {
					super.setPoint(e, t, s), void 0 !== s && s.shift() ? this._correctPoint(e) : this._correctScaleRatio();
				}
				setLastPoint(e, t) {
				...
				levels() {
					...
					for (let i = 0; i < s; i++) {
						...
						e.push({ index: i, visible: s.visible.value(), color: s.color.value(), width: s.width.value() });
					}
					return e;
				}
				fanLinesCount() {
