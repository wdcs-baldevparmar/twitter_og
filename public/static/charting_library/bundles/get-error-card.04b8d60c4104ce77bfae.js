	...
	[139],
	{
		...
		66860: (t, e, r) => {
			...
			var o = r(50959),
				...
				c = r(1538),
				d = r.n(c);
			const u = (t) => o.createElement(n.Icon, { className: i(d().caret, t && d().activeCaret), icon: s });
			function p(t) {
				const {
					showCaret: e,
					iconOnly: r,
		...
		81200: (t, e, r) => {
			...
			const x = a.forwardRef((t, e) => {
				const { icon: r, message: o, size: i = 1, rawHtml: l = !1, doNotLimitWidth: n, solutionId: s, buttons: p } = t,
					h = a.useMemo(
						() =>
							r &&
							(function (t, e) {
				...
				return a.createElement(
					...
					{
						ref: e,
						className: c()(C.errorCard, 2 === i && C.errorCard_size_big, !n && C.errorCard_limitWidth),
