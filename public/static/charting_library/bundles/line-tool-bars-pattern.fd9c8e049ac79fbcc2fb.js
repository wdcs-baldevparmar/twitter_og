	...
	[5206],
	{
		81756: (t, e, i) => {
			...
			class w extends p.LineDataSource {
				...
				restoreData(t) {
					const { pattern: e = this._pattern, scale: i = this._scale, diff: s = this._pointsCoordinatePricesDiff } = t;
				...
				addPoint(t, e, i) {
					...
					if (s) {
						const t = this._model.mainSeries(),
							...
							s = (0, r.ensureDefined)(t.nearestIndex(Math.min(e, i), h.PlotRowSearchMode.NearestRight)),
							n = (0, r.ensureDefined)(t.nearestIndex(Math.max(e, i), h.PlotRowSearchMode.NearestLeft));
				...
				migrateVersion(t, e, i) {
					if (1 === t && this._pattern.length > 0) {
						...
						2 === this._timePoint.length && (this._timePoint[1].price = this._timePoint[0].price + t),
				...
				static createProperties(t, e) {
					const i = new l.DefaultProperty({ defaultName: 'linetoolbarspattern', state: e, theme: t });
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([i.e(6406), i.e(3889), i.e(8009), i.e(8056), i.e(8537)]).then(i.bind(i, 1847)))
						.BarsPatternDefinitionsViewModel;
				}
				static _configureProperties(t) {
					super._configureProperties(t), t.addExcludedKey('mirrored', 1), t.addExcludedKey('flipped', 1);
				}
				_calculatePatternCoordinatePricesDiff() {
					return this._pattern.length > 0
						? (this._priceCoordinateDiff([this.firstPatternPrice(), this.lastPatternPrice()]) ?? null)
						: null;
				}
				...
				_mirror() {
					...
					if (e < i) {
						...
						for (let e = 0; e < t.length; e++)
							(t[e][2] = r(t[e][2])), (t[e][3] = r(t[e][3])), (t[e][1] = r(t[e][1])), (t[e][4] = r(t[e][4]));
					}
				...
				_pricesToCoordinates(t) {
					...
					if (null !== i && null !== e && !e.isEmpty()) return t.map((t) => e.priceToCoordinate(t, i));
				}
				...
				_calculateScale() {
					...
					if (2 === this._points.length) {
						...
						if ((e && null !== i && (t = +(i / e).toFixed(8)), this._pointsCoordinatePricesDiff !== i)) {
