(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[5093],
	{
		...
		55679: (e) => {
			e.exports = { wrapper: 'wrapper-TJ9ObuLF', animated: 'animated-TJ9ObuLF', pulsation: 'pulsation-TJ9ObuLF' };
		},
		53885: (e, t, s) => {
			'use strict';
			...
			function n(e) {
				...
				return (
					...
					t && 3 !== s
						...
						: i.createElement(
								'span',
								{ className: n, title: e.title, 'aria-label': e['aria-label'], 'aria-hidden': e['aria-hidden'] },
								d
							)
				);
			}
		...
		22136: (e, t, s) => {
			...
			class X {
				constructor(e, t, s) {
					(this._widget = (0, i.ensureNotNull)((0, u.parseHtml)($).querySelector('.control-bar-wrapper'))),
						(this._controlBar = (0, i.ensureNotNull)(this._widget.querySelector('.control-bar'))),
						(this._back = (0, i.ensureNotNull)((0, u.parseHtml)(Q).querySelector('.control-bar-wrapper'))),
						...
						(this._onVisibilityTypeChange = (e) => {
							'alwaysOn' === e || 'alwaysOff' === e
								? ((this._controlBarVisible = 'alwaysOn' === e),
									this._parent.removeEventListener('mousemove', this._controlsBarVisibilityHandler, !1),
									this._parent.removeEventListener('mouseleave', this._controlsBarVisibilityHandler, !1))
								: ((this._controlBarVisible = !1),
						...
						(this._controlsBarVisibilityHandler = (e) => {
							...
							void 0 !== t && this._controlBarVisible !== t && ((this._controlBarVisible = t), this._setRAF());
						}),
						(this._updateControlBarVisibility = () => {
							...
							e.fullscreenable.subscribe(this._boundUpdateMaximizeButtonsVisibility),
								...
								this._back.querySelector('.control-bar__btn')?.addEventListener('click', () => {
									null !== this._chartModel &&
										this._chartModel.timeScale().scrollToRealtime(!0, () => this._checkBackButtonVisibility());
								});
						});
				}
				_initHandlers() {
				...
				_checkBackButtonVisibility() {
					...
					e !== this._backButtonVisible &&
						...
						this._back.querySelector('.control-bar__btn')?.classList.toggle(q, !this._backButtonVisible));
				}
				_initVisibility() {
					(this._visibilityTypeProperty = (0, n.combine)(
						...
						(0, m.getSeriesDisplayErrorWV)((0, i.ensureNotNull)(this._chartModel).mainSeries()).ownership()
					)),
						this._visibilityTypeProperty.subscribe(this._onVisibilityTypeChange, { callWithLast: !0 });
				}
						...
						_.CheckMobile.any()
							...
							: 'alwaysOn' === e || 'alwaysOff' === e
								? ((this._backButtonCanBeVisible = 'alwaysOn' === e),
									this._parent.removeEventListener('mousemove', this._visibilityBackButtonHandler, !1),
									this._parent.removeEventListener('mouseleave', this._visibilityBackButtonHandler, !1))
								: ((this._backButtonCanBeVisible = !1),
				...
				_checkIsPointerNearBox(e, t) {
					if (!(e.buttons || (null !== this._chartModel && this._chartModel.lineBeingCreated()))) {
						if ('mousemove' === e.type) {
							const s = 100 - (this._targetPaneWidget ? this._bottomMargin(this._targetPaneWidget) : 0);
							return (
				...
				_setRAF() {
					null === this._rafId &&
						(this._rafId = this._widget.ownerDocument.defaultView.requestAnimationFrame(() => {
							this._checkBackButtonVisibility(), this._updateControlBarVisibility(), (this._rafId = null);
						}));
				}
		...
		60786: (e, t, s) => {
			...
			class D {
				constructor(e, t, s) {
					(this._el = null),
						...
						(this._updateLoadingState = (e = this._loading.value()) => {
							if (null !== this._el) {
								this._el.classList.toggle(k.eyeLoading, e && !this._disabled.value()), I(this._el, e);
							}
					...
					(this._withActions = s.withActions),
						...
						this._withActions &&
							...
							(this._showActionsHandler = (0, f.wrapHandlerWithPreventEvent)(this._showActions.bind(this))),
							(this._hideActionsHandler = (0, f.wrapHandlerWithPreventEvent)(this._hideActions.bind(this))),
				...
				_renderTitles() {
					...
					for (let e = 0; e < this._titlesSpawns.length; e++) {
						...
						this._titlesWrapperEl.appendChild(t), this._titleContainers.push(t), this._titleElements.push(s);
					}
				}
				_renderTitle(e) {
				...
				_isWidthButtonsMode() {
					return (
						null !== this._el &&
						(this._el.classList.contains(k.withAction) || this._disabled.value() || this._selected.value())
					);
				}
				...
				_addStatusesWidget(e, t, s) {
					(this._statusesWrapper = document.createElement('div')),
						...
						this._hideInvisibleHover.subscribe(this._updateHideInvisibleHoverMode.bind(this), { callWithLast: !0 }),
						(this._hideValues = s),
				...
				_updateSelectedState() {
					null !== this._el && this._withActions && this._el.classList.toggle(k.selected, this._selected.value());
				}
				_updateShowTitles() {
					null !== this._titlesWrapperEl &&
				...
				_updateStatusWidgetVisibility(e) {
					null !== this._statusesWrapper && this._statusesWrapper.classList.toggle(L.blockHidden, e);
				}
			}
			var P = s(50279),
				z = s(97754),
			...
			class Z {
					...
					(this._lastDrawnLogos = []),
						...
						(this._updateSymbolLogo = async (e) => {
							if (
								...
								0 !== this._lastDrawnLogos.length && 0 !== e.length && (0, P.default)(this._lastDrawnLogos, e))
							)
								return;
							const t = await ((s = e),
							Promise.all(s.map((e) => (0, U.getImage)(`symbol_logo_${e}`, e, $).then((e) => e.cloneNode())))).catch(
								() => []
							);
							var s;
							switch (t.length) {
				...
				_renderSymbolLogo() {
					if (!this._logoWrapper) {
						...
						((this._symbolLetterContainer = e.appendChild(document.createElement('span'))).className = N()(
							(0, O.getStyleClasses)('xxxsmall'),
							k.logo
						)),
							this._updateSymbolLetter();
			...
			class K extends D {
				constructor(e, t, s) {
					super(e, t, s),
						...
						s.withActions &&
							...
							null !== this._titlesWrapperEl && this._titlesWrapperEl.addEventListener(Q, this._wheelClickHandler));
				...
				_createTitlesSpawns() {
					...
					this._titlesSpawns = [
						{ ...t.title, title: e.title.spawn(), class: k.mainTitle, titleId: 'legend-source-title' },
						{ ...t.args, title: e.args.spawn(), class: k.descTitle, titleId: 'legend-source-description' },
					];
				}
				_renderValues() {
				...
				_update5ButtonsStyles(e) {
					null !== this._el && (this._el.classList.toggle(k.has5Buttons, e), this._updateAllButtonsWidth());
				}
				_onWheelClicked(e) {
			...
			class q extends D {
				constructor(e, t, s) {
					super(e, t, s),
						...
						this._selected.subscribe(this._updateTitleMaxWidth.bind(this));
					const i = e.symbolLogoViewModel().value();
					i && (this._symbolLogoRenderer = new Z(i, (0, o.ensureNotNull)(this._titleContainers[0])));
				}
				destroy() {
				...
				_createTitlesSpawns() {
					...
					this._titlesSpawns = [
						...
						{ ...t.interval, title: e.interval.spawn(), class: k.intervalTitle, titleId: 'legend-source-interval' },
						{ ...t.provider, title: e.provider.spawn(), class: k.providerTitle, titleId: 'legend-source-provider' },
						{ ...t.exchange, title: e.exchange.spawn(), class: k.exchangeTitle, titleId: 'legend-source-exchange' },
						{ ...t.chartStyle, title: e.chartStyle.spawn(), class: k.styleTitle, titleId: 'legend-source-style' },
						{
							...t.priceSource,
				...
				_updateFlaggedState() {
					...
					(0, o.ensureNotNull)(this._el).classList.toggle(k.flagged, Boolean(this._flagged.value())),
						this._updateTitleMaxWidth();
				}
			...
			class ae {
				...
				accessibleButtons() {
					return null === this._el || (this._el.classList.contains(k.onlyOneSourceShown) && 1 !== this._mode)
						? []
						: this._accessibleButtons;
				}
				setMode(e) {
				...
				_updateThemedColor(e) {
					if (null !== this._el)
						if (e.length > 0) {
							...
							this._el.style.backgroundColor = (0, d.rgbaToString)([t, s, i, (0, d.normalizeAlphaComponent)(0.8)]);
				...
				_updateVisibility() {
					const e = this._sourceCount.value(),
						...
						i = e < 1 || (this._isPaneCollapsed.value() && (this._isMainPane.value() || this._isStateOpen.value()));
			...
			class de {
					...
					(this._mode = 4),
						...
						(this._toggleHiddenActions = (e) => {
							this._toggleHiddenActionsTimoutID &&
								(clearTimeout(this._toggleHiddenActionsTimoutID), (this._toggleHiddenActionsTimoutID = null)),
								e
				...
				destroy() {
					...
					if (de._wasKeyboardNavigationActivated && e instanceof HTMLButtonElement) {
						null !== this._getRowRendererByChild(e) && (t = (0, g.queryTabbableElements)(document.body).indexOf(e));
					}
					if (
				...
				updateMode(e) {
					const t = ne && e < 133 ? 1 : e < 205 ? 2 : e < 222 ? 3 : 4,
						s = e < 192 ? 1 : e < 442 ? 2 : 3;
					(this._mode = t), null !== this._mainDataSourceRenderer && this._mainDataSourceRenderer.updateMode(t, s);
					...
					this._parentEl.classList.toggle(k.directionColumn, i),
						this._parentEl.classList.toggle(k.hideUniportantValueItems, !_.CheckMobile.any() && e <= 272);
				}
				getMainSourceHeight() {
				...
				_onIsDataSourcesCollapsed(e) {
					...
					if (0 !== (this._mainDataSourceRenderer?.accessibleButtons() || []).filter((e) => e.tabIndex >= 0).length)
						return;
					const t = [];
				...
				_renderCollapsedCounter(e) {
					...
					t.classList.add(k.statusesWrapper),
						this._collapsedDataSourcesStatusWidgetElement.classList.add(k.statusesWrapper__statuses),
				...
				_showCollapsedDataSourcesTooltip() {
					(0, v.showOnElement)(this._collapsedDataSourcesEl, { text: this._options.collapsedDataSourcesTitle.value() }),
				...
				_updateLegendVisibility() {
					...
					if (
						...
						null !== this._dataSourcesEl &&
							this._dataSourcesEl.classList.toggle(L.blockHidden, this._isStudiesLegendHidden.value()),
						t)
					) {
				...
				_onLayoutChanged(e) {
					const { newMainSource: t, removedDataSources: s, addedDataSources: i, movedDataSources: l } = e,
					...
					if (
						...
						if (e && t) this._changeFocusElement(e, t);
							...
							(e = n === t.length ? t[0] : t[n]), e && (o && (0, m.becomeSecondaryElement)(o), e.focus());
						}
					}
				}
					...
					if (null !== a) {
						...
						void 0 !== e
							...
							: ((e = this._dataSourceRenderers[s - 1]),
								void 0 !== e && i.insertBefore(a, (0, o.ensureNotNull)(e.getElement()).nextSibling));
					}
								...
								(this._focusEventAbortController = new AbortController()),
									e.addEventListener(
										...
										(s) => {
											...
											(null !== i && i instanceof HTMLButtonElement && t.accessibleButtons().includes(i)) ||
												(this._subscribeElementToFocusEvents(e, t), t instanceof ae || t.hideActions());
										},
			...
			class Be {
				constructor(e, t) {
					(this._symbolLogoUrls = new n.WatchedValue([])),
						...
						(this._logoModel = e),
						(this._isLogoVisible = (0, xe.createWVFromGetterAndSubscription)(() => t.showLogo.value(), t.showLogo)),
			...
			class Re {
				...
				_onQuoteSymbolDataUpdated(e, t) {
					...
					!this._source.symbolSameAsCurrent(e.values.pro_name) ||
						(void 0 === s.logoid && void 0 === s['currency-logoid'] && void 0 === s['base-currency-logoid']) ||
				...
				async _onSourceSymbolChange() {
					...
					try {
						...
						this.symbol() === e && (null === t ? this._logoData.setValue(null, !0) : this._logoData.setValue(Ne(t)));
					}
				}
				...
				_createActions() {
					if (Je) {
						const e = (0, _e.convertPropertyToWatchedValue)(
								(0, ce.combineProperty)((e) => !e, this._source.properties().childs().visible.weakReference())
							),
							t = {
								icon: new Map([
									['large', Fe],
			...
			const ct = J.t(null, void 0, s(32514)),
				...
				gt = (J.t(null, void 0, s(57335)), J.t(null, void 0, s(43206)), J.t(null, void 0, s(74759))),
			...
			class ft extends Le {
				...
				onRemoveSource() {
					this._source.isUserDeletable() &&
						(this._source.hasChildren()
							? (0, tt.showDeleteStudyTreeConfirm)(this._model.removeSource.bind(this._model, this._source, !1))
						...
						if (
							...
							const s = new n.WatchedValue(this._getDisabledOnIntervalState()),
								i = {
									...
									action: (0, f.wrapHandlerWithPreventEvent)(this.onShowSettings.bind(this, De.TabNames.visibility)),
									visible: s.readonly(),
				...
				_updateSymbolLogoModel() {
					if ((this._symbolLogoViewModel.value()?.destroy(), (0, it.isSymbolSourceWithQuotesProvider)(this._source))) {
						const e = this._model.model().properties().childs().paneProperties.childs().legendProperties.childs();
			...
			const Tt = new ve.TranslatedString('change symbol description visibility', J.t(null, void 0, s(88167))),
				Ht = new ve.TranslatedString('change open market status visibility', J.t(null, void 0, s(96227))),
				Bt = new ve.TranslatedString('change chart values visibility', J.t(null, void 0, s(79637))),
				It = new ve.TranslatedString('change last day change visibility', J.t(null, void 0, s(66307))),
				Dt = new ve.TranslatedString('change bar change visibility', J.t(null, void 0, s(27426))),
				Pt = new ve.TranslatedString('change indicator titles visibility', J.t(null, void 0, s(63050))),
				zt = new ve.TranslatedString('change indicator arguments visibility', J.t(null, void 0, s(78310))),
				Nt = new ve.TranslatedString('change indicator values visibility', J.t(null, void 0, s(49583))),
				Rt = new ve.TranslatedString('change volume values visibility', J.t(null, void 0, s(96201))),
				...
				es = (e, t) => (e ? (e.dataset[t] ? e.dataset[t] : e.parentElement ? es(e.parentElement, t) : null) : null);
			s(88145);
			var ts = s(53350),
				ss = s(75725);
			class is {
				constructor(e) {
					(this._source = e), (this._fullSessionScheduleViewModel = new ts.FullSessionScheduleViewModel(e));
				}
				destroy() {
					...
					(e, t) =>
						(0, os.htmlEscape)(
							J.t(
								null,
								{
									plural: '{symbolName} data is delayed by {time} minutes because of exchange requirements.',
									count: t,
			...
			class oi extends rs {
				...
				async _getHtmls() {
					...
					for (const a of e) {
						...
						if (
							((t[e] = []),
							['DelayToRealtime', 'DelayNoRealtime', 'DelayWithoutMarketAgreement', ...ei].includes(e) &&
							...
							0,
								Gs.CRUCIAL_REALTIME_BATS.includes(this._model.listedExchange()) || l
									...
									: t[e].push(
											...
											'' !== s ? (0, os.htmlEscape)(Fs).format({ exchange: s }) : (0, os.htmlEscape)(Os)
										);
						}
					}
				...
				_getShortTexts() {
					...
					for (const i of e) {
						const e = i.mode;
						if (
							(['DelayToRealtime', 'DelayNoRealtime', ...ei, 'DelayWithoutMarketAgreement'].includes(e) && (t[e] = Vs),
							'EOD' === e && (t[e] = Ls),
							'TickByTick' === e)
						) {
							const l =
			...
			class ci extends rs {
				constructor(e, t, s) {
					super({ iconMap: ni, classNameMap: ri, tooltipMap: di, titleMap: ui, titleColorMap: hi, size: t }),
						...
						? this._fullTooltip.setValue([
								{
									...
									title: this._getTitle(e),
									titleColor: this._getTitleColor(e),
									html: void 0 === t.stackTrace ? [(0, as.formatStudyError)((0, os.htmlEscape)(t.error))] : null,
									size: this._size,
									action: this._getAction(e),
									solutionId: this._options.errorSolution ? this._dataSourceErrorStatus.value()?.solutionId : void 0,
								},
							])
						: this._fullTooltip.setValue(null);
				}
			...
			class vi extends rs {
				constructor(e, t) {
					super({ tooltipMap: gi, iconMap: pi, classNameMap: mi, titleMap: gi, titleColorMap: bi, size: t }),
			...
			class Ai {
				...
				_buildAction(e) {
					return e && e.onClick ? { text: e.text ?? '', tooltip: e.tooltip, onClick: e.onClick } : null;
				}
				_unSyncModel() {
					this._symbolModel &&
			...
			function _l(e) {
				...
				return J.t(
					null,
					{ plural: '{number} minutes', count: l, replace: { number: `${l}`, context: 'Market opens in n minutes' } },
					s(32547)
				);
			}
			const pl = {
					market: (e) => ('post_market' === e.status ? Yi : Xi).format({ remainingTime: _l(e.remainingSeconds) }),
					...
					holiday: (e) => ('pre_market' === e.status ? el : qi).format({ remainingTime: _l(e.remainingSeconds) }),
					delisted: (e) => '',
					expired: (e) => '',
				},
				ml = new Map([
			...
			class gl extends rs {
				constructor(e, t, s = !1) {
					super({
						...
						this.setModel(e),
						Lt.showMarketOpenStatusProperty.subscribe(this, this._showMarketOpenStatusPropertyChanged);
				}
				destroy() {
				...
				setModel(e) {
					if ((this._marketStatus.destroy(), this._sessionEdge.destroy(), this._expiredStatus?.destroy(), null === e))
						return (
							(this._marketStatus = new n.WatchedValue(null).spawn()),
							(this._sessionEdge = new n.WatchedValue(null).spawn()),
				...
				_shouldBeHiddenByStatus(e) {
					return !this._ignoreHideStatusSettings && !Lt.showMarketOpenStatusProperty.value() && 'market' === e;
				}
				_updateStatus(e) {
			...
			class vl {
				constructor(e) {
					(this._el = document.createElement('div')),
						...
						(this._visible = (0, w.combine)((e, t) => e && !!t, e.visible.spawnOwnership(), e.icon.spawnOwnership())),
			...
			class Ml {
				constructor(e) {
					(this._size = b.trackingModeIsAvailable ? 'medium' : 'small'),
						...
						(this._renderer = new yl(this._size, this._tooltips, { onClick: this._handleToggleDropdown.bind(this) })),
				...
				async _updateDropdownMenu() {
					const e = Promise.all([s.e(3953), s.e(5826), s.e(2564), s.e(7204), s.e(2544), s.e(8643)]).then(
						s.bind(s, 12048)
					);
						...
						this._recreateWidgets().then(() => {
							i.signal.aborted ||
								...
								null !== this._dataUpdatedAvailableVisible &&
									this._dataUpdatedAvailableVisible.subscribe(this._updateDataUpdatedWidgetIsShown.bind(this)),
				...
				async _recreateWidgets() {
					if (this._options.sourceStatusesEnabled) {
						...
						if (null === this._dataSourceErrorStatusViewModel) {
							(this._dataSourceErrorStatusViewModel = new ci(this._source, this._size, this._options.sourceStatuses)),
					...
					if (this._options.marketStatusEnabled) {
						...
						if (null === this._marketStatusViewModel) {
							...
							null !== e &&
								((this._sessionWidget = new is(this._source)), (s.additionalWidgets = [this._sessionWidget])),
								this._addStatusWidgetInfos(s);
						} else this._marketStatusViewModel.setModel(e), this._sessionWidget?.updateSource(this._source);
					}
				...
				constructor(e, t) {
					...
					if ((0, Vl.isStudyLineTool)(e)) s.push(e.onStatusChanged());
						...
						s.push(i.onStatusChanged()),
							(this._isSymbolInvalid = (0, ce.createWVFromGetterAndSubscriptions)(() => i.isSymbolInvalid(), s)),
			...
			class eo extends Ml {
				...
				_recreateHasErrorStatus() {
					this._hasErrorStatus?.destroy();
					const e = (0, w.combine)(
						(e) => this._dataSourceStatusWidgets.map((e) => e.dataSourceErrorStatusShown.weakReference()),
			...
			class no {
				...
				onShowLegendWidgetContextMenu(e, t) {
					...
					return (function (e, t, s, i, l, o) {
						...
						if (
							...
							const t = At.alwaysShowLastPriceAndLastDayChange ? r.showBarChange : r.showLastDayChange;
							a.push(
								new Ct.Action({
				...
				updateLayout() {
					...
					if (-1 !== i) {
						if ((e.splice(i, 1), !lo && null === this._mainSeriesViewModel)) {
							...
							const t = new Cl(this._statusSourceAdapter(s), this._model, this._options.statusesWidgets);
					...
					for (; _ >= 0; ) {
						...
						} else _ !== s && (r.set(e, { model: h[_], statusWidget: c[_] }), d.push({ oldIndex: _, newIndex: s }));
						_--;
					}
					const p = [],
						m = [];
					for (let s = 0; s < a.length; s++) {
						...
						if (r.has(i)) {
							...
							(l = new ft(
								...
								(n = new fl(this._statusSourceAdapter(t), this._model, this._options.statusesWidgets)),
					...
					if (
						...
						for (const e of this._dataSourcesStatusesWidgets) this._toggledDataSourcesStatusWidget.addStatusWidget(e);
					}
				}
				update() {
				...
				_updateCollapsedSourcesMode() {
					...
					if ((this._collapsedDataSourcesStatusWidget.clear(), this._availableHeight > 0 && e > 2)) {
								...
								for (let l = 0; l < e; l++) {
									...
									this._dataSourceViewModels[l].setGlobalVisibility(e && (!t || (0 === l && !s))),
										e ||
											...
											this._collapsedDataSourcesStatusWidget.addStatusWidget(this._dataSourcesStatusesWidgets[l]));
								}
								return (
									this._collapsedDataSourcesTitle.setValue(i), void this._collapsedDataSourcesCount.setValue(e - n)
								);
							}
						}
					}
				...
				_getCustomTextColorValue() {
					...
					for (const t of (0, to.getStdThemeNames)())
						if ((0, to.isStdThemedDefaultValue)('chartProperties.scalesProperties.textColor', e, t)) return null;
					return e;
				}
				_clearSubscriptions() {
		...
		61560: (e, t, s) => {
			...
			class b {
				...
				destroy() {
					this._visibilityType.destroy(), this._themedColor.destroy(), this._separatorSelected.destroy();
				...
				_render() {
					this._renderActions(), this._parentEl.classList.add(m.paneControls), this._wrapEl.append(this._parentEl);
				}
				_renderActions() {
				...
				_updateThemedColor(e) {
					if (e.length > 0) {
						...
						this._parentEl.style.color = (0, c.rgbaToString)([t, s, i, (0, c.normalizeAlphaComponent)(0.8)]);
			...
			const K = (0, k.hotKeySerialize)({ keys: [''], text: $ }),
				q = (0, k.hotKeySerialize)({ keys: [(0, n.humanReadableModifiers)(n.Modifiers.Mod, !1)], text: `{0} + ${$}` });
			class J {
				constructor(e, t, s, i) {
					(this._actions = {}),
						(this._moreCMShown = !1),
						...
						(this._maximizeButtonVisibility = new A.WatchedValue(this._getMaximizeButtonVisibility())),
								...
								if (e.up.visible.value()) {
									...
									i.push(
										new v.Action({
											...
											options: { icon: y, label: t.value(), statName: 'Move pane up', onExecute: () => s() },
										})
									);
								}
								if (e.down.visible.value()) {
									...
									i.push(
										new v.Action({
											...
											options: { icon: M, label: t.value(), statName: 'Move pane down', onExecute: () => s() },
										})
									);
								}
								if (e.close.visible.value()) {
									...
									i.push(
										new v.Action({
											...
											options: { icon: S, label: t.value(), statName: 'Delete pane', onExecute: () => s() },
										})
									);
								}
		...
		63276: (e, t, s) => {
			...
			var i = s(43888),
				...
				a = s(80007);
			function n(e, t) {
				const { buttonClassName: s, wrapIconClassName: n, hiddenClassName: r, iconSize: d, blurOnClick: u } = t,
