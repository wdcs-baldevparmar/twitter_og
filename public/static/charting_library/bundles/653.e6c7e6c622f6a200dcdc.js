(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[653],
	{
		...
		41590: (e, t, o) => {
			...
			var p;
			function h(e) {
				const { position: t = 'Bottom', onClose: o, children: d, reference: p, className: h, theme: f = u } = e,
				...
				return (
					...
					r.createElement(
						...
						r.createElement(
							...
							v === g.currentDrawer && r.createElement('div', { className: u.backdrop, onClick: o }),
							r.createElement(
								m,
								{ className: a(f.drawer, u[`position${t}`], h), ref: w, 'data-name': e['data-name'] },
								d
							)
						)
					)
			...
			const m = (0, r.forwardRef)((e, t) => {
				...
				return r.createElement(d.TouchScrollContainer, { className: a(u.drawer, o), tabIndex: -1, ref: t, ...n });
			});
		},
		11684: (e, t, o) => {
			'use strict';
			...
			function l(e, t) {
				return (o) => {
					...
					const B = w === r.Top ? -1 * g : g,
						...
						T = { x: D - (m === i.FromRightToLeft ? l : 0) + f, y: E - (b === a.FromBottomToTop ? d : 0) + B };
		...
		56388: (e, t, o) => {
			...
			const s = r.forwardRef(function (e, t) {
				...
				return r.createElement(a.ToolWidgetButton, { id: s, 'data-name': s, ...c, ref: t, className: n(o, i.button) });
			});
		},
		16829: (e, t, o) => {
			'use strict';
				...
				constructor(e) {
					super(e),
						...
						(this._handleToggleDropdown = (e, t = !1) => {
							...
							this.setState({ isOpened: a, shouldReturnFocus: !!a && t }), a && r && r(), !a && o && o();
						}),
						(this._handleClose = () => {
							this.close();
						}),
				...
				_renderContent(e) {
					...
					return g
						? r.createElement(
								...
								r.createElement(
									u.Drawer,
									{ reference: this.props.drawerReference, onClose: this._handleClose, position: c, 'data-name': t },
									v
								)
							)
						: r.createElement(
		...
		77151: (e, t, o) => {
			'use strict';
			o.d(t, { RegistryProvider: () => c, registryContextType: () => l, validateRegistry: () => s });
			var r = o(50959),
				n = o(19036),
				a = o.n(n);
