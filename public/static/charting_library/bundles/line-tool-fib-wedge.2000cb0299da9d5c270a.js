	...
	[3314],
	{
		73174: (e, t, i) => {
			...
			function P(e, t) {
				return {
					...
					info: { typeX: 0, minX: new c.WatchedValue(p), maxX: new c.WatchedValue(_), stepX: new c.WatchedValue(1) },
				};
			}
		...
		53749: (e, t, i) => {
			...
			var n = i(11542),
				...
				o = i(32097),
				s = i(91682);
			const l = new r.TranslatedString('change {toolName} line visibility', n.t(null, void 0, i(24550))),
				...
				h = new r.TranslatedString('change {toolName} line extending left', n.t(null, void 0, i(18773))),
				u = new r.TranslatedString('change {toolName} line left end', n.t(null, void 0, i(21474))),
				p = new r.TranslatedString('change {toolName} line extending right', n.t(null, void 0, i(43823))),
			...
			function y(e, t, i, n, r) {
				...
				return (
					void 0 !== t.showLine &&
						(y.checked = (0, o.convertToDefinitionProperty)(e, t.showLine, l.format({ toolName: i }))),
					void 0 !== t.lineWidth &&
						(y.width = (0, o.convertToDefinitionProperty)(e, t.lineWidth, a.format({ toolName: i }))),
					void 0 !== t.lineStyle &&
						(y.style = (0, o.convertToDefinitionProperty)(e, t.lineStyle, d.format({ toolName: i }))),
					void 0 !== t.lineColor &&
						(y.color = (0, o.getColorDefinitionProperty)(e, t.lineColor, null, c.format({ toolName: i }))),
					void 0 !== t.extendLeft &&
						((y.extendLeft = (0, o.convertToDefinitionProperty)(e, t.extendLeft, h.format({ toolName: i }))),
						(P.extendLeftTitle = (r && r.extendLeftTitle) || v)),
					void 0 !== t.leftEnd &&
						(y.leftEnd = (0, o.convertToDefinitionProperty)(e, t.leftEnd, u.format({ toolName: i }))),
					void 0 !== t.extendRight &&
						((y.extendRight = (0, o.convertToDefinitionProperty)(e, t.extendRight, p.format({ toolName: i }))),
						(P.extendRightTitle = (r && r.extendRightTitle) || g)),
					void 0 !== t.rightEnd &&
						(y.rightEnd = (0, o.convertToDefinitionProperty)(e, t.rightEnd, _.format({ toolName: i }))),
			...
			class f extends s.DefaultProperty {
				constructor(e) {
					const { levelsIterator: t = p, map: i = {}, ...n } = e,
						r = { ...a, ...i };
					n.state && (n.state = _(n.state, r, t)), super(n), (this._map = r), (this._levelsIterator = t);
				}
				state(e, t, i) {
		...
		72609: (e, t, i) => {
			...
			class h extends a.InplaceTextLineSourcePaneView {
				...
				_updateLabelForLevel(e) {
					...
					return s && (a += ' (' + i.formatPrice(e.price, n) + ')'), this._updateRendererLabel(e, t, a), t;
				}
				_updateRendererLabel(e, t, i) {
					if (!i && void 0 === e.decorator) return null;
					const { leftPoint: n, rightPoint: o, horzAlign: s, extendLeft: a, extendRight: d, ...h } = e,
					...
					if ((super.setPoint(e, t), !this._recursiveGuard))
						try {
							if (((this._recursiveGuard = !0), 2 === e)) {
								...
								const i = (0, n.ensureNotNull)(this.pointToScreenPoint(this._points[2])).subtract(e).length();
								let o = t.subtract(e);
		...
		84417: (e, t, i) => {
			...
			class p extends s.LineToolPaneViewFibWithLabels {
				...
				_updateImpl(e) {
					...
					if ((l.dotProduct(d) < 0 && (h = 2 * Math.PI - h), h < c && ([c, h] = [h, c]), Math.abs(c - h) > Math.PI)) {
				...
				_updateRenderer(e = NaN, t = NaN) {
					...
					this._model.lineBeingCreated() !== this._source && y.push(_),
						i.append(this.createLineAnchor({ points: y.map(u.mapLineSourcePaneViewPointToLineAnchorPoint) }, 0)),
						(this._renderer = i);
				}
			}
		},
		30051: (e, t, i) => {
			...
			const f = new o.TranslatedString('change {title} level {index} line visibility', r.t(null, void 0, i(51403))),
				...
				g = new o.TranslatedString('change {title} level {index} line color', r.t(null, void 0, i(664))),
				y = new o.TranslatedString('change {title} level {index} line width', r.t(null, void 0, i(97870))),
				P = new o.TranslatedString('change {title} level {index} line coeff', r.t(null, void 0, i(27154))),
				m = new o.TranslatedString('change {title} all lines color', r.t(null, void 0, i(59577))),
				T = new o.TranslatedString('change {title} background visibility', r.t(null, void 0, i(30839))),
				x = new o.TranslatedString('change {title} background transparency', r.t(null, void 0, i(13783))),
			...
			class N extends u.LineDataSourceDefinitionsViewModel {
				_stylePropertyDefinitions() {
					...
					const L = (0, h.createCheckablePropertyDefinition)(
						{
							checked: (0, h.convertToDefinitionProperty)(this._propertyApplier, t.showCoeffs, v.format({ title: s })),
						},
						{ id: `${r}Levels`, title: C }
					);
					...
					if (
						...
						if (
							...
							e.addColorStop(0, (0, o.generateColor)(this._data.color1, this._data.transparency)),
								...
								(t.fillStyle = e);
						} else t.fillStyle = (0, o.generateColor)(this._data.color, this._data.transparency, !0);
						t.fill();
					}
				}
			}
