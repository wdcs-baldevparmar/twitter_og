			...
			class d extends a.LineDataSource {
				...
				addPoint(e, i, t, r) {
					...
					if (this._points.length > 0) {
						...
						if (!i?.isApiEvent() && u < (0, o.interactionTolerance)().minDistanceBetweenPoints && !r)
				...
				static _configureProperties(e) {
					super._configureProperties(e),
						e.addChild('linesWidths', new h.LineToolWidthsProperty([(0, n.ensureDefined)(e.child('lineWidth'))])),
