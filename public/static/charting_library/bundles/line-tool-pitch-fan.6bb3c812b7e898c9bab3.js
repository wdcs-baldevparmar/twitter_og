...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	...
	{
		27916: (e, t, n) => {
			n.d(t, { LineSourcePaneView: () => g, createLineSourcePaneViewPoint: () => _, thirdPointCursorType: () => p });
			var i = n(19625),
				o = n(50151),
				r = n(69186),
				s = n(56468),
				...
				_updateImpl(e) {
					...
					if (
						((this._medianPoint = (0, _.lineSourcePaneViewPointToLineAnchorPoint)(
							3 === t ? this._points[1].add(this._points[2]).scaled(0.5) : 2 === t ? this._points[1] : n,
							3
						)),
						t < 2)
					)
					...
					for (let e = 0; e <= 8; e++) {
						...
						if (o?.childs().visible.value()) {
							...
							a = o.childs().coeff.value();
							{
								...
								s.setData(r), s.setHitTest(new c.HitTestResult(c.HitTarget.MovePoint, void 0, e)), i.append(s);
							}
							{
								const t = {
										points: [n, r],
									...
									s = new P.TrendLineRenderer();
								s.setData(t), s.setHitTest(new c.HitTestResult(c.HitTarget.MovePoint, void 0, e)), i.append(s);
							}
						}
					}
			...
			class w extends a.LineDataSource {
				...
				static _configureProperties(e) {
					...
					for (let o = 0; o <= 8; o++) {
						...
						t.push((0, i.ensureDefined)(r.child('linewidth'))), n.push((0, i.ensureDefined)(r.child('color')));
					}
			...
			class c extends h.MediaCoordinatesPaneRenderer {
				...
				_visiblePolygon(e) {
					...
					if (
						(0, o.equalPoints)(n, r) ||
						(0, o.equalPoints)(l, d) ||
						((0, s.distanceToLine)(n, r, l).distance < 1e-6 && (0, s.distanceToLine)(n, r, d).distance < 1e-6)
					)
						return null;
					...
					return (
						...
						(0, o.equalPoints)(l, n) || t.extendLeft || (h = (0, a.clipPolygonByEdge)(h, l, n, [r, d])),
						h
					);
				}
			}
					...
					for (let e = 0; e < t.length; ++e) {
						...
						if (!((0, l.isInteger)(r.pointIndex) && c.linePointBeingEdited === r.pointIndex)) {
							...
							if (
								(o(
									a,
									{ ...r, point: new i.Point(Math.round(r.point.x * d) + P, Math.round(r.point.y * h) + P) },
									g / 2,
									p
								),
