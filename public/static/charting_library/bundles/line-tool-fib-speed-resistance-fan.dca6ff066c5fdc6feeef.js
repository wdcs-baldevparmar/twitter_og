...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[906],
	{
		73174: (e, t, i) => {
			...
			function y(e, t, i) {
				return { property: (0, c.convertToDefinitionProperty)(e, t.price, _), info: { typeY: 1, stepY: i } };
			}
			function P(e, t) {
				return {
					property: (0, c.convertToDefinitionProperty)(e, t.bar, g),
					info: { typeX: 0, minX: new d.WatchedValue(u), maxX: new d.WatchedValue(f), stepX: new d.WatchedValue(1) },
				};
			}
			...
			class _ extends s.DefaultProperty {
				constructor(e) {
					const { levelsIterator: t = u, map: i = {}, ...n } = e,
						r = { ...a, ...i };
					n.state && (n.state = f(n.state, r, t)), super(n), (this._map = r), (this._levelsIterator = t);
				}
				state(e, t, i) {
				...
				preferences() {
					return (0, s.extractState)(this.state(this._excludedDefaultsKeys, void 0, !0), this._allDefaultsKeys);
				}
				applyTemplate(e, t) {
					this.mergeAndFire(
						(0, s.extractState)(
				...
				_options() {
					return { ...super._options(), map: { ...this._map }, levelsIterator: this._levelsIterator };
				}
			}
		},
		95166: (e, t, i) => {
			i.d(t, { CollectibleColorPropertyDirectWrapper: () => l, CollectibleColorPropertyUndoWrapper: () => s });
			var n = i(50151),
				r = i(12988);
			class o extends r.Property {
				...
				unsubscribe(e, t) {
					const i = (0, n.ensureDefined)(this._listenersMappers.find((i) => i.obj === e && i.method === t)?.callback);
		...
		2662: (e, t, i) => {
			...
			var n = i(50151),
				...
				p = i(91682),
				u = i(95166);
			const f = new o.TranslatedString('change {title} level {index} line visibility', r.t(null, void 0, i(51403))),
				_ = new o.TranslatedString('change {title} level {index} line color', r.t(null, void 0, i(664))),
				g = new o.TranslatedString('change {title} level {index} line coeff', r.t(null, void 0, i(27154))),
				v = new o.TranslatedString('change {title} all lines color', r.t(null, void 0, i(59577))),
				y = new o.TranslatedString('change {title} background visibility', r.t(null, void 0, i(30839))),
				P = new o.TranslatedString('change {title} background transparency', r.t(null, void 0, i(13783))),
				x = new o.TranslatedString('change {title} left labels visibility', r.t(null, void 0, i(63021))),
				m = new o.TranslatedString('change {title} right labels visibility', r.t(null, void 0, i(8390))),
				T = new o.TranslatedString('change {title} top labels visibility', r.t(null, void 0, i(81301))),
				b = new o.TranslatedString('change {title} bottom labels visibility', r.t(null, void 0, i(62130))),
				...
				_stylePropertyDefinitions() {
					...
					const U = t.grid.childs(),
						j = (0, d.createLinePropertyDefinition)(
							{
								checked: (0, d.convertToDefinitionProperty)(this._propertyApplier, U.visible, S.format({ title: s })),
								color: (0, d.getColorDefinitionProperty)(this._propertyApplier, U.color, null, L.format({ title: s })),
								width: (0, d.convertToDefinitionProperty)(this._propertyApplier, U.linewidth, A.format({ title: s })),
								style: (0, d.convertToDefinitionProperty)(this._propertyApplier, U.linestyle, R.format({ title: s })),
							},
							{ id: `${r}GridLine`, title: N }
						);
					e.push(j);
					const J = (0, d.createCheckablePropertyDefinition)(
						{ checked: (0, d.convertToDefinitionProperty)(this._propertyApplier, t.reverse, w.format({ title: s })) },
			...
			class J extends j.LineSourcePaneView {
				constructor(e, t) {
					...
					for (let e = 0; e < this._source.hLevelsCount(); e++)
						this._leftTextRenderers.push(new K.TextRenderer()), this._rightTextRenderers.push(new K.TextRenderer());
					for (let e = 0; e < this._source.vLevelsCount(); e++)
						this._topTextRenderers.push(new K.TextRenderer()), this._bottomTextRenderers.push(new K.TextRenderer());
				}
				renderer(e) {
					...
					for (let e = 0; e < a.length; e++) {
						...
						}
						{
							const i = {
								...
								n = new U.TrendLineRenderer();
							n.setData(i),
								n.setHitTest(new O.HitTestResult(O.HitTarget.MovePoint, void 0, { type: 'h', index: a[e].index })),
								f.append(n);
						}
					}
					for (let e = 0; e < h.length; e++) {
			...
			class ee extends s.LineDataSource {
				...
				static _configureProperties(e) {
					...
					for (let i = 1; i <= 7; i++) t.push((0, n.ensureDefined)(e.child(`hlevel${i}`)?.child('color')));
					for (let i = 1; i <= 7; i++) t.push((0, n.ensureDefined)(e.child(`vlevel${i}`)?.child('color')));
					e.addChild('linesColors', new a.LineToolColorsProperty(t)), e.addExcludedKey('linesColors', 3);
				}
			}
		},
		27916: (e, t, i) => {
			i.d(t, { LineSourcePaneView: () => _, createLineSourcePaneViewPoint: () => f, thirdPointCursorType: () => u });
			var n = i(19625),
				r = i(50151),
				o = i(69186),
				s = i(56468),
			...
			class _ {
				...
				_anchorRadius() {
					return (0, o.lastMouseOrTouchEventInfo)().isTouch ? p.TouchAnchorRadius : p.RegularAnchorRadius;
				}
				_lineAnchorColors(e) {
				...
				_getSelectionRenderer(e) {
					for (; this._selectionRenderers.length <= e; ) this._selectionRenderers.push(new l.SelectionRenderer());
			...
			class h extends d.MediaCoordinatesPaneRenderer {
				...
				_drawImpl(e) {
					...
					if (null !== i) {
						...
						(t.fillStyle = (0, c.generateColor)(this._data.color, this._data.transparency, !0)), t.fill();
					}
				}
				_visiblePolygon(e) {
					...
					if (
						(0, r.equalPoints)(i, o) ||
						(0, r.equalPoints)(l, c) ||
						((0, s.distanceToLine)(i, o, l).distance < 1e-6 && (0, s.distanceToLine)(i, o, c).distance < 1e-6)
					)
						return null;
					...
					return (
						...
						(0, r.equalPoints)(l, i) || t.extendLeft || (d = (0, a.clipPolygonByEdge)(d, l, i, [o, c])),
						d
					);
				}
			}
		...
		36036: (e, t, i) => {
			...
			function p(e, t, i, n) {
				const { point: r } = t,
					o = i + n / 2;
				(0, s.drawRoundRect)(e, r.x - o, r.y - o, 2 * o, 2 * o, (i + n) / 2), e.closePath(), (e.lineWidth = n);
			}
			function u(e, t, i, n) {
					...
					for (let e = 0; e < t.length; ++e) {
						...
						if (!((0, l.isInteger)(o.pointIndex) && h.linePointBeingEdited === o.pointIndex)) {
							...
							if (
								(r(
									a,
									{ ...o, point: new n.Point(Math.round(o.point.x * c) + g, Math.round(o.point.y * d) + g) },
									_ / 2,
									u
								),
