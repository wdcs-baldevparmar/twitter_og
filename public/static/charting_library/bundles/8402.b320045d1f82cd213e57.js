				...
				(e = function (d) {
					...
					var c =
						...
						s = function (d) {
							...
							return !!i(u.target) || 1 < u.touches.length || (u.preventDefault && u.preventDefault(), !1);
						},
						l = function () {
							setTimeout(function () {
						...
						if (c) {
							...
							if (
								...
								(t = [].concat(u(t), [l])),
									...
									n || (document.addEventListener('touchmove', s, e ? { passive: !1 } : void 0), (n = !0));
							}
						} else {
							(p = f),
								setTimeout(function () {
									if (void 0 === a) {
										...
										d &&
											0 < u &&
											((a = document.body.style.paddingRight), (document.body.style.paddingRight = u + 'px'));
									}
						...
						(d.clearAllBodyScrollLocks = function () {
							c
								? (t.forEach(function (d) {
									...
									n && (document.removeEventListener('touchmove', s, e ? { passive: !1 } : void 0), (n = !1)),
									(t = []),
									(r = -1))
								: (l(), (t = []));
						}),
						(d.enableBodyScroll = function (d) {
							if (c) {
								...
								(d.ontouchstart = null),
									...
									n &&
										0 === t.length &&
										(document.removeEventListener('touchmove', s, e ? { passive: !1 } : void 0), (n = !1));
							} else
			...
			const f = (function () {
				...
				function l(d, u) {
					for (var f, c, t, n, r, a, l, b, p, v, h, g, m, y = i(d, []), w = y.length; w--; ) {
						for (t = !1, n = document.createDocumentFragment(), a = (r = y[w]).nodeValue, b = 0; (l = e.exec(a)); ) {
							if (
								...
								(f = u.attributes(h, g))))
									f.hasOwnProperty(c) && 0 !== c.indexOf('on') && !v.hasAttribute(c) && v.setAttribute(c, f[c]);
								(v.className = u.className), (v.alt = h), (v.src = m), (t = !0), n.appendChild(v);
							}
							v || n.appendChild(o(h, !1)), (v = null);
						}
						t && (b < a.length && n.appendChild(o(a.slice(b), !0)), r.parentNode.replaceChild(n, r));
					}
					return d;
				}
				function b(d, u) {
			...
			let f = (d = 21) =>
				crypto
					...
					.reduce(
						(d, u) =>
							(d +=
								(u &= 63) < 36 ? u.toString(36) : u < 62 ? (u - 26).toString(36).toUpperCase() : u > 62 ? '-' : '_'),
						''
					);
		},
	},
