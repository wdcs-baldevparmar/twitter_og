...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[380],
	{
		73174: (e, t, i) => {
			...
			function v(e, t, i) {
				return { property: (0, c.convertToDefinitionProperty)(e, t.price, m), info: { typeY: 1, stepY: i } };
			}
			function _(e, t) {
				return {
					property: (0, c.convertToDefinitionProperty)(e, t.bar, f),
					info: { typeX: 0, minX: new d.WatchedValue(p), maxX: new d.WatchedValue(g), stepX: new d.WatchedValue(1) },
				};
			}
		...
		91335: (e, t, i) => {
			...
			const s = new n.TranslatedString('change {toolName} text visibility', o.t(null, void 0, i(56634))),
				...
				u = new n.TranslatedString('change {toolName} text font italic', o.t(null, void 0, i(42694))),
				...
				g = new n.TranslatedString('change {toolName} labels alignment horizontal', o.t(null, void 0, i(88277))),
				m = new n.TranslatedString('change {toolName} labels direction', o.t(null, void 0, i(61160))),
				f = new n.TranslatedString('change {toolName} text background visibility', o.t(null, void 0, i(31133))),
				b = new n.TranslatedString('change {toolName} text background color', o.t(null, void 0, i(22231))),
				v = new n.TranslatedString('change {toolName} text border visibility', o.t(null, void 0, i(58704))),
				_ = new n.TranslatedString('change {toolName} text border width', o.t(null, void 0, i(35423))),
				T = new n.TranslatedString('change {toolName} text border color', o.t(null, void 0, i(36666))),
			...
			function C(e, t, i, o) {
				...
				if (
					...
					void 0 !== t.bold && (n.bold = (0, r.convertToDefinitionProperty)(e, t.bold, d.format({ toolName: i }))),
					void 0 !== t.italic &&
					...
					void 0 !== t.textOrientation &&
						(n.orientation = (0, r.convertToDefinitionProperty)(e, t.textOrientation, m.format({ toolName: i }))),
					...
					void 0 !== t.backgroundTransparency && (o = t.backgroundTransparency),
						(n.backgroundColor = (0, r.getColorDefinitionProperty)(e, t.backgroundColor, o, b.format({ toolName: i })));
				}
				return (
					...
					void 0 !== t.borderVisible &&
						(n.borderVisible = (0, r.convertToDefinitionProperty)(e, t.borderVisible, v.format({ toolName: i }))),
					void 0 !== t.borderWidth &&
						(n.borderWidth = (0, r.convertToDefinitionProperty)(e, t.borderWidth, _.format({ toolName: i }))),
					void 0 !== t.borderColor &&
						(n.borderColor = (0, r.getColorDefinitionProperty)(e, t.borderColor, null, T.format({ toolName: i }))),
		...
		27916: (e, t, i) => {
			i.d(t, { LineSourcePaneView: () => m, createLineSourcePaneViewPoint: () => g, thirdPointCursorType: () => p });
			var o = i(19625),
				n = i(50151),
				r = i(69186),
				l = i(56468),
			...
			class m {
				...
				_anchorRadius() {
					return (0, r.lastMouseOrTouchEventInfo)().isTouch ? h.TouchAnchorRadius : h.RegularAnchorRadius;
				}
				_lineAnchorColors(e) {
				...
				_getSelectionRenderer(e) {
					for (; this._selectionRenderers.length <= e; ) this._selectionRenderers.push(new s.SelectionRenderer());
					return this._selectionRenderers[e];
				}
				_getLineAnchorRenderer(e) {
					for (; this._lineAnchorRenderers.length <= e; ) this._lineAnchorRenderers.push(new a.LineAnchorRenderer());
			...
			class P extends p.LineDataSourceProperty {
				constructor(e) {
					super(e),
						...
						this.addChild('linesColors', new c.LineToolColorsProperty([(0, o.ensureDefined)(this.child('lineColor'))])),
						this.addChild(
							'backgroundsColors',
							new c.LineToolColorsProperty([(0, o.ensureDefined)(this.child('priceLabelBackgroundColor'))])
						),
						this.addChild(
							'textsColors',
							new c.LineToolColorsProperty([(0, o.ensureDefined)(this.child('priceLabelTextColor'))])
						);
				}
				static create(e, t) {
					return new this({
			...
			class F {
				constructor() {
					(this._data = null),
						(this._priceLabelRenderer = new D.TextRenderer(
							void 0,
							new B.HitTestResult(B.HitTarget.MovePoint, { areaName: B.AreaName.Style, activeItem: 1 })
						)),
						(this._hittest = new B.HitTestResult(B.HitTarget.MovePoint, { areaName: B.AreaName.Style }));
				}
				setData(e) {
					this._data = e;
					const t = e.points[0],
				...
				draw(e, t) {
					...
					(0, H.createCircle)(e, r, l, c),
						e.fill(),
						void 0 !== i.excludeBoundaries && (e.save(), (0, I.addExclusionArea)(e, t, i.excludeBoundaries)),
			...
			class O extends k.LineSourcePaneView {
				...
				_updateImpl(e) {
					...
					const l = this._source.properties().childs(),
						a = this._model.dark().value() ? r.colorsPalette['color-cold-gray-900'] : r.colorsPalette['color-white'],
					...
					if (l.showLabel && l.showLabel.value()) {
						...
						let u;
						u = 'left' === c ? n.clone() : 'right' === c ? r.clone() : new L.Point((t.x + o.x) / 2, (t.y + o.y) / 2);
						...
						if (
							...
							d.excludeBoundaries = (0, D.getTextBoundaries)(this._customLabelRenderer, t, i) ?? void 0;
						}
					}
					this._renderer.append(this._priceNoteRenderer),
						this._priceNoteRenderer.setData(d),
						this._renderer.append(
							this.createLineAnchor({ points: i.map(R.mapLineSourcePaneViewPointToLineAnchorPoint) }, 0)
						);
				}
			}
			var K = i(11542),
					...
					return {
						definitions: [
							(0, X.createTextStyleDefinition)(
								...
								o,
								{ isEditable: !1, isMultiLine: !1, customTitles: { text: j, borderTitle: Z, backgroundTitle: ee } }
							),
							n,
						],
					};
				...
				startMoving(e, t, i) {
					if (1 === t) {
						...
						const i = (0, o.ensureDefined)(e.logical),
							n = this.points()[1];
						(this._labelMovingDelta = { index: n.index - i.index, price: n.price - i.price }), this.startChanging(t, i);
				...
				move(e, t, i) {
					if (null !== this._labelMovingDelta) {
						const t = (0, o.ensureDefined)(e.logical),
							n = { index: t.index + this._labelMovingDelta.index, price: t.price + this._labelMovingDelta.price };
		...
		36036: (e, t, i) => {
			...
			function h(e, t, i, o) {
				const { point: n } = t,
					r = i + o / 2;
				(0, l.drawRoundRect)(e, n.x - r, n.y - r, 2 * r, 2 * r, (i + o) / 2), e.closePath(), (e.lineWidth = o);
			}
			function p(e, t, i, o) {
					...
					for (let e = 0; e < t.length; ++e) {
						...
						if (!((0, s.isInteger)(r.pointIndex) && u.linePointBeingEdited === r.pointIndex)) {
							...
							if (
								(n(
									a,
									{ ...r, point: new o.Point(Math.round(r.point.x * c) + f, Math.round(r.point.y * d) + f) },
									m / 2,
									p
								),
