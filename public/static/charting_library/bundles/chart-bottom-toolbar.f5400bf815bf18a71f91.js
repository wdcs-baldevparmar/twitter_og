	...
	[7260],
	{
		...
		23829: (e, t, n) => {
			...
			function p(e) {
				const {
					...
					B = !!y.length;
				return i
					? s.createElement('li', { className: o()(t, m.item, m.loading, m[T]) }, s.createElement(r.Loader, null))
					: s.createElement(
							'li',
							{
								className: o()(
							...
							s.createElement(
								'span',
								{ className: o()(m.label) },
								!R && S ? S.map(({ text: e, ...t }, n) => s.createElement('span', { key: n, style: t }, e)) : (R ?? E)
							),
							!!w &&
								s.createElement(a.Icon, {
									onClick: function () {
			...
			function h(e) {
				...
				return s.createElement(
					Y,
					{
						...
						id: t,
						role: n,
						className: i(u, L.item, f && L.withIcon, { [L.isActive]: C, [L.isDisabled]: x || E, [L.hovered]: y }),
						title: h,
						href: M,
						target: R,
						rel: T,
					...
					(void 0 !== v || b) &&
						s.createElement('span', { className: L.shortcut }, (ee = v) && ee.split('+').join(' + ')),
					void 0 !== A &&
						s.createElement(
							'span',
							{
		...
		68426: (e, t, n) => {
			...
			var s = n(50959),
				...
				_ = n(52033),
				C = n(85049);
			const x = (e) => o.t(null, { plural: '{str} minutes', count: e, replace: { str: `${e}` } }, n(5926)),
				y = (e) => o.t(null, { plural: '{str} hours', count: e, replace: { str: `${e}` } }, n(64963)),
				E = (e) => o.t(null, { plural: '{str} months', count: e, replace: { str: `${e}` } }, n(20062)),
				S = (e) => e,
				M = {
					...
					[S('1D')]: {
						resolution: '1D',
						text: ((R = 1), o.t(null, { plural: '{str} days', count: R, replace: { str: `${R}` } }, n(62368))),
					},
					[S('1W')]: {
						resolution: '1W',
						text: ((w = 1), o.t(null, { plural: '{str} weeks', count: w, replace: { str: `${w}` } }, n(49306))),
					},
					...
					[S('12M')]: {
						resolution: '12M',
						text: ((k = 1), o.t(null, { plural: '{str} years', count: k, replace: { str: `${k}` } }, n(91549))),
					},
				};
			var k, w, R;
			function T(e) {
				...
				return o.t(null, { replace: { timePeriod: t, timeInterval: s }, context: 'timeframe_title' }, n(58426));
			}
			const A = (e) =>
					o.t(
						null,
						{ plural: '{str} minutes', count: e, replace: { str: `${e}` }, context: 'timeframe_title' },
						n(95484)
					),
				B = (e) =>
					o.t(
						null,
						{ plural: '{str} hours', count: e, replace: { str: `${e}` }, context: 'timeframe_title' },
						n(72495)
					),
				D = (e) =>
					o.t(null, { plural: '{str} days', count: e, replace: { str: `${e}` }, context: 'timeframe_title' }, n(63808)),
				N = (e) =>
					o.t(null, { plural: '{str} weeks', count: e, replace: { str: `${e}` }, context: 'timeframe_title' }, n(6088)),
				W = (e) =>
					o.t(
						null,
						{ plural: '{str} months', count: e, replace: { str: `${e}` }, context: 'timeframe_title' },
						n(12752)
					),
				P = (e) =>
					o.t(
				...
				L = (e) =>
					o.t(
						null,
						{ plural: '{str} hours intervals', count: e, replace: { str: `${e}` }, context: 'timeframe_title' },
						n(14887)
					),
				z = (e) =>
					o.t(
				...
				H = (e) =>
					o.t(
						null,
						{ plural: '{str} months intervals', count: e, replace: { str: `${e}` }, context: 'timeframe_title' },
						n(48514)
					),
				I = (e) =>
					o.t(
						null,
						{ plural: '{str} years intervals', count: e, replace: { str: `${e}` }, context: 'timeframe_title' },
						n(78971)
					);
			class j {
				constructor(e) {
				...
				_updateAvailableRanges(e) {
					...
					const a = t(i, o).map((e) => ({ ...e, description: '' === e.description ? T(e) : e.description }));
			...
			const ee = { title: o.t(null, void 0, n(85444)), goToDate: (0, Q.appendEllipsis)(o.t(null, void 0, n(42432))) },
						...
						(this._renderChildren = (e) => {
							...
							return e
								? s.createElement(
										s.Fragment,
										null,
										s.createElement(K, { ranges: t, activeRange: n, onSelectRange: this._handleRangeSelect }),
								...
								: s.createElement(
										...
										i &&
											s.createElement(p.AccessibleMenuItem, { label: ee.goToDate, onClick: this._handleGoToDateClick })
									);
						}),
			...
			function ue(e) {
				const { reference: t, text: n, tooltip: i, isActive: o, className: a, onClick: l, theme: c = ce, ...u } = e,
			...
			class Ee extends s.PureComponent {
				constructor(e, t) {
					super(e, t),
						(this._handleClick = () => {
							const { chartWidget: e } = this.context;
							(0, b.trackEvent)('GUI', 'Chart Bottom Toolbar', 'go to'), (0, J.showGoToDateDialog)(e);
						}),
						(0, f.validateRegistry)(t, { chartWidget: a.any.isRequired });
				}
				render() {
			...
			var Me = n(76460),
				...
				De = n(40443),
				Ne = n(47825);
			const We = (0, re.mergeThemes)(le.DEFAULT_TOOLBAR_BUTTON_THEME, { isDisabled: Ne.disabled, button: Ne.button });
			...
			class Fe extends s.PureComponent {
				constructor(e, t) {
					super(e, t),
						...
						(0, f.validateRegistry)(t, { chartWidget: a.any.isRequired, chartApiInstance: a.any.isRequired }),
						(this.state = { time: '' });
				}
				componentDidMount() {
					const { chartWidget: e } = this.context;
				...
				render() {
					const { className: e, withMenu: t } = this.props,
						{ time: i } = this.state,
						a = void 0 !== this._timezone ? (0, ke.parseTzOffset)(this._timezone.name()).string : null;
					return s.createElement(le.ToolbarButton, {
			...
			class je {
				...
				_setHighlight() {
					...
					if (null !== s) {
						...
						null !== i &&
							a.value().axis !== i &&
							(a.setValue({ owner: this._owner, axis: i }), e.lightUpdate(), (this._highlighted = !0));
					}
				}
				_removeHighlight() {
					if (!this._chartWidget.hasModel()) return;
				...
				((bt = class extends s.PureComponent {
					constructor(e, t) {
						super(e, t),
							...
							(this._priceAxisHighlighter = new je(this.context.chartWidget, () => this._priceScale, 'logarithm'));
					}
					componentDidMount() {
						...
						((t = class extends s.PureComponent {
							constructor(e, t) {
								super(e, t),
									...
									(0, f.validateRegistry)(t, { chartWidget: a.any.isRequired }),
									(this.state = { isActive: !1, series: null }),
									(this._priceAxisHighlighter = new je(this.context.chartWidget, () => this._priceScale, 'auto'));
							}
							componentDidMount() {
								const e = this.context.chartWidget;
								e.withModel(null, () => {
								...
								super(e, t),
									...
									(this._handleSelect = () => {
										const e = this.context.chartWidget.model(),
											...
											n = t.priceScale(),
											s = n.mode();
										t.priceScale().isLockScale() || e.setPriceScaleMode({ percentage: !s.percentage }, n, Ge);
									}),
									(0, f.validateRegistry)(t, { chartWidget: a.any.isRequired }),
									(this.state = { isActive: !1, series: null }),
									(this._priceAxisHighlighter = new je(this.context.chartWidget, () => this._priceScale, 'percentage'));
							}
							componentDidMount() {
								const e = this.context.chartWidget;
								e.withModel(null, () => {
			...
			class Tt extends s.PureComponent {
				constructor(e, t) {
					...
					super(e, t),
						...
						(this._updateButtonsVisibilityImp = (e) => {
							...
							this._setStateWithResize({ intervalAllowsSessionButton: o, symbolAllowsSessionButton: a }, e);
						}),
						(this._resizeByRaf = () => {
							null === this._raf &&
				...
				render() {
					...
					return s.createElement(
						Oe.Toolbar,
						{ className: dt.toolbar, onContextMenu: Ze.preventDefault, ref: this._handleToolbarRef },
						t &&
							s.createElement(
								$e.FragmentMap,
								null,
								s.createElement(
									'div',
									{
										className: r(dt.dateRangeWrapper, 'collapsed' !== e.dateRangeMode && dt.collapsed),
										ref: this._handleRangeCollapsedRef,
									},
									s.createElement(
										'div',
										{ className: r(dt.dateRangeCollapsed) },
										s.createElement(se, { goToDateButton: this.props.goToDateEnabled, className: dt.dateRange })
									)
								),
								s.createElement(
									'div',
									...
									s.createElement(
										...
										s.createElement(ge, { onSelectRange: this._trackRangeButtonClick, className: dt.dateRange }),
										this.props.goToDateEnabled && s.createElement(ze, { className: r(dt.separator) }),
						...
						s.createElement(
							...
							n &&
								s.createElement(
									'div',
									{ className: r(dt.inline, e.timeZones && dt.collapsed), ref: this._handleTimeZonesRef },
									s.createElement(
										'div',
							...
							this.props.sessionIdButtonEnabled &&
								...
								s.createElement(
									'div',
									{ className: r(dt.inline, e.session && dt.collapsed), ref: this._handleSessionsRef },
									s.createElement(
										'div',
										{ className: dt.inline },
										s.createElement(at, { className: dt.item, withMenu: this.props.sessionIdButtonEnabled })
									)
								),
							s.createElement(
								'div',
								{ ref: this._handleSeparatorRef, className: r(dt.inline, e.separator && dt.collapsed) },
							...
							s.createElement(
								...
								!1,
								!1,
								i && !c.enabled('fundamental_widget') && s.createElement(_t, { className: dt.item }),
				...
				_applyResizing() {
					...
					this._rangeExpanded &&
						...
						this._rangeCollapsed && this._rangeCollapsed.classList.toggle(dt.collapsed, 'collapsed' !== e);
					let s = !1,
						i = !1;
