	...
	[1314],
	{
		...
		40265: (e, t, r) => {
			...
			class d {
				...
				setDirection(e) {
					return (this._direction = e), this._line.updateAllViewsAndRedraw(a(this._line.id())), this;
				}
				setProfitState(e) {
					return (this._profitState = e), this._line.updateAllViewsAndRedraw(a(this._line.id())), this;
				}
				getPrice() {
				...
				setPrice(e) {
					if (this._line.points().length > 0) {
						...
						(t.price = e), this._line.setPoint(0, t), this._line.updateAllViewsAndRedraw(a(this._line.id()));
					}
				...
				setText(e) {
					return (this._data.bodyText = e || ''), this._line.updateAllViewsAndRedraw(a(this._line.id())), this;
				}
				setTooltip(e) {
				...
				setQuantity(e) {
					return (this._data.quantityText = e || ''), this._line.updateAllViewsAndRedraw(a(this._line.id())), this;
				}
				getExtendLeft() {
				...
				setLineLength(e, t = 'percentage') {
					...
					return (
						this._line.properties().lineLength.setValue(r), this._line.properties().lineLengthUnit.setValue(t), this
					);
				}
				getLineColor() {
				...
				setQuantityBackgroundColor(e) {
					return (
						'buy' === this._direction ? this.setQuantityBackgroundBuyColor(e) : this.setQuantityBackgroundSellColor(e),
						this
					);
				}
				...
				onContextMenu(e, t) {
					return (
						t
							? this.isFunction(t) && ((this._onContextMenuData = e), (this._onContextMenuCallback = t))
			...
			class _ extends i {
				...
				addPoint(e, t) {
					return this._points.push(e), (this._lastPoint = null), this._normalizePoints(), this.createServerPoints(), !0;
				}
				name() {
					return 'Position';
				}
				...
				static createProperties(e, t) {
					var r = new l({ defaultName: 'linetoolposition', state: t, useUserPreferences: !1, theme: e });
