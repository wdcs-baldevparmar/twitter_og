		...
		39214: (e, t, n) => {
			...
			function C(e) {
				...
				return r.createElement(
					r.Fragment,
					null,
					!c && r.createElement('div', { className: y.separatorWrap }, r.createElement(b, { className: y.separator })),
					r.createElement(
						'div',
						{
							className: a(n, y.group, { [y.noMinimalWidth]: o, [y.noLeftDecoration]: s, [y.noRightDecoration]: i }),
							onClick: l,
						},
						t
					)
			...
			function T(e) {
				return r.createElement('div', { className: a(L.fadeLeft, e.className, { [L.isVisible]: e.isVisible }) });
			}
			function B(e) {
				return r.createElement('div', { className: a(L.fadeRight, e.className, { [L.isVisible]: e.isVisible }) });
			}
			function A(e) {
			...
			function x(e) {
				return r.createElement(
					...
					r.createElement('div', { className: L.iconWrap }, r.createElement(w.Icon, { icon: W, className: L.icon }))
				);
			}
					...
					((o = class extends r.PureComponent {
						...
						render() {
							const {
								...
								b = d && h;
							return r.createElement(E.Measure, { onResize: u ? this._handleResizeWrap : null }, (d) =>
								r.createElement(
									'div',
									...
									r.createElement(
										...
										r.createElement(
											...
											r.createElement(E.Measure, { onResize: u ? this._handleResizeContent : null }, i)
										),
											...
											r.createElement(
												...
												!o &&
													r.Children.toArray([
														...
														e.DateRange && r.createElement(C, { key: 'range' }, r.createElement(e.DateRange, null)),
														e.Intervals &&
															r.createElement(
																C,
																{ key: 'intervals' },
														...
														e.AlertReferral &&
															...
															r.createElement(
																C,
																{ key: 'alert-referral' },
																r.createElement(e.AlertReferral, { className: U.button, displayMode: n })
															),
														e.ScalePercentage &&
															r.createElement(C, { key: 'percentage' }, r.createElement(e.ScalePercentage, null)),
														e.ScaleLogarithm &&
															r.createElement(C, { key: 'logarithm' }, r.createElement(e.ScaleLogarithm, null)),
														...v,
													]),
												(function (e) {
													const t = e.findIndex(
													...
													r.Children.toArray([
														...
														(e.Layout || e.SaveLoad) &&
															r.createElement(
																...
																!o && e.Layout && r.createElement(e.Layout, { id: h ? void 0 : H.Layouts }),
																e.SaveLoad &&
														...
														t.showLaunchInPopupButton &&
															...
															r.createElement(C, { key: 'popup' }, r.createElement(e.OpenPopup, null)),
														!o &&
			...
			class ue {
				...
				getDefaultIntervals() {
					return this._resolutionGetter ? this._resolutionGetter().map(ee.normalizeIntervalString) : [];
				}
				getCustomIntervals() {
			...
			class Ve extends r.PureComponent {
				constructor(e) {
					...
					(this._favoriteIntervalsService = l || new ne(ae.TVXWindowEvents, ie, E)),
						...
						(this._features = {
							...
							allowSymbolSearchSpread: m.enabled('header_symbol_search') && m.enabled('show_spread_operators'),
				...
				componentDidUpdate(e, t) {
					...
					n !== t.isVisible && (p.emit('toggle_header', n), this._negotiateResizer()), r || this._setDisplayMode();
				}
				render() {
