		...
		23550: (e, t, n) => {
			...
			class c extends r.LineDataSource {
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([n.e(6406), n.e(3889), n.e(8009), n.e(8056), n.e(8537)]).then(n.bind(n, 90490)))
				...
				static createProperties(e, t) {
					const n = new a.DefaultProperty({ defaultName: 'linetoolrotatedrectangle', state: t, theme: e });
					return this._configureProperties(n), n;
				}
				static _configureProperties(e) {
					super._configureProperties(e), e.addChild('linesColors', new l.LineToolColorsProperty([e.childs().color]));
				}
			}
		},
	},
