	...
	[2050],
	{
		...
		56621: (e, t, i) => {
			...
			class p extends l.LineDataSource {
				...
				startMoving(e, t, i, s) {
					super.startMoving(e, t, i, s), (this._coordOffsetWhileMovingOrChanging = this._findPixelsHeight());
				}
				endMoving(e, t, i) {
				...
				restoreExternalPoints(e, t) {
					if ((super.restoreExternalPoints(e, t), t.pricesChanged && this._points.length === e.points.length))
				...
				setPoint(e, t, i, s) {
					...
					u && !s && e < 4 && this._syncLineStyleChanges(u, { prices: this._points.map((e) => e.price) });
				}
				state(e) {
				...
				addPoint(e, t, i) {
					return (
						this._snapTo45DegreesApplicable(t) &&
							...
							this.snapPoint45Degree(e, this.points()[0]),
						2 === this._points.length && (e = this._convertLastPointTo3rdPoint((0, n.ensureNotNull)(this._lastPoint))),
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([i.e(6406), i.e(3889), i.e(8009), i.e(8056), i.e(8537)]).then(i.bind(i, 73653)))
				...
				_getAlertPlots() {
					...
					return (
						...
						[this._linePointsToAlertPlot(o, 'Upper', l, a), this._linePointsToAlertPlot(r, 'Lower', l, a)].filter(
							(e) => null !== e
						)
					);
				}
		...
		14267: (e, t, i) => {
			...
			function A(e) {
				...
				return {
					...(0, n.default)((0, s.default)(T), y.get(_.watchedTheme.value()) ?? y.get(l.StdTheme.Light)),
					...p,
			...
			class V extends d.LineDataSourceProperty {
					...
					1 === (e.state && 'version' in e.state ? e.state.version : 1) &&
						...
						this.addChild(
							...
							new f.LineToolWidthsProperty(
								g.map((e, t) => (0, o.ensureDefined)(this.child(`level${t + 1}`)).childs().lineWidth)
							)
						);
				}
				applyTemplate(e) {
					1 === ('version' in e ? e.version : 1) && ((e = A(e)), (e = (0, u.extractState)(e, this._templateKeys))),
				...
				_userSettings() {
					...
					return (
						...
						(0, u.extractState)((0, s.default)(e), this._allDefaultsKeys, this._excludedDefaultsKeys)
					);
				}
			}
		},
