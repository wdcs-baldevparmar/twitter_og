	...
	[9116, 1277],
	{
		32211: (e, t, i) => {
			...
			class _ extends a.LineSourcePaneView {
				...
				closeTextEditor() {
					(this._textWasEdited = !1), (this._isTextEditModeActivated = !1), this._hideTextEditor?.();
				}
				_placeHolderMode(e) {
					return (
			...
			class b extends _.LineDataSource {
				...
				onSelectionChange(e) {
					...
					if (void 0 !== e) {
						...
						i === n ? (t.cursorPosition = i) : (t.selectionRange = [Math.min(i, n), Math.max(i, n)]);
					}
		...
		27916: (e, t, i) => {
			i.d(t, { LineSourcePaneView: () => x, createLineSourcePaneViewPoint: () => p, thirdPointCursorType: () => _ });
			var n = i(19625),
				o = i(50151),
				s = i(69186),
				r = i(56468),
		...
		36036: (e, t, i) => {
			...
			function u(e, t, i, n) {
				const { point: o } = t,
					s = i + n / 2;
				(0, r.drawRoundRect)(e, o.x - s, o.y - s, 2 * s, 2 * s, (i + n) / 2), e.closePath(), (e.lineWidth = n);
			}
			function _(e, t, i, n) {
					...
					for (let e = 0; e < t.length; ++e) {
						...
						if (!((0, a.isInteger)(s.pointIndex) && c.linePointBeingEdited === s.pointIndex)) {
							...
							if (
								(o(
									l,
									{ ...s, point: new n.Point(Math.round(s.point.x * d) + g, Math.round(s.point.y * h) + g) },
									x / 2,
									_
								),
