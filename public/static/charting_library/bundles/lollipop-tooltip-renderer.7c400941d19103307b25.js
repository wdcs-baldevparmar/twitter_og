	...
	[9039],
	{
						...
						(e.enableBodyScroll = function (e) {
							if (r) {
								...
								(e.ontouchstart = null),
									...
									i &&
										0 === l.length &&
										(document.removeEventListener('touchmove', p, o ? { passive: !1 } : void 0), (i = !1));
							} else
		...
		66860: (e, t, o) => {
			...
			var n = o(50959),
				...
				c = o(1538),
				u = o.n(c);
			const p = (e) => n.createElement(a.Icon, { className: r(u().caret, e && u().activeCaret), icon: s });
			function d(e) {
				const {
					showCaret: t,
					iconOnly: o,
						...
						n.createElement(
							...
							s || a
								? n.createElement(
										...
										n.createElement('span', { className: u().visuallyHidden, 'aria-hidden': !0 }, d)
									)
								: n.createElement(
										n.Fragment,
										null,
		...
		41590: (e, t, o) => {
			...
			var d;
			function m(e) {
				const { position: t = 'Bottom', onClose: o, children: u, reference: d, className: m, theme: f = p } = e,
				...
				return (
					...
					n.createElement(
						...
						n.createElement(
							...
							g === v.currentDrawer && n.createElement('div', { className: p.backdrop, onClick: o }),
							n.createElement(
								h,
								{ className: l(f.drawer, p[`position${t}`], m), ref: y, 'data-name': e['data-name'] },
								u
							)
						)
					)
		...
		184: (e, t, o) => {
			...
			function y(e) {
				(0, n.useEffect)(() => {
					return (e = b), window.addEventListener('scroll', e), () => window.removeEventListener('scroll', e);
					var e;
				}, []),
					(0, n.useEffect)(() => {
						if (e.length)
			...
			var C = o(40173),
				...
				E = o(40711);
			function k(e) {
				const { title: t, icon: o, iconStyle: r, className: l, cardType: i, informationButtonProps: s } = e;
				return n.createElement(
					'div',
					{
						className: a()(
							E.lollipopTooltipTitle,
							['mob' === i && E.lollipopTooltipTitle_mobile, 'mini' === i && E.lollipopTooltipTitle_minimal],
							l
						),
					},
					o && n.createElement(x.Icon, { icon: o, className: E.lollipopTooltipTitle__icon, style: r }),
			...
			function D(e) {
				...
				return n.createElement(
					...
					t && n.createElement('div', { className: B.groupCell }, n.createElement('span', { className: B.text }, t)),
					n.createElement(
						'div',
			...
			function W(e) {
				const { content: t = [], subTitle: o, cardRowClass: r } = e,
					...
					i = 'string' == typeof o ? o : o.map((e, t) => n.createElement(D, { key: `subTitle${t}`, ...e }));
				return n.createElement(
					'div',
					{ className: r },
			...
			function F(e) {
				const {
					...
					p = (0, n.useMemo)(() => (r && l ? { color: e.style?.color } : void 0), [!!r, !!l, e.style?.color]),
				...
				return n.createElement(
					...
					n.createElement(
						'div',
						{ className: u },
						r && n.createElement(k, { title: r, icon: l, informationButtonProps: i, iconStyle: p, cardType: t }),
						(function () {
							switch (c.type) {
								case 'common':
			...
			var M = o(51287);
			const P = (0, C.mergeThemes)(w.DEFAULT_MENU_THEME, { menuWrap: M.menuWrap, menuBox: M.menuBox });
			function _(e) {
				const {
						tooltips: t,
						onClose: o,
						...
						n.createElement(u.MatchMedia, { rule: '(max-width: 419px)' }, (e) =>
							e
								? n.createElement(
										...
										t.map((e, t) => n.createElement(F, { key: `${t}`, className: M.drawerItem, cardType: 'mob', ...e }))
									)
								: n.createElement(
										g,
										{
										...
										n.createElement(
											...
											{ ref: T },
											t.map((e, t) =>
												n.createElement(F, { className: a()(M.card, v, f && M[f]), key: `${t}`, cardType: f, ...e })
											)
										),
										h &&
											n.createElement(
			...
			function R(e, t) {
				...
				return (
					b < n ? ((v = e.marginTop + u.top), (f = Math.max(b, 0))) : (v = u.height + u.top - y - n),
