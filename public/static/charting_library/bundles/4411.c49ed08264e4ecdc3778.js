(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[4411],
	{
		...
		98993: (e) => {
			e.exports = { button: 'button-F5dN3ulE', emoji: 'emoji-F5dN3ulE', emptySelect: 'emptySelect-F5dN3ulE' };
		},
		39453: (e) => {
			e.exports = {
		...
		67248: (e, t, n) => {
			...
			function g(e) {
				const { startSlot: t, iconOnly: n, children: o, endSlot: r, primaryText: s, secondaryText: i } = e;
				if (t && r && n) return c.createElement('span', { className: u(m().slot, m().startSlotWrap) }, t);
				const a = n && (t ?? r),
					l = !t && !r && !n && !o && s && i;
			...
			function x(e) {
				const {
					...
					{ isGrouped: u, cellState: d, disablePositionAdjustment: p } = (0, c.useContext)(y.ControlGroupContext),
					m = f({ ...l, isGrouped: u, cellState: d, disablePositionAdjustment: p }),
					h = n ?? (e.primaryText ? [e.primaryText, e.secondaryText].join(' ') : (0, v.getTextForTooltip)(e.children));
				return c.createElement(
					'button',
					{
						...C(l),
		...
		66860: (e, t, n) => {
			...
			var o = n(50959),
				...
				c = n(1538),
				u = n.n(c);
			const d = (e) => o.createElement(a.Icon, { className: r(u().caret, e && u().activeCaret), icon: l });
			function p(e) {
				const {
					showCaret: t,
					iconOnly: n,
		...
		67029: (e, t, n) => {
			...
			function v(e, t) {
				const {
					...
					{ isGrouped: O, cellState: k, disablePositionAdjustment: N = !1 } = (0, o.useContext)(l.ControlGroupContext),
		...
		78274: (e, t, n) => {
			...
			function a(e) {
				...
				return o.createElement('span', { className: r(i()['inner-slot'], n && i().interactive, s && i().icon, t) }, a);
			}
			function l(e) {
				...
				return o.createElement(p.ControlSkeleton, {
					...
					middleSlot: o.createElement(
						...
						o.createElement('input', {
							...H,
							className: r(f().input, f()[`size-${M}`], L, V && f()['with-start-slot'], I && f()['with-end-slot']),
							disabled: A,
							readOnly: F,
							ref: U,
						})
		...
		48027: (e, t, n) => {
			...
			function s(e) {
				...
				return { ...e, intent: s || (l ? 'primary' : 'default'), highlight: i ?? l, onFocus: u, onBlur: d };
			}
		},
		29202: (e, t, n) => {
			'use strict';
		...
		53680: (e, t, n) => {
				...
				return P && r
					? s.createElement(f.InputControl, {
							...
							onKeyDown: function (t) {
								...
								0 === o && 0 === r && a && 8 === (0, m.hashFromEvent)(t) && (t.preventDefault(), n?.(l));
							},
			...
			class T extends s.PureComponent {
				constructor(e) {
					if (
						...
						(this._handleChange = (e) => {
							...
							if (t && '' === e) this.setState({ queryValue: e, isOpened: !1, active: void 0 }), s && s();
							else {
								const t = this._suggestions(e),
									o = Object.keys(t).length > 0;
								this.setState({ queryValue: e, isOpened: o, active: n ? void 0 : this._getActiveKeyByValue(e) }),
									o && r && r();
							}
							n && o && o(e);
						}),
						...
						(this._handleKeyDown = (e) => {
							...
							const { allowUserDefinedValues: t, value: n, onChange: r, onSuggestionsOpen: s } = this.props,
							...
							switch (e.which) {
								...
								case o.Enter:
									...
									t && (a && h ? this.setState(this._valueToQuery(h)) : (h = l)),
										void 0 !== h &&
											(this._close(), a || this._blur(), h !== n ? r && r(h) : this.setState(this._valueToQuery(h)));
							}
						}),
				...
				render() {
					...
					return s.createElement(u.OutsideEvent, { handler: this._handleOutsideClick, click: !0 }, (t) =>
						s.createElement(
							'div',
								...
								endSlot: Object.keys(this._suggestions(this.state.queryValue)).length
									? s.createElement(
											...
											s.createElement(
												...
												s.createElement(l.ToolWidgetCaret, { className: k.icon, dropped: this.state.isOpened })
											)
										)
									: void 0,
		...
		82930: (e, t, n) => {
			...
			const D = () => null,
				...
				B = 200;
			function O(e) {
				const { value: t, disabled: n, onSelect: i, onClose: d, canBeEmpty: m, renderButton: y = k } = e,
					b = (0, o.useRef)(null),
							...
							o.createElement(
								...
								e
									...
									: o.createElement(
											...
											o.createElement(s.EmojiList, { className: w.desktopSize, emojis: A, onSelect: _, height: R })
										)
							)
					)
				);
			...
			function c(e, t) {
				return (n) => {
					...
					const E = y === o.Top ? -1 * g : g,
						...
						w = { x: C - (h === i.FromRightToLeft ? c : 0) + f, y: x - (b === s.FromBottomToTop ? u : 0) + E };
