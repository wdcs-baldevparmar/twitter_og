	...
	[8949],
	{
		...
		38039: (e, t, i) => {
			...
			class a extends o.DefaultProperty {
				...
				applyTemplate(e) {
					this.mergeAndFire(
						(0, o.extractState)((0, n.default)((0, s.default)(this._factoryDefaultsSupplier()), e), this._templateKeys)
					);
				}
			}
		},
		86915: (e, t, i) => {
			...
			class S extends r.LineToolSvgIconBase {
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([i.e(6406), i.e(3889), i.e(8009), i.e(8056), i.e(8537)]).then(i.bind(i, 18009)))
						.LineDataSourceDefinitionsViewModel;
				}
				async _loadViews() {
					const [{ getSvgContentForSticker: e, getSvgRenderer: t }, { StickerPaneView: s }] = await Promise.all([
		...
		22329: (e, t, i) => {
			...
			class u extends l.LineDataSource {
				...
				startChanging(e, t) {
					...
					(this._changePointData = { centerPoint: i, initialLength: c, initialSize: a }), super.startChanging(e, t);
				}
				setPoint(e, t, i) {
					const { centerPoint: s, initialLength: r, initialSize: o } = (0, n.ensureNotNull)(this._changePointData),
						a = (0, n.ensureNotNull)(this.pointToScreenPoint(t)),
						l = this.properties().childs();
					if (0 === e || 1 === e) {
						const t = a.subtract(s).normalized();
						let i = Math.acos(-t.x);
						Math.asin(t.y) > 0 && (i = 2 * Math.PI - i), 0 === e && (i += Math.PI), l.angle.setValue(i);
					} else {
