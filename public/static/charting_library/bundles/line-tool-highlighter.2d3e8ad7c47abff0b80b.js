	...
	[2087],
	{
		65539: (e, i, t) => {
			...
			class h extends s.LineToolBrushBase {
				constructor(e, i, t, r) {
					super(e, i ?? h.createProperties(e.backgroundTheme().spawnOwnership()), t, r), this._loadPaneViews(e);
				}
				smooth() {
				...
				static createProperties(e, i) {
					const t = new r.DefaultProperty({ defaultName: 'linetoolhighlighter', state: i, theme: e });
