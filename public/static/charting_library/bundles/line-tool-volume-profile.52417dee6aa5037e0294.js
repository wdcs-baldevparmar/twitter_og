...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[5695],
	{
		25937: (e, t, o) => {
			...
			class p extends s.LineToolVbPFixed {
				constructor(e, t, o, i, s) {
					super(e, t, o || (0, d.studyMetaInfoRepository)().findByIdSync({ type: 'java', studyId: h }), i, s);
				}
				calcIsActualSymbol() {
				...
				static createProperties(e, t) {
					const o = r.StudyMetaInfo.getStudyPropertyRootNameById(h),
						s = (0, i.ensureNotNull)((0, d.studyMetaInfoRepository)().findByIdSync({ type: 'java', studyId: h })),
						n = (0, l.createDefaultsState)(!0, o, [], (0, d.studyMetaInfoRepository)().studyVersioning());
		...
		71131: (e, t, o) => {
			...
			function m(e, t, o, i) {
				return t.styles && (_(t.styles.developingPoc), _(t.styles.developingVAHigh), _(t.styles.developingVALow)), t;
			}
			function _(e) {
			...
			class P extends n.StudyLineDataSource {
					...
					super(
						...
						this._createPaneViews().then((e) => {
							this._setPaneViews(e),
								e.forEach((e) => e.update((0, c.sourceChangeEvent)({ sourceId: this.id(), clearData: !0 })));
						}),
						this.clearData();
				}
				pointsCount() {
				...
				static createProperties(e, t) {
					const o = r.StudyMetaInfo.getStudyPropertyRootNameById(f),
						i = (0, s.ensureNotNull)((0, y.studyMetaInfoRepository)().findByIdSync({ type: 'java', studyId: f })),
						n = (0, u.createDefaultsState)(!0, o, [], (0, y.studyMetaInfoRepository)().studyVersioning());
					return this.createPropertiesFromStudyMetaInfoAndState(
						i,
						i,
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([o.e(1190), o.e(3889), o.e(8009), o.e(4482), o.e(607)]).then(o.bind(o, 31507)))
				...
				_updateAnchors() {
					...
					this._timePoint.length && ((this._timePoint[0].price = t), (this._timePoint[1].price = o)),
				...
				static _configureProperties(e) {
					super._configureProperties(e),
						e.setThemedColors(
							(0, p.volumeProfileThemedColors)(e.childs().graphics.childs().polygons?.hasChild('histBoxBg'))
						);
				}
				_getLeftIndex() {
		...
		47988: (e, t, o) => {
			...
			function p(e) {
				...
				return e && i.push({ path: 'graphics.polygons.histBoxBg.color', colors: h.histogramBoxColor }), i;
			}
		},
	},
]);
