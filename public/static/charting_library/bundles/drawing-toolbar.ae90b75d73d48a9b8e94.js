(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[2878],
	{
		...
		36189: (e, t, o) => {
			...
			function h(e) {
				const { className: t, isFilled: o, isActive: i, onClick: h, title: m, ...v } = e,
					...
					b = m ?? (o ? a.removeTitlesMap[a.RemoveTitleType.Remove] : a.removeTitlesMap[a.RemoveTitleType.Add]);
				return (
					(0, n.useLayoutEffect)(() => {
						const e = p.current;
						e instanceof HTMLElement && b && e.dispatchEvent(new CustomEvent('common-tooltip-update'));
					}, [b, p]),
					n.createElement(s.Icon, {
						...v,
						className: l()(d.favorite, 'apply-common-tooltip', o && d.checked, i && d.active, g && d.focused, t),
						onClick: h,
						icon: o ? c : u,
						title: b,
						ariaLabel: b,
		...
		65171: (e) => {
			e.exports = { 'tablet-small-breakpoint': '(max-width: 440px)', stickerRow: 'stickerRow-KUOIljqV' };
		},
		59453: (e) => {
		...
		73824: (e) => {
			e.exports = { sectionTitle: 'sectionTitle-Srvnqigs', newBadge: 'newBadge-Srvnqigs', label: 'label-Srvnqigs' };
		},
		82374: (e) => {
			e.exports = {
				wrap: 'wrap-Z4M3tWHb',
		...
		40894: (e, t, o) => {
			...
			function u(e) {
				const { onClick: t, isFilled: o, isActive: i, ...u } = e,
					...
					m = o ? r.removeTitlesMap[r.RemoveTitleType.Remove] : r.removeTitlesMap[r.RemoveTitleType.Add];
				return (
					(0, n.useLayoutEffect)(() => {
						const e = d.current;
		...
		37159: (e, t, o) => {
				...
				fe = (0, n.forwardRef)((e, t) => {
					...
					return (
						...
						n.createElement(
							...
							!m &&
								(g
									? k && n.createElement(me.Drawer, { className: b.drawer, onClose: O, position: 'Bottom' }, d)
									: n.createElement(
											ue.PopupMenu,
											{
												theme: F,
			...
			var ye = o(74099);
			var Le = o(173);
			const Ae = new xe('RECENT_EMOJIS_CHANGED', 'linetoolemoji.recents', Le.removeUnavailableEmoji, 'emojiTool');
			var Me;
			!(function (e) {
				(e.Elon = 'elon'),
					(e.Doge = 'doge'),
			...
			const Ue = {
				[W.Icons]: {
					...
					ItemComponent: function (e) {
						...
						return n.createElement('div', { className: a()(ye.item, o) }, n.createElement(ke, { charCode: Number(t) }));
					},
					icons: se,
					onEmojiSelect: (e) => {
			...
			var qe = o(19291),
				...
				Qe = o(3845),
				Ye = o(33430);
			const $e = { icon: B.t(null, void 0, o(37913)), dropdownTooltip: B.t(null, void 0, o(73829)) },
			...
			function tt(e) {
				...
				return n.createElement(
					fe,
					{
						...
						onClickWhenGrayed: () =>
							(0, h.emit)('onGrayedObjectClicked', { type: 'drawing', name: g.lineToolsInfo[r].localizedName }),
			...
			class st extends n.PureComponent {
				...
				render() {
					return this.state.isVisible
						? n.createElement(I, { action: this._handleClick, isTransparent: !0, toolName: 'zoom-out' })
				...
				constructor(e) {
					super(e),
						...
						(this._handleGrayedClick = (e) => {
							(0, h.emit)('onGrayedObjectClicked', { type: 'drawing', name: g.lineToolsInfo[e].localizedName });
						}),
							...
							s.map((s, a) => {
								if ('title' in s)
									return n.createElement(
										...
										s.title && n.createElement(ct.ToolWidgetMenuSummary, { className: vt.sectionTitle }, s.title)
									);
								const { name: u } = s,
				...
				constructor(e) {
					super(e),
						...
						(this._handleRemoveStudies = () => {
							xt('remove indicator'),
								this.props.chartWidgetCollection.activeChartWidget.value().actions().paneRemoveAllStudies.execute();
						}),
			...
			function Mt(e) {
				...
				const r = g.lineToolsInfo.hideAllDrawings,
					{ trackLabel: c, tooltip: u, dataName: d } = (0, l.ensureDefined)((0, kt.getHideOptions)().get(s)),
			...
			class Rt extends n.PureComponent {
				...
				componentDidMount() {
					const e = (this._promise = (0, l.ensureNotNull)((0, Bt.getFavoriteDrawingToolbarPromise)()));
					e.then((t) => {
						this._promise === e &&
							((this._instance = t),
			...
			function jt(e) {
				...
				function s(e) {
					void 0 !== e &&
						((0, bt.trackEvent)('GUI', 'Magnet mode', e === Ht.MagnetMode.WeakMagnet ? 'Weak' : 'Strong'),
			...
			class To extends n.PureComponent {
				constructor(e) {
					super(e),
						...
						(this._handleWidgetbarSettled = (e) => {
							this.setState({ isWidgetbarVisible: Boolean(window.widgetbar?.visible().value()), widgetbarSettled: e });
						}),
						...
						this._filteredLineTools.forEach((e) => {
							e.items.forEach((e) => {
								'name' in e &&
									(this._grayedTools[e.name] = this._toolsFilter.isToolGrayed(g.lineToolsInfo[e.name].localizedName));
							});
						}),
						(this.state = {
							isHovered: !1,
				...
				componentDidMount() {
					T.isDrawingToolbarVisible.subscribe(this._handleChangeVisibility),
						...
						this.props.widgetbarSettled &&
							...
							v.CheckMobile.any() && window.widgetbar?.visible().subscribe(this._handleWidgetbarVisible));
				}
				componentWillUnmount() {
				...
				render() {
					...
					let c;
					c = n.createElement(lo, { toolbarVisible: l, 'data-name': 'toolbar-drawing-toggle-button' });
					const h = () => !!this._features.tools && !(!u.enabled('show_object_tree') || (vo && !mo));
					return n.createElement(
						uo.RegistryProvider,
														...
														this._filteredLineTools.map((o) =>
															n.createElement(gt, {
																...
																favoriting:
																	...
																	!('linetool-group-cursors' === o.id && (0, p.isOnMobileAppPage)('any')),
				...
				_negotiateResizer() {
					...
					this.props.resizerBridge.negotiateWidth(this.state.isVisible ? Kt.TOOLBAR_WIDTH_EXPANDED : e);
				}
				_handleGlobalClose() {
					go.fire();
				}
