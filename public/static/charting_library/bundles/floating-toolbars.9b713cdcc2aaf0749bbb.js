(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[2306],
	{
		...
		67248: (t, e, o) => {
			...
			function _(t) {
				const { startSlot: e, iconOnly: o, children: i, endSlot: n, primaryText: r, secondaryText: s } = t;
				if (e && n && o) return c.createElement('span', { className: h(u().slot, u().startSlotWrap) }, e);
				const a = o && (e ?? n),
					l = !e && !n && !o && !i && r && s;
							...
							return (
								...
								c.createElement(
									...
									'string' == typeof t.secondaryText
										? c.createElement('span', { className: u().secondaryText }, ' ', t.secondaryText, ' ')
										: c.createElement(
												'span',
			...
			function C(t) {
				const {
					...
					{ isGrouped: h, cellState: d, disablePositionAdjustment: p } = (0, c.useContext)(f.ControlGroupContext),
					u = g({ ...l, isGrouped: h, cellState: d, disablePositionAdjustment: p }),
					m = o ?? (t.primaryText ? [t.primaryText, t.secondaryText].join(' ') : (0, v.getTextForTooltip)(t.children));
				return c.createElement(
					'button',
					{
						...w(l),
				...
				return i.createElement(
					...
					i.createElement(d.ColorPicker, {
						...
						onColorChange: function (t, e) {
							...
							W((0, c.generateColor)(String(t), o, true)), e || (0, s.ensureNotNull)(C.current).close();
						},
		...
		59369: (t, e, o) => {
					...
					(0, i.useLayoutEffect)(() => {
						const t = (0, n.ensureNotNull)(e.current),
							o = () => {
								...
								if (0 === o.length || (o[0].parentElement && !u(o[0].parentElement, (0, n.ensureNotNull)(e.current)))) {
									const i = (function (t) {
									...
									if (null === i) return;
									if (((0, a.becomeMainElement)(i), o.length > 0)) for (const t of o) (0, a.becomeSecondaryElement)(t);
								}
							};
						return (
			...
			function p(t) {
				return Array.from(t.querySelectorAll('[data-role="row"]')).filter((0, l.createScopedVisibleElementFilter)(t));
			}
			function u(t, e) {
					...
					super(...arguments),
						...
						(this._handlePosition = (t) => {
							...
							const i = (0, h.ensureNotNull)(this._container).getBoundingClientRect(),
								n = t.clientX - i.left,
								r = t.clientY - i.top;
							o({ h: e, s: (0, P.clamp)(n / i.width, 0, 1), v: (0, P.clamp)(1 - r / i.height, 0, 1) });
						}),
				...
				render() {
					...
					return i.createElement(
						...
						i.createElement(
							...
							i.createElement('div', { className: B.pointer, style: { left: 100 * o + '%', top: 100 * (1 - n) + '%' } })
						)
					);
				}
			}
			...
			function r(t, e) {
				return class extends i.PureComponent {
					render() {
						...
						if (!o) return null;
						const s = i.createElement(t, { ...this.props, ref: this.props.componentRef, zIndex: 150 });
			...
			function c(t, e) {
				return (o) => {
					...
					const b = f === i.Top ? -1 * _ : _,
						...
						T = { x: w - (m === s.FromRightToLeft ? c : 0) + g, y: C - (y === r.FromBottomToTop ? h : 0) + b };
				...
				_renderContent(t) {
					...
					return _
						? i.createElement(
								...
								i.createElement(
									d.Drawer,
									{ reference: this.props.drawerReference, onClose: this._handleClose, position: l, 'data-name': e },
									v
								)
							)
						: i.createElement(
		...
		10540: (t, e, o) => {
				...
				constructor(t) {
					(this._helper = null),
						...
						(this._handleDragStop = (t) => {
							if (null === this._helper) return;
							this._source.classList.remove('ui-draggable-dragging'), (this._helper = null), this._stop?.();
						});
			...
			class y {
					...
					(this._items = []),
						...
						(this._handleDragStart = (t) => {
							...
							(this._helper = {
								...
								rightBorder: n.right - b(o, 'padding-right') - b(o, 'border-right-width') - i.right + 1,
								topBorder: n.top + b(o, 'padding-top') + b(o, 'border-top-width') - i.top - 1,
								bottomBorder: n.bottom - b(o, 'padding-bottom') - b(o, 'border-bottom-width') - i.bottom + 1,
							}),
				...
				_getAllItems() {
					return this._items?.length || (this._items = Array.from(this._options.source.children)), this._items;
				}
		...
		46675: (t, e, o) => {
			...
			class g extends m.Property {
				...
				unsubscribe(t, e) {
					const o = (0, u.ensureDefined)(this._listenersMappers.find((o) => o.obj === t && o.method === e)?.callback);
			...
			function T(t) {
				...
				return d && d.length
					? i.createElement(
							y.MatchMediaMap,
							{ rules: { isSmallWidth: w.DialogBreakpoints.TabletSmall, isSmallHeight: '(max-height: 440px)' } },
			...
			function L(t) {
				...
				return i.createElement(D.ToolButton, { className: v(e, W.button), tooltipPosition: 'horizontal', ...o });
			}
			var k = o(65186),
				N = o(91244);
			function M(t) {
				...
				const a = s[0].properties().frozen,
					l = (0, B.useProperty)(a),
					c = l ? { tooltip: r.t(null, void 0, o(99894)), icon: k } : { tooltip: r.t(null, void 0, o(51077)), icon: N };
			...
			function j(t) {
				...
				const l = (0, B.useProperty)((0, h.alignTo45Degrees)()),
					c = l ? { tooltip: r.t(null, void 0, o(31145)), icon: U } : { tooltip: r.t(null, void 0, o(83187)), icon: U };
				return i.createElement(L, {
					className: n,
					isActive: Boolean(l),
					onClick: function () {
			...
			function $(t) {
				...
				return i.createElement(S.ToolWidgetIconButton, {
					...
					onClick: function () {
						(0, x.trackEvent)('GUI', 'Context action on drawings', 'Cancel Drawing'), o.resetDrawingState();
					},
				});
			}
			var K = o(9745),
			...
			async function it(t, e) {
				const i = [(0, A.createVisualOrderAction)(t, e), (0, A.createChangeIntervalsVisibilitiesAction)(t, e)],
					n = (function (t, e) {
						const i = [],
							n = tt.isMacKeyboard ? ' +' : '',
						...
						if (a.length > 0) {
							...
							i.push(new ot.Action({ actionId: 'Chart.Clipboard.CopyLineTools', options: e, id: 'Copy' }));
						}
						return i;
					})(t, e);
				...
				return i.createElement(
					Q.ToolWidgetMenu,
					{
						...
						content: i.createElement(
							...
							!l && 'mixed' !== c && i.createElement('div', { className: Et.buttonLabel }, `${c}px`)
						),
					},
					Bt.map((t) =>
			...
			function Wt(t) {
				const { activeChartWidget: e, className: o, actionId: n } = t,
					...
					s = I(
						() => new A.ActionsProvider(e).actionForLineTools(e.model().selection().lineDataSources(), n),
						(t) => t?.destroy(),
						[e, r]
					);
				if (!s) return null;
			...
			const Lt = new s.TranslatedString('change line tool(s) font size', r.t(null, void 0, o(37453))),
			...
			class Gt {
				constructor(t) {
					(this._isDrawingFinished = new l.WatchedValue(!0)),
						...
						(this._floatingToolbar = new b.FloatingToolbar({
							defaultPosition: { top: vt.HEADER_TOOLBAR_HEIGHT_EXPANDED + 15, left: window.innerWidth / 2 },
				...
				async _onToolChanged(t, e) {
					...
					this._isDrawingToolExcludingCustomUrlEventTool(t)
						? (this._isDrawingFinished.setValue(!1), this._createCancelButton(), this._updateVisibility())
						: o && o.length
							? (o.length > 1 && this._isDrawingFinished.setValue(!0), this.refresh())
							: this.hide();
				}
				async _onSourceChanged(t) {
					if (!t?.length) return (this._propertiesVisible = !1), (this._toolbarVisible = !1), void this.hide();
					if (
				...
				_createSettingsButton() {
					const t = { component: P, props: { title: At, activeChartWidget: this.activeChartWidget() } };
				...
				_createAnchorButton() {
					const t = {
						component: V,
						props: { title: r.t(null, void 0, o(24185)), activeChartWidget: this.activeChartWidget() },
					};
					this._addCommonButton(t);
				}
				...
				_createCancelButton() {
					if ((null !== this._cancelButton && this._clearCancelButtons(), !jt || null === this._currentTool)) return;
				...
				_createActionCommonButtons() {
					...
					const t = {
						component: Wt,
						props: { actionId: 'Chart.SelectedObject.InsertColumnTable', activeChartWidget: this.activeChartWidget() },
					};
					this._addActionCommonButton(t);
					const e = {
						component: Wt,
						props: { actionId: 'Chart.SelectedObject.InsertRowTable', activeChartWidget: this.activeChartWidget() },
					};
				...
				_createLineStyleButton(t) {
					...
					return (
						this._addPropertyButton({
							component: ut,
							props: { property: o, title: Ot, propertyApplier: i, 'data-name': 'style', undoText: kt },
						}),
						!0
					);
				}
				...
				_createHighlighterWidthsButton(t, e) {
					if (
						...
						return !0;
					const o = e && 1 !== this.selectedSources().filter((t) => t.properties().widths).length ? Ut : Ht;
					return (
						this._addPropertyButton({
							component: Dt,
							props: {
		...
		36074: (t, e, o) => {
			...
			class D extends n {
				...
				_highlighterPropertiesExceptionCase() {
					return [
						this._defaultLinesColorProperty(),
						{ name: 'widths', inputType: 'combobox', factory: D.prototype._createHighlighterWidthsButton },
					];
				}
				...
				_textPropertiesExceptionCases() {
					return [
						{ name: 'color', title: _, inputType: 'colorPicker', iconSvgCode: c, dataName: 'text-color', undoText: p },
						{
							name: 'backgroundColor',
							title: f,
							inputType: 'colorPicker',
		...
		95166: (t, e, o) => {
			...
			class r extends n.Property {
				...
				unsubscribe(t, e) {
					const o = (0, i.ensureDefined)(this._listenersMappers.find((o) => o.obj === t && o.method === e)?.callback);
					this._baseProperty.unsubscribe(t, o);
				}
				unsubscribeAll(t) {
					this._baseProperty.unsubscribeAll(t);
