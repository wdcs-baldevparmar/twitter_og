	...
	[360],
	{
		...
		13506: (t, e, i) => {
			...
			class h extends r.LineToolBrushBase {
				constructor(t, e, i, o) {
					super(t, h.createProperties(t.backgroundTheme().spawnOwnership()), !1, (0, n.randomHash)()),
				...
				static createProperties(t) {
					const e = new o.DefaultProperty({ defaultName: '', useUserPreferences: !1, state: void 0, theme: t });
					return this._configureProperties(e), e;
				}
				_ignoreSourceEvent(t) {
					return 'data-source-change' === t.type && t.sourceId !== this.model().crosshairSource().id();
				}
			}
		},
		27916: (t, e, i) => {
			...
			class g {
				...
				_getSelectionRenderer(t) {
					for (; this._selectionRenderers.length <= t; ) this._selectionRenderers.push(new a.SelectionRenderer());
					return this._selectionRenderers[t];
				}
				_getLineAnchorRenderer(t) {
					for (; this._lineAnchorRenderers.length <= t; ) this._lineAnchorRenderers.push(new l.LineAnchorRenderer());
		...
		36036: (t, e, i) => {
			...
			function u(t, e, i, n) {
				const { point: o } = e,
					r = i + n / 2;
				(0, s.drawRoundRect)(t, o.x - r, o.y - r, 2 * r, 2 * r, (i + n) / 2), t.closePath(), (t.lineWidth = n);
			}
			function _(t, e, i, n) {
					...
					for (let t = 0; t < e.length; ++t) {
						...
						if (!((0, a.isInteger)(r.pointIndex) && d.linePointBeingEdited === r.pointIndex)) {
							...
							if (
								(o(
									l,
									{ ...r, point: new n.Point(Math.round(r.point.x * h) + P, Math.round(r.point.y * c) + P) },
									g / 2,
									_
								),
		...
		74011: (t, e, i) => {
			...
			class p extends h.MediaCoordinatesPaneRenderer {
				...
				hitTest(t) {
					...
					return this._data.filled && this._data.fillBackground && (0, n.pointInPolygon)(t, this._data.points)
						? this._backHittest
						: null;
				}
				_drawImpl(t) {
					...
					try {
						if ((void 0 !== this._data.globalAlpha && (e.globalAlpha = this._data.globalAlpha), 1 === i))
						...
						if (
							(this._data.filled &&
								...
								((e.fillStyle = (0, l.generateColor)(this._data.backcolor, this._data.transparency)), e.fill()),
							this._data.filled && !this._data.skipClosePath && e.closePath(),
							i > 1)
						) {
							if (this._data.leftend === s.LineEnd.Arrow) {
								const t = this._correctArrowPoints(this._points[1], this._points[0], e.lineWidth, n);
								(0, r.drawArrow)(t[0], t[1], e, e.lineWidth, _.dpr1PixelRatioInfo);
							}
							if (this._data.rightend === s.LineEnd.Arrow) {
								const t = this._correctArrowPoints(this._points[i - 2], this._points[i - 1], e.lineWidth, n);
								(0, r.drawArrow)(t[0], t[1], e, e.lineWidth, _.dpr1PixelRatioInfo);
							}
						}
				...
				_drawPoint(t, e, i, n) {
					0 !== i &&
						(t.beginPath(), (t.fillStyle = n), t.arc(e.x, e.y, i, 0, 2 * Math.PI, !0), t.fill(), t.closePath());
				}
