(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[9928],
	{
		...
		67248: (t, e, n) => {
			...
			function f(t) {
				const { startSlot: e, iconOnly: n, children: r, endSlot: o, primaryText: s, secondaryText: a } = t;
				if (e && o && n) return c.createElement('span', { className: u(m().slot, m().startSlotWrap) }, e);
				const i = n && (e ?? o),
					l = !e && !o && !n && !r && s && a;
			...
			function y(t) {
				const {
					...
					{ isGrouped: u, cellState: h, disablePositionAdjustment: d } = (0, c.useContext)(v.ControlGroupContext),
					m = g({ ...l, isGrouped: u, cellState: h, disablePositionAdjustment: d }),
					p = n ?? (t.primaryText ? [t.primaryText, t.secondaryText].join(' ') : (0, b.getTextForTooltip)(t.children));
				return c.createElement(
					'button',
					{
						...w(l),
		...
		67029: (t, e, n) => {
			...
			function b(t, e) {
				const {
					...
					{ isGrouped: W, cellState: N, disablePositionAdjustment: M = !1 } = (0, r.useContext)(l.ControlGroupContext),
				...
				return r.createElement(d.ControlSkeleton, {
					...
					middleSlot: r.createElement(
						...
						r.createElement('input', {
							...J,
							className: o(g().input, g()[`size-${T}`], I, L && g()['with-start-slot'], j && g()['with-end-slot']),
							disabled: O,
							readOnly: _,
							ref: U,
						})
		...
		48027: (t, e, n) => {
			...
			function s(t) {
				...
				return { ...t, intent: s || (l ? 'primary' : 'default'), highlight: a ?? l, onFocus: u, onBlur: h };
			}
		},
		45812: (t, e, n) => {
			'use strict';
			...
			function c(t) {
				...
				return r.createElement(
					...
					r.createElement(o.InputControl, {
						...
						endSlot: r.createElement(r.Fragment, null, A.icon && r.createElement(a.EndSlot, { icon: !0 }, A.icon), m),
						'aria-required': B,
						'aria-invalid': W,
		...
		1140: (t, e, n) => {
			...
			function P(t) {
				...
				return r.createElement(C.Icon, { icon: w, className: o(y['error-icon'], y[`intent-${e}`]) });
			}
			var S,
				D,
				E = n(41437);
				...
				const {
					...
					S = r.useCallback(
						(t) => {
							if (!t) return;
							const e = y.current;
							e.has(t) ? e.delete(t) : e.set(t, t), 0 !== e.size ? w(Array.from(e.keys()).join(' ')) : w(void 0);
						},
						[w, y.current]
					),
					{
