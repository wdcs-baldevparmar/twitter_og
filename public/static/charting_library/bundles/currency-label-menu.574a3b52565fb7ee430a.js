	...
	[2704],
	{
		...
		28587: (e, t, n) => {
			...
			const S = o.memo(
				function (e) {
					...
					return o.createElement(
						'div',
						{ className: p()(M.action, l && M.active, E, h && M.withDescription, d && M.selected), onClick: C, ref: m },
						v &&
							(void 0 !== n
				...
				return o.createElement(F.AdaptivePopupDialog, {
					...
					render: function () {
						return o.createElement(
							o.Fragment,
							null,
							o.createElement(_.DialogSearch, { placeholder: v.t(null, void 0, n(8573)), onChange: f, reference: m }),
							o.createElement(
								'div',
			...
			function O(e) {
				...
				return o.createElement(c.MatchMedia, { rule: d.DialogBreakpoints.TabletSmall }, (e) =>
					e
						...
						: o.createElement(N, { ...n, ...C, position: (0, m.getPopupPositioner)(t, B), doNotCloseOn: t })
				);
				function E() {
				...
				destroy() {
					s.unsubscribe(r.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._close, this),
						...
						null !== this._rootInstance &&
							(this._rootInstance.unmount(), (this._rootInstance = null), this._menuClosedCallback());
				}
				_render() {
					...
					null !== this._rootInstance
						...
						: (this._rootInstance = (0, i.createReactRoot)(e, document.createElement('div'), 'modern'));
				}
			}
		},
		74670: (e, t, n) => {
		...
		36189: (e, t, n) => {
			...
			function m(e) {
				const { className: t, isFilled: n, isActive: r, onClick: m, title: h, ...p } = e,
					...
					g = h ?? (n ? a.removeTitlesMap[a.RemoveTitleType.Remove] : a.removeTitlesMap[a.RemoveTitleType.Add]);
				return (
					(0, o.useLayoutEffect)(() => {
						const e = v.current;
					...
					o.createElement(s.Icon, {
						...p,
						className: i()(d.favorite, 'apply-common-tooltip', n && d.checked, r && d.active, f && d.focused, t),
						onClick: m,
						icon: n ? l : u,
						title: g,
						ariaLabel: g,
					...
					.map((e) => {
						...
						return (
							n.forEach((e) => {
								...
								if (((n.lastIndex = 0), (0, o.isString)(t) && t && t.toLowerCase() === r.toLowerCase()))
		...
		39706: (e, t, n) => {
			...
			const c = (0, o.forwardRef)(function (e, t) {
				const { open: n, summary: r, children: c, onStateChange: l, tabIndex: u, className: d, ...m } = e;
				return o.createElement(
					o.Fragment,
					null,
					o.createElement(
			...
			function l(e, t) {
				return (n) => {
					...
					const x = C === o.Top ? -1 * f : f,
						...
						A = { x: w - (p === s.FromRightToLeft ? l : 0) + v, y: y - (E === i.FromBottomToTop ? u : 0) + x };
		...
		75556: (e, t, n) => {
			...
			function a(e, t, a) {
				...
				return (x.length > 0 || E.length > 0) && c.push({ id: 'second_section', actions: E.concat(x) }), c;
			}
		},
		49992: (e, t, n) => {
			'use strict';
		...
		59363: (e, t, n) => {
			...
			function a(e, t, a) {
				...
				(C.length > 0 || E.length > 0) &&
					v.actions.push(...E.sort((e, t) => e.label.toLowerCase().localeCompare(t.label.toLowerCase())), ...C),
					v.actions.length > 0 && c.push(v);
		...
		8481: (e, t, n) => {
			...
			function o(e, t, n, o, r, i, s, a) {
				return { id: e, label: t, icon: n, description: o, isActive: r, onClick: i, isFavorite: s, onFavoriteClick: a };
			}
