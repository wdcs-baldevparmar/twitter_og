	...
	[8009],
	{
		26434: (e, t, i) => {
			...
			var r = i(11542),
				...
				c = i(73305),
				d = i(46112);
			const p = new n.TranslatedString('change {title} visibility on ticks', r.t(null, void 0, i(98596))),
				u = new n.TranslatedString('change {title} visibility on seconds', r.t(null, void 0, i(41315))),
				...
				P = new n.TranslatedString('change {title} visibility on minutes', r.t(null, void 0, i(78219))),
				...
				f = new n.TranslatedString('change {title} visibility on hours', r.t(null, void 0, i(68715))),
				...
				b = new n.TranslatedString('change {title} visibility on days', r.t(null, void 0, i(56402))),
				...
				S = new n.TranslatedString('change {title} visibility on weeks', r.t(null, void 0, i(71084))),
				...
				D = new n.TranslatedString('change {title} visibility on months', r.t(null, void 0, i(67583))),
			...
			function ce(e, t) {
					...
					const r = (0, o.createRangePropertyDefinition)(
						{
							...
							from: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.secondsFrom), E, t),
							to: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.secondsTo), Y, t),
						},
						{
							id: 'IntervalsVisibilitiesSecond',
							title: A,
				...
				const r = (0, o.createRangePropertyDefinition)(
						{
							checked: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.minutes), j, t),
							from: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.minutesFrom), H, t),
							to: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.minutesTo), B, t),
						},
						{
							id: 'IntervalsVisibilitiesMinutes',
							title: I,
					...
					n = (0, o.createRangePropertyDefinition)(
						{
							checked: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.hours), q, t),
							from: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.hoursFrom), z, t),
							to: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.hoursTo), G, t),
						},
						{
							id: 'IntervalsVisibilitiesHours',
							title: L,
					...
					p = (0, o.createRangePropertyDefinition)(
						{
							checked: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.days), J, t),
							from: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.daysFrom), K, t),
							to: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.daysTo), O, t),
						},
						{
							id: 'IntervalsVisibilitiesDays',
							title: x,
				...
				const u = (0, o.createRangePropertyDefinition)(
						{
							checked: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.weeks), Q, t),
							from: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.weeksFrom), X, t),
					...
					h = (0, o.createRangePropertyDefinition)(
						{
							checked: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.months), $, t),
		...
		18009: (e, t, i) => {
			...
			class m {
				...
				_createPropertyRages() {
					...
					null !== r && ((r.visible = this._source.hasEditableCoordinates()), this._propertyPages.push(r));
		...
		46112: (e, t, i) => {
			...
			var r = i(50151),
				...
				o = i(45126),
				s = i(12988);
			const l = new o.TranslatedString('change {propertyName} property', n.t(null, void 0, i(25167)));
			class a extends s.Property {
				...
				unsubscribe(e, t) {
					const i = (0, r.ensureDefined)(this._listenersMappers.find((i) => i.obj === e && i.method === t)?.callback);
		...
		35923: (e, t, i) => {
			...
			class n {
				...
				setWatchedValue(e, t, i) {
					this._undoModelSupplier().undoHistory().setWatchedValue(e, t, i, r.lineToolsDoNotAffectChartInvalidation);
				}
			}
		},
	},
