	...
	[3889],
	{
		...
		32097: (e, t, i) => {
			...
			function c(e, t) {
				...
				return (
					void 0 !== i.properties.style && (i.styleValues = l), void 0 !== i.properties.width && (i.widthValues = a), i
				);
			}
			var u = i(14608),
				f = i(14139);
			...
			const P = [
					{ id: b.VerticalAlign.Top, value: b.VerticalAlign.Bottom, title: v.t(null, void 0, i(97118)) },
					{ id: b.VerticalAlign.Middle, value: b.VerticalAlign.Middle, title: v.t(null, void 0, i(68833)) },
					{ id: b.VerticalAlign.Bottom, value: b.VerticalAlign.Top, title: v.t(null, void 0, i(27567)) },
				],
				D = [
					{ id: b.HorizontalAlign.Left, value: b.HorizontalAlign.Left, title: v.t(null, void 0, i(11626)) },
					{ id: b.HorizontalAlign.Center, value: b.HorizontalAlign.Center, title: v.t(null, void 0, i(24197)) },
					{ id: b.HorizontalAlign.Right, value: b.HorizontalAlign.Right, title: v.t(null, void 0, i(50421)) },
				],
				T = [
					{ id: 'horizontal', value: 'horizontal', title: v.t(null, void 0, i(95406)) },
					{ id: 'vertical', value: 'vertical', title: v.t(null, void 0, i(69526)) },
				],
				g = [8, 10, 11, 12, 14, 16, 18, 20, 22, 24, 28, 32, 40].map((e) => ({ title: String(e), value: e })),
				m = [1, 2, 3, 4],
			...
			function V(e, t) {
				...
				return (
					...
					void 0 !== i.properties.borderWidth && void 0 === i.borderWidthItems && (i.borderWidthItems = m),
					i
				);
			}
			function k(e, t) {
			...
			var x = i(64147);
			function W(e, t, i, r) {
				return { id: t, title: i, visible: r, groupType: 'general', definitions: new x.WatchedValue(e) };
			}
				...
				const r = new Map(),
					...
					s = {
						...
						subscribe: (t, i) => {
							...
							let n = r.get(t);
							void 0 === n ? ((n = new Map()), n.set(i, o), r.set(t, n)) : n.set(i, o), e.subscribe(o);
						},
						unsubscribe: (t, i) => {
							const o = r.get(t);
							if (void 0 !== o) {
			...
			function X(e, t, i, r, o) {
				...
				} else n = (0, _.makeProxyDefinitionProperty)(t.weakReference(), [() => Q(t.value(), 0), (e) => e]);
				return (
					(n.setValue = (i) => {
