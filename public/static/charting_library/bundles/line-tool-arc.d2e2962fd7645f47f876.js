		...
		87654: (t, i, e) => {
			...
			class d extends c.LineDataSource {
					...
					switch (t) {
						case 0: {
							...
							(this._points[0] = { ...e, interval: c }),
								(this._points[2] = { ...(0, s.ensureNotNull)(this.screenPointToPoint(h)), interval: c });
							break;
						}
						case 1: {
							const t = (0, s.ensureNotNull)(this._dist),
						...
						case 2: {
							...
							this._points[2] = { ...(0, s.ensureNotNull)(this.screenPointToPoint(T)), interval: c };
							break;
						}
					}
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([e.e(6406), e.e(3889), e.e(8009), e.e(8056), e.e(8537)]).then(e.bind(e, 90490)))
						.GeneralFiguresDefinitionsViewModelBase;
				}
				static _configureProperties(t) {
					super._configureProperties(t), t.addChild('linesColors', new h.LineToolColorsProperty([t.childs().color]));
				}
			}
		},
	},
