	...
	[1200],
	{
		...
		38039: (d, u, e) => {
			...
			class a extends i.DefaultProperty {
				...
				applyTemplate(d) {
					this.mergeAndFire(
						(0, i.extractState)((0, c.default)((0, f.default)(this._factoryDefaultsSupplier()), d), this._templateKeys)
					);
				}
			}
		},
		68498: (d, u, e) => {
			...
			class h extends o.MediaCoordinatesPaneRenderer {
				...
				hitTest(d) {
					...
					return Math.abs(i.y) <= u / 2 && Math.abs(i.x) <= u / 2 ? new l.HitTestResult(l.HitTarget.MovePoint) : null;
				}
				isOutOfScreen(d, u) {
				...
				_drawImpl(d) {
					...
					const { size: u, svg: e, point: f, angle: c, color: t, background: i, selected: a } = this._data,
						n = d.context;
					n.translate(f.x, f.y);
					const r = c - Math.PI / 2;
					n.rotate(r);
					...
					a &&
						...
						e &&
							...
							e.render(n, { targetViewBox: { x: 0, y: 0, width: u, height: u }, doNotApplyColors: null !== t }));
				}
			}
			class p extends r.LineSourcePaneView {
				constructor(d, u, e) {
					super(d, u), (this._iconRenderer = new h()), (this._renderer = new n.CompositeRenderer()), (this._svg = e);
				}
				renderer(d) {
				...
				_updateImpl(d) {
					...
					const p = s.add(l),
						...
						g = [
							(0, a.lineSourcePaneViewPointToLineAnchorPoint)(p, 0, void 0, void 0, void 0, void 0, void 0, !0),
							(0, a.lineSourcePaneViewPointToLineAnchorPoint)(v, 1, void 0, void 0, void 0, void 0, void 0, !0),
							(0, a.lineSourcePaneViewPointToLineAnchorPoint)(s.add(b), 2, m, !0, void 0, void 0, void 0, !0),
							(0, a.lineSourcePaneViewPointToLineAnchorPoint)(s.subtract(b), 3, m, !0, void 0, void 0, void 0, !0),
						];
				...
				_calculateBackgroundColor() {
					return (0, i.generateColor)(
						this._model.backgroundColorAtYPercentFromTop(
							this._points[0].y / (0, t.ensureNotNull)(this._model.paneForSource(this._source)).height()
						),
						60,
						!0
					);
		...
		19365: (d, u, e) => {
			...
			function c(d, u) {
				let e = '';
				return (
					f.default.parse(d, (d) => ((e = f.default.base + ('svg' === u ? `svg/${d}.svg` : `72x72/${d}.png`)), !1)), e
				);
			}
			...
			const f = (function () {
				...
				function l(d, u) {
					for (var f, c, t, i, a, r, l, b, h, p, v, m, g, x = s(d, []), y = x.length; y--; ) {
						for (t = !1, i = document.createDocumentFragment(), r = (a = x[y]).nodeValue, b = 0; (l = e.exec(r)); ) {
							if (
								...
								(f = u.attributes(v, m))))
									f.hasOwnProperty(c) && 0 !== c.indexOf('on') && !p.hasAttribute(c) && p.setAttribute(c, f[c]);
								(p.className = u.className), (p.alt = v), (p.src = g), (t = !0), i.appendChild(p);
							}
							p || i.appendChild(n(v, !1)), (p = null);
						}
						t && (b < r.length && i.appendChild(n(r.slice(b), !0)), a.parentNode.replaceChild(i, a));
					}
					return d;
				}
				function b(d, u) {
