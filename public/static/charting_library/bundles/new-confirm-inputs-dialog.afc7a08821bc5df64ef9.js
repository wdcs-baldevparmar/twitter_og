(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[3030],
	{
							...
							(p = o),
								setTimeout(function () {
									if (void 0 === a) {
										...
										e &&
											0 < t &&
											((a = document.body.style.paddingRight), (document.body.style.paddingRight = t + 'px'));
									}
		...
		59369: (e, t, n) => {
					...
					(0, o.useLayoutEffect)(() => {
						const e = (0, r.ensureNotNull)(t.current),
							n = () => {
								...
								if (0 === n.length || (n[0].parentElement && !m(n[0].parentElement, (0, r.ensureNotNull)(t.current)))) {
									const o = (function (e) {
									...
									if (null === o) return;
									if (((0, s.becomeMainElement)(o), n.length > 0)) for (const e of n) (0, s.becomeSecondaryElement)(e);
								}
							};
						return (
					...
					[
						...
						function (t) {
							...
							if (e) {
								...
								(s = ((m = r),
								Array.from(m.querySelectorAll('button:not([disabled]):not([aria-disabled])')).filter(
									(0, c.createScopedVisibleElementFilter)(m)
			...
			function f(e) {
				return Array.from(e.querySelectorAll('[data-role="row"]')).filter((0, c.createScopedVisibleElementFilter)(e));
			}
			function m(e, t) {
					...
					if ((0, l.isGroup)(e))
						if ((0, l.isInputInlines)(e)) {
							const t = (function (e) {
								...
								return 'price' === e[0].type ? { price: e[0], time: e[1] } : { price: e[1], time: e[0] };
							})(e.children);
							if (t) {
								const { time: o, price: r } = t,
									l = o.inline
										? i.t(null, { replace: { inputInline: o.inline, studyShortDescription: c } }, n(10679))
				...
				async function p(e) {
					const t = 'time' === e.type,
						...
						r = (function () {
							...
							const o = e.name
									? i.t(null, { replace: { inputTitle: e.name, studyShortDescription: c } }, n(59451))
									: i.t(null, { replace: { studyShortDescription: c } }, n(60935)),
								r = e.name
									? i.t(null, { replace: { inputTitle: e.name, studyShortDescription: c } }, n(94238))
