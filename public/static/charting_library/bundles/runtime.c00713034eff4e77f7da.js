(() => {
	...
	(o.m = b),
		...
		(o._plural = {
			...
			cs: (e, a = 4, c = 1 == e ? 0 : e >= 2 && e <= 4 ? 1 : 0 != e ? 2 : 3) => (null == e ? 0 : +c),
			ru: (
				e,
				a = 3,
				c = e % 10 == 1 && e % 100 != 11 ? 0 : e % 10 >= 2 && e % 10 <= 4 && (e % 100 < 10 || e % 100 >= 20) ? 1 : 2
			) => (null == e ? 0 : +c),
			ro: (e, a = 3, c = 1 == e ? 0 : e % 100 > 19 || (e % 100 == 0 && 0 != e) ? 2 : 1) => (null == e ? 0 : +c),
			pl: (e, a = 3, c = 1 == e ? 0 : e % 10 >= 2 && e % 10 <= 4 && (e % 100 < 10 || e % 100 >= 20) ? 1 : 2) =>
				null == e ? 0 : +c,
		...
		(o.d = (e, a) => {
			for (var c in a) o.o(a, c) && !o.o(e, c) && Object.defineProperty(e, c, { enumerable: !0, get: a[c] });
		}),
		(o.f = {}),
		...
		o.g.location && o.p.startsWith(o.g.location.origin) && (o.p = o.p.slice(o.g.location.origin.length)),
		(() => {
			const e = o.u;
			...
			return new Promise(function (c) {
				var d = function () {
					self.removeEventListener('online', d, !1),
						!1 === navigator.onLine ? self.addEventListener('online', d, !1) : c(a < 2 ? r(e, a + 1) : l(e));
				};
	...
	(o.e = function (e) {
			...
			if (null === e) {
				...
				if ('object' == typeof c) {
					if (o.g.customTranslateFunction) {
						...
						if (null !== e)
							return e.replace(/{(\w+)}/g, (e, c) => (void 0 !== (a.replace || a)[c] ? (a.replace || a)[c] : e));
					}
					return c[o.g.language] ? o.i18next(null, a, c[o.g.language]) : o.i18next(null, a, c.en, 'en');
				}
			} else if (c && e) {
		...
		(() => {
			const { miniCssF: e } = o;
			o.miniCssF = (a) => (self.document && 'rtl' === self.document.dir ? e(a).replace(/\.css$/, '.rtl.css') : e(a));
		})();
})();
