(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[1702],
	{
			...
			function m(e) {
				...
				return i.createElement(
					c,
					{
						...
						role: 'row',
						id: M?.(B),
						className: a()(u.itemRow, g && u.active, C && u.mobile, b && k && null === y && u.focused, E),
						tabIndex: S,
					...
					i.createElement(
						...
						i.createElement(
							'div',
							{ className: a()(u.title, g && u.active, C && u.mobile), 'data-name': 'list-item-title' },
							t
						),
					...
					i.createElement(r.RemoveButton, {
						id: M?.(B, Y.remove),
						role: 'cell',
						className: a()(u.removeButton, u.actionButton, b && y === Y.remove && u.focused, b && k && u.showOnFocus),
						isActive: g,
		...
		41662: (e, t, n) => {
			...
			class v extends u.DialogRenderer {
				constructor(e) {
					super(),
						(this._handleClose = () => {
							this._onClose && this._onClose(), this._rootInstance?.unmount(), this._setVisibility(!1);
						}),
						(this._onClose = e);
				}
				hide() {
		...
		11386: (e, t, n) => {
			...
			const M = new c.TranslatedString('remove all line tools for {symbol}', r.t(null, void 0, n(58407))),
				I = (e) =>
					r.t(null, { plural: '{drawingsCount} drawings', count: e }, n(90755)).format({ drawingsCount: e.toString() }),
