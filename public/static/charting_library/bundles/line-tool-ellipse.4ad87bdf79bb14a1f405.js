		...
		59002: (t, e, i) => {
			...
			class _ extends d.InplaceTextLineDataSource {
					...
					switch (t) {
						...
						case 1:
							...
							e && this.snapPoint45Degree(a, this._points[0 === t ? 1 : 0]),
								...
								this._setPoint(2, { ...this._calcPoint2(void 0, void 0, e ? void 0 : this._radius2), interval: l }),
								e &&
						...
						case 3:
							const r = this._screenPoint(0),
								...
								P = _.add(p.scaled(d));
							this._setPoint(2, { ...(0, s.ensureNotNull)(this.screenPointToPoint(P)), interval: l });
					}
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([i.e(6406), i.e(3889), i.e(8009), i.e(8056), i.e(8537)]).then(i.bind(i, 99458)))
				...
				static _configureProperties(t) {
					super._configureProperties(t),
						...
						t.addChild('textsColors', new c.LineToolColorsProperty([t.childs().textColor], t.childs().showLabel)),
				...
				_fixVerticalDiameterPoints(t, e, i) {
					...
					(c *= e.price > t.price ? 1 : -1),
						(t.price = (0, s.ensureNotNull)(this.screenPointToPoint(new o.Point(n.x, r.y + c))).price);
				}
				_calcPoint2(t, e, i) {
			...
			class m extends _.LineDataSource {
								...
								(this._cursorPaneView = new e.InplaceTextCursorPaneView(this, t)),
									this._additionalCursorDataGetters &&
										...
										null !== this._cursorPosition &&
											(this._cursorPaneView.setCursorPosition(this._cursorPosition), t.updateSource(this)));
							});
				}
				destroy() {
				...
				topPaneViews(t) {
					return t.hasDataSource(this) && !window.TradingView.printing && this._cursorPaneView
						? (this._cursorPaneView.update((0, p.sourceChangeEvent)(this.id())), [this._cursorPaneView])
						: null;
				}
				dataAndViewsReady() {
				...
				onSelectionChange(t) {
					...
					if (void 0 !== t) {
						...
						i === s ? (e.cursorPosition = i) : (e.selectionRange = [Math.min(i, s), Math.max(i, s)]);
					}
				...
				_saveEditedText() {
					...
					t !== e &&
						(this._editingOnCreation
							...
							: this._model.undoModel().undoHistory().pushUndoCommand(this._changeEditableTextUndoCommand(t, e)));
				}
