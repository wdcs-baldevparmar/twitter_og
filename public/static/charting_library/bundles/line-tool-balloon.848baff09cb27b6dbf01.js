...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[1277],
	{
		...
		27916: (e, t, i) => {
			i.d(t, { LineSourcePaneView: () => g, createLineSourcePaneViewPoint: () => p, thirdPointCursorType: () => _ });
			var n = i(19625),
				o = i(50151),
				s = i(69186),
				r = i(56468),
					...
					for (let e = 0; e < t.length; ++e) {
						...
						if (!((0, a.isInteger)(s.pointIndex) && d.linePointBeingEdited === s.pointIndex)) {
							...
							if (
								(o(
									l,
									{ ...s, point: new n.Point(Math.round(s.point.x * h) + x, Math.round(s.point.y * c) + x) },
									g / 2,
									_
								),
