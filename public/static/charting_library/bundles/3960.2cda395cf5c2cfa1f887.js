...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[3960],
	{
		73174: (e, t, o) => {
			...
			function T(e, t, o) {
				return { property: (0, d.convertToDefinitionProperty)(e, t.price, g), info: { typeY: 1, stepY: o } };
			}
			function b(e, t) {
				return {
					property: (0, d.convertToDefinitionProperty)(e, t.bar, f),
					info: { typeX: 0, minX: new c.WatchedValue(p), maxX: new c.WatchedValue(m), stepX: new c.WatchedValue(1) },
				};
			}
		...
		91335: (e, t, o) => {
			...
			var i = o(11542),
				...
				r = o(32097),
				a = o(91682);
			const l = new n.TranslatedString('change {toolName} text visibility', i.t(null, void 0, o(56634))),
				...
				u = new n.TranslatedString('change {toolName} text font italic', i.t(null, void 0, o(42694))),
				h = new n.TranslatedString('change {toolName} text', i.t(null, void 0, o(66668))),
				p = new n.TranslatedString('change {toolName} labels alignment vertical', i.t(null, void 0, o(31689))),
				m = new n.TranslatedString('change {toolName} labels alignment horizontal', i.t(null, void 0, o(88277))),
				g = new n.TranslatedString('change {toolName} labels direction', i.t(null, void 0, o(61160))),
				f = new n.TranslatedString('change {toolName} text background visibility', i.t(null, void 0, o(31133))),
				v = new n.TranslatedString('change {toolName} text background color', i.t(null, void 0, o(22231))),
				T = new n.TranslatedString('change {toolName} text border visibility', i.t(null, void 0, o(58704))),
				b = new n.TranslatedString('change {toolName} text border width', i.t(null, void 0, o(35423))),
				x = new n.TranslatedString('change {toolName} text border color', i.t(null, void 0, o(36666))),
			...
			function P(e, t, o, i) {
				...
				if (
					(void 0 !== t.showText &&
						(n.checked = (0, r.convertToDefinitionProperty)(e, t.showText, l.format({ toolName: o }))),
					void 0 !== t.textColor &&
					...
					void 0 !== t.bold && (n.bold = (0, r.convertToDefinitionProperty)(e, t.bold, c.format({ toolName: o }))),
					void 0 !== t.italic &&
					...
					void 0 !== t.textOrientation &&
						(n.orientation = (0, r.convertToDefinitionProperty)(e, t.textOrientation, g.format({ toolName: o }))),
					...
					void 0 !== t.backgroundTransparency && (i = t.backgroundTransparency),
						(n.backgroundColor = (0, r.getColorDefinitionProperty)(e, t.backgroundColor, i, v.format({ toolName: o })));
				}
				return (
					...
					void 0 !== t.borderVisible &&
						(n.borderVisible = (0, r.convertToDefinitionProperty)(e, t.borderVisible, T.format({ toolName: o }))),
					void 0 !== t.borderWidth &&
						(n.borderWidth = (0, r.convertToDefinitionProperty)(e, t.borderWidth, b.format({ toolName: o }))),
					void 0 !== t.borderColor &&
						(n.borderColor = (0, r.getColorDefinitionProperty)(e, t.borderColor, null, x.format({ toolName: o }))),
		...
		69113: (e, t, o) => {
			...
			class k extends N.MediaCoordinatesPaneRenderer {
				...
				_measureInfo(e, t, o) {
					if (this._geomertryCacheInvalidated) {
						...
						(this._geometryCache = { paddingLeft: r, innerWidth: l, innerHeight: s, textHorizontalPadding: d }),
				...
				_updateImpl(e) {
					...
					const t = this._source.properties().childs(),
						o = {
							...
							backgroundColor: (0, g.generateColor)(t.backgroundColor.value(), t.transparency.value()),
			...
			class V extends a.InplaceTextLineDataSource {
				constructor(e, t, o, i) {
					super(e, t ?? V.createProperties(e.backgroundTheme().spawnOwnership()), o, i), this._createPaneView();
				}
				pointsCount() {
					return 1;
				}
