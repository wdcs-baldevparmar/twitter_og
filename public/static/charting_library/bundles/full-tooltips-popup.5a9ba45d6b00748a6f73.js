	...
	[8643],
	{
						...
						if (r) {
							...
							if (
								...
								(l = [].concat(t(l), [p])),
									...
									a || (document.addEventListener('touchmove', d, o ? { passive: !1 } : void 0), (a = !0));
							}
						} else {
							(h = n),
								setTimeout(function () {
						...
						(e.clearAllBodyScrollLocks = function () {
							r
								? (l.forEach(function (e) {
									...
									a && (document.removeEventListener('touchmove', d, o ? { passive: !1 } : void 0), (a = !1)),
									(l = []),
									(i = -1))
								: (p(), (l = []));
						}),
						(e.enableBodyScroll = function (e) {
							if (r) {
								...
								(e.ontouchstart = null),
									...
									a &&
										0 === l.length &&
										(document.removeEventListener('touchmove', d, o ? { passive: !1 } : void 0), (a = !1));
							} else
		...
		66860: (e, t, o) => {
			...
			var n = o(50959),
				...
				c = o(1538),
				u = o.n(c);
			const d = (e) => n.createElement(i.Icon, { className: r(u().caret, e && u().activeCaret), icon: s });
			function p(e) {
				const {
					showCaret: t,
					iconOnly: o,
						...
						n.createElement(
							...
							s || i
								? n.createElement(
										...
										n.createElement('span', { className: u().visuallyHidden, 'aria-hidden': !0 }, p)
									)
								: n.createElement(
										n.Fragment,
										null,
		...
		41590: (e, t, o) => {
				...
				return (
					...
					n.createElement(
						...
						n.createElement(
							...
							y === g.currentDrawer && n.createElement('div', { className: d.backdrop, onClick: o }),
							n.createElement(
								h,
								{ className: l(v.drawer, d[`position${t}`], m), ref: f, 'data-name': e['data-name'] },
								u
							)
						)
					)
			...
			const h = (0, n.forwardRef)((e, t) => {
				...
				return n.createElement(u.TouchScrollContainer, { className: l(d.drawer, o), tabIndex: -1, ref: t, ...r });
			});
		},
		20520: (e, t, o) => {
			'use strict';
		...
		12048: (e, t, o) => {
			...
			function b(e) {
				...
				const o = t.map((t) => {
					const { title: o, titleColor: r, icon: l, iconClassName: a, html: i, action: s, size: h, solutionId: b } = t;
