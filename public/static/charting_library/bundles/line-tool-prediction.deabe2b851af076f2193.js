	...
	[9534],
	{
		...
		29356: (t, e, i) => {
			...
			class u extends a.LineDataSource {
				...
				dataAndViewsReady() {
					return (
						super.dataAndViewsReady() && Boolean(this._predictionPaneView && this._predictionPaneView.iconsReady())
					);
				}
				cloneable() {
					return !1;
				...
				recalculateStateByData() {
					...
					if (this.status())
						return void (t.index > this._model.timeScale().baseIndex() && this.setStatus(o.AlertStatus.Waiting));
					const e = this._model.mainSeries().bars().valueAt(t.index);
					if (null === e) return;
					const i = this.direction();
					if (i === o.Direction.Up && (0, s.ensure)(e[2]) >= t.price) this.setStatus(o.AlertStatus.Success);
					else if (i === o.Direction.Down && (0, s.ensure)(e[3]) <= t.price) this.setStatus(o.AlertStatus.Success);
					else {
				...
				static createProperties(t, e) {
					const i = new r.DefaultProperty({ defaultName: 'linetoolprediction', state: e, theme: t });
