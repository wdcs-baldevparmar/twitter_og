	...
	[2077],
	{
		...
		67029: (e, t, n) => {
			...
			function _(e, t) {
				const {
					...
					{ isGrouped: P, cellState: T, disablePositionAdjustment: F = !1 } = (0, o.useContext)(l.ControlGroupContext),
		...
		78274: (e, t, n) => {
			...
			function a(e) {
				...
				return o.createElement('span', { className: i(r()['inner-slot'], n && r().interactive, s && r().icon, t) }, a);
			}
			function l(e) {
				const { className: t, children: n } = e;
				return o.createElement('span', { className: i(r()['inner-slot'], r()['inner-middle-slot'], t) }, n);
			}
			function c(e) {
				const { className: t, interactive: n = !0, icon: s = !1, children: a } = e;
				return o.createElement('span', { className: i(r()['inner-slot'], n && r().interactive, s && r().icon, t) }, a);
				...
				return o.createElement(h.ControlSkeleton, {
					...
					middleSlot: o.createElement(
						...
						o.createElement('input', {
							...Y,
							className: i(m().input, m()[`size-${L}`], O, Z && m()['with-start-slot'], H && m()['with-end-slot']),
							disabled: B,
							readOnly: k,
							ref: $,
						})
		...
		48027: (e, t, n) => {
			...
			function s(e) {
				...
				return { ...e, intent: s || (l ? 'primary' : 'default'), highlight: r ?? l, onFocus: u, onBlur: d };
			}
		},
		29202: (e, t, n) => {
			'use strict';
		...
		27267: (e, t, n) => {
			...
			function o(e, t, n, o, i) {
				function s(i) {
					...
					const s = i.target;
					void 0 !== n && null !== t && null !== s && s.ownerDocument === o && (t.contains(s) || n(i));
				}
				return (
		...
		82206: (e, t, n) => {
			...
			class u extends o.PureComponent {
				...
				render() {
					...
					return o.createElement(
						...
						o.createElement(
							...
							{ value: this._manager },
							u && o.createElement('div', { onClick: this.props.onClickBackdrop, className: c.backdrop }),
							o.createElement(
								'div',
								{
									...p,
				...
				_createStyles() {
					const { bottom: e, left: t, width: n, right: o, top: i, zIndex: s, height: r } = this.props;
			...
			const N = class {
				...
				recalculateBounds() {
					const { clientWidth: e, clientHeight: t } = this._getClientDimensions(),
						...
						o = this._calculateDialogPosition?.(this._dialog, { clientWidth: e, clientHeight: t }, { vertical: n });
								...
								o.createElement(
									...
									o.createElement(
										u,
										{
											...
											className: i(
												F.dialog,
												(0, T.isOnMobileAppPage)('any') && !this.props.noMobileAppShadows && F.mobile,
					...
					if (!o.contains(document.activeElement)) {
						const e = (function (e) {
							...
							const n = (0, m.getActiveElementSelectors)(),
								o = Array.from(e.querySelectorAll(n)).filter((0, m.createScopedVisibleElementFilter)(e));
			...
			(A.contextType = x.PortalContext),
				(A.defaultProps = { boundByScreen: !0, draggable: !0, centeredOnMount: !0, shouldReturnFocus: !0 });
			...
			function s(e, t) {
				return class extends o.PureComponent {
					render() {
						...
						if (!n) return null;
						const r = o.createElement(e, { ...this.props, ref: this.props.componentRef, zIndex: 150 });
		...
		71090: (e, t, n) => {
			...
			function m(e) {
				...
				return o.createElement(d.Icon, { icon: h, className: s()('apply-common-tooltip', t), title: n ? g : p });
			}
			var f = n(10074),
				_ = n(85049);
			var v = n(44610);
					...
					o.createElement(
						...
						o.createElement(
							...
							o.createElement(
								...
								o.createElement(m, { className: v.infoHint, isSecondsEnabled: (0, f.isSecondsEnabled)() })
							),
							o.createElement(
								'form',
								{
							...
							w
								...
								: o.createElement('div', { className: s()(v.hint, v.error) }, r.t(null, void 0, n(87859)))
						)
					)
				);
			}
			var w = n(51826),
				E = n(87896);
			function x(e) {
				if (w.dialogsOpenerManager.isOpened('ChangeIntervalDialog') || w.dialogsOpenerManager.isOpened('SymbolSearch'))
					return;
				const t = document.createElement('div'),
