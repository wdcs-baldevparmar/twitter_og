		...
		55288: (e, s, t) => {
			...
			class a extends o.Study {
				...
				isConvertedToOtherUnit() {
					return (0, i.isConvertedToOtherUnit)(this.symbolInfo(), this._model.unitConversionEnabled());
				}
				setInterval(e) {}
				setStyle(e) {}
				symbolTitle(e, s, t) {
				...
				async _tryChangeInputs() {
					...
					(0, n.symbolSameAsCurrent)(this._previousSymbolInputValue, e) ||
						...
						(this._previousSymbolInputValue = this.properties().childs().inputs.childs().symbol.value());
				}
				_getSymbolObject(e) {
					const s = { symbol: e },
						t = this.currency();
				...
				_onSymbolResolved(e, s, t) {
					...
					const l = s === this.symbol() ? (0, i.extractSymbolNameFromSymbolInfo)(t, this.symbol()) : null;
