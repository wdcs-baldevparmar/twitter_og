	...
	[8537, 5231],
	{
		...
		34412: (e, t, i) => {
			...
			const d = new o.TranslatedString('change {title} middle point visibility', n.t(null, void 0, i(27470))),
				...
				g = new o.TranslatedString('change {title} date/time range visibility', n.t(null, void 0, i(37563))),
				v = new o.TranslatedString('change {title} distance visibility', n.t(null, void 0, i(45153))),
			...
			function W(e, t, i, n) {
				...
				if ('showDistance' in t) {
					const r = (0, l.createCheckablePropertyDefinition)(
						{ checked: (0, l.convertToDefinitionProperty)(e, t.showDistance, v.format({ title: i })) },
				...
				const G = (0, l.createCheckablePropertyDefinition)(
					{ checked: (0, l.convertToDefinitionProperty)(e, t.alwaysShowStats, T.format({ title: i })) },
				...
				const F = (0, l.createOptionsPropertyDefinition)(
					...
					{ id: `${o}StatsPosition`, title: (n && n.statsPosition) || S, options: new s.WatchedValue(P) }
				);
				return (
					N.push(F), a.push((0, l.createPropertyDefinitionsGeneralGroup)(N, `${o}StatsGroup`, $)), { definitions: a }
				);
			}
		},
		91335: (e, t, i) => {
			...
			const s = new o.TranslatedString('change {toolName} text visibility', n.t(null, void 0, i(56634))),
				...
				g = new o.TranslatedString('change {toolName} text background visibility', n.t(null, void 0, i(31133))),
				v = new o.TranslatedString('change {toolName} text background color', n.t(null, void 0, i(22231))),
				_ = new o.TranslatedString('change {toolName} text border visibility', n.t(null, void 0, i(58704))),
				T = new o.TranslatedString('change {toolName} text border width', n.t(null, void 0, i(35423))),
			...
			function b(e, t, i, n) {
				...
				if (
					...
					void 0 !== t.backgroundTransparency && (n = t.backgroundTransparency),
						(o.backgroundColor = (0, r.getColorDefinitionProperty)(e, t.backgroundColor, n, v.format({ toolName: i })));
				}
				return (
					...
					void 0 !== t.borderVisible &&
						(o.borderVisible = (0, r.convertToDefinitionProperty)(e, t.borderVisible, _.format({ toolName: i }))),
					void 0 !== t.borderWidth &&
						(o.borderWidth = (0, r.convertToDefinitionProperty)(e, t.borderWidth, T.format({ toolName: i }))),
		...
		41618: (e, t, i) => {
			...
			const p = new r.TranslatedString('change {title} level {index} line visibility', o.t(null, void 0, i(51403))),
				...
				v = new r.TranslatedString('change {title} background visibility', o.t(null, void 0, i(30839))),
				_ = new r.TranslatedString('change {title} background transparency', o.t(null, void 0, i(13783))),
				T = new r.TranslatedString('change {title} coeffs as percents visibility', o.t(null, void 0, i(31753))),
		...
		75450: (e, t, i) => {
			...
			const y = new r.TranslatedString('change {title} level {index} line visibility', o.t(null, void 0, i(51403))),
				...
				_ = new r.TranslatedString('change {title} background visibility', o.t(null, void 0, i(30839))),
				...
				F = [
					{ id: c.VerticalAlign.Top, value: c.VerticalAlign.Bottom, title: o.t(null, void 0, i(97118)) },
					{ id: c.VerticalAlign.Middle, value: c.VerticalAlign.Middle, title: o.t(null, void 0, i(68833)) },
					{ id: c.VerticalAlign.Bottom, value: c.VerticalAlign.Top, title: o.t(null, void 0, i(27567)) },
				],
			...
			class j extends a.LineDataSourceDefinitionsViewModel {
				...
				_stylePropertyDefinitions() {
					...
					const K = (0, l.createLineStyleDefinition)(this._propertyApplier, Y, c, 'LevelsStyleLine', X);
					e.push(K);
					const q = [],
					...
					if ('reverse' in te) {
						const t = (0, s.createCheckablePropertyDefinition)(
							{
								checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, te.reverse, w.format({ title: c })),
							},
					...
					const ie = (0, s.createCheckablePropertyDefinition)(
						{
							checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.showPrices, P.format({ title: c })),
						},
						{ id: `${a}Prices`, title: B }
					);
					e.push(ie);
					const ne = (0, s.createOptionsPropertyDefinition)(
						{
							checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.showCoeffs, C.format({ title: c })),
					...
					if (re && le && se) {
						const t = (0, s.createTwoOptionsPropertyDefinition)(
							{
								checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, re, S.format({ title: c })),
								option1: (0, s.convertToDefinitionProperty)(this._propertyApplier, le, m.format({ title: c })),
								option2: (0, s.convertToDefinitionProperty)(this._propertyApplier, se, m.format({ title: c })),
							},
							{
								id: `${a}Text`,
								title: N,
		...
		23720: (e, t, i) => {
			...
			var n = i(50151),
				...
				d = i(91682),
				p = i(95166);
			const u = new r.TranslatedString('change {title} level {index} line visibility', o.t(null, void 0, i(51403))),
				h = new r.TranslatedString('change {title} level {index} line color', o.t(null, void 0, i(664))),
				y = new r.TranslatedString('change {title} level {index} line width', o.t(null, void 0, i(97870))),
				...
				b = [
					{ id: a.VerticalAlign.Bottom, value: a.VerticalAlign.Top, title: o.t(null, void 0, i(97118)) },
					{ id: a.VerticalAlign.Middle, value: a.VerticalAlign.Middle, title: o.t(null, void 0, i(68833)) },
					{ id: a.VerticalAlign.Top, value: a.VerticalAlign.Bottom, title: o.t(null, void 0, i(27567)) },
				],
				C = [
					{ id: a.HorizontalAlign.Left, value: a.HorizontalAlign.Left, title: o.t(null, void 0, i(11626)) },
					{ id: a.HorizontalAlign.Center, value: a.HorizontalAlign.Center, title: o.t(null, void 0, i(24197)) },
					{ id: a.HorizontalAlign.Right, value: a.HorizontalAlign.Right, title: o.t(null, void 0, i(50421)) },
				];
			class x extends s.LineDataSourceDefinitionsViewModel {
				_stylePropertyDefinitions() {
					...
					const A = (0, l.createTwoOptionsPropertyDefinition)(
						...
						{ id: `${o}Labels`, title: S, optionsItems1: new c.WatchedValue(C), optionsItems2: new c.WatchedValue(b) }
					);
		...
		53894: (e, t, i) => {
			i.r(t), i.d(t, { GannComplexAndFixedDefinitionsViewModel: () => z, isGannComplexLineTool: () => R });
			var n = i(50151),
				o = i(11542),
				r = i(45126),
				l = i(91335),
			...
			const y = new r.TranslatedString('change {title} level {index} line visibility', o.t(null, void 0, i(51403))),
				f = new r.TranslatedString('change {title} level {index} line color', o.t(null, void 0, i(664))),
				g = new r.TranslatedString('change {title} level {index} line width', o.t(null, void 0, i(97870))),
				v = new r.TranslatedString('change {title} all lines color', o.t(null, void 0, i(59577))),
				_ = new r.TranslatedString('change {title} background visibility', o.t(null, void 0, i(30839))),
				T = new r.TranslatedString('change {title} background transparency', o.t(null, void 0, i(13783))),
				w = new r.TranslatedString('change {title} reverse', o.t(null, void 0, i(50762))),
				P = new r.TranslatedString('change {title} fan {index} line visibility', o.t(null, void 0, i(28833))),
				D = new r.TranslatedString('change {title} fan {index} line color', o.t(null, void 0, i(62500))),
				m = new r.TranslatedString('change {title} fan {index} line width', o.t(null, void 0, i(45732))),
				S = new r.TranslatedString('change {title} arcs {index} line visibility', o.t(null, void 0, i(4313))),
				b = new r.TranslatedString('change {title} arcs {index} line color', o.t(null, void 0, i(95582))),
				C = new r.TranslatedString('change {title} arcs {index} line width', o.t(null, void 0, i(8745))),
			...
			class z extends a.LineDataSourceDefinitionsViewModel {
				_stylePropertyDefinitions() {
					...
					const O = (0, s.createPropertyDefinitionsLeveledLinesGroup)(I, `${o}FanLeveledLinesGroup`);
					...
					const F = (0, s.createPropertyDefinitionsLeveledLinesGroup)(U, `${o}ArcsLeveledLinesGroup`);
					...
					if ((e.push(X), R(this._source))) {
						const t = this._source,
							...
							n = (0, s.createNumberPropertyDefinition)(
								{
									value: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.scaleRatio, x, [
		...
		72443: (e, t, i) => {
			...
			const d = new r.TranslatedString('change {title} level {index} line visibility', o.t(null, void 0, i(51403))),
				...
				g = new r.TranslatedString('change {title} background transparency', o.t(null, void 0, i(13783))),
		...
		27340: (e, t, i) => {
			...
			const d = new r.TranslatedString('change {title} level {index} line visibility', o.t(null, void 0, i(51403))),
				...
				_ = new r.TranslatedString('change {title} right labels visibility', o.t(null, void 0, i(8390))),
				...
				_stylePropertyDefinitions() {
					...
					const X = t.fans.childs(),
						K = (0, l.createColorPropertyDefinition)(
							{
								checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, X.visible, P.format({ title: s })),
								color: (0, l.getColorDefinitionProperty)(this._propertyApplier, X.color, null, D.format({ title: s })),
							},
							{ id: `${o}FansLines`, title: V }
						);
					e.push(K);
					const q = (0, l.createCheckablePropertyDefinition)(
						{ checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.reverse, g.format({ title: s })) },
		...
		41585: (e, t, i) => {
			...
			var n = i(11542),
				...
				c = i(30699),
				d = i(91682);
			const p = new o.TranslatedString('change {title} background visibility', n.t(null, void 0, i(30839))),
					...
					return {
						definitions: [
							(0, l.createTextStyleDefinition)(
								...
								new o.TranslatedString(this._source.name(), this._source.translatedType()),
								{ isEditable: !0, isMultiLine: !0, alignmentVerticalItems: h, customTitles: { text: y } }
							),
						],
					};
				}
					...
					return {
						definitions: [
							(0, l.createNumberPropertyDefinition)(
								{
									value: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.averageHL, v.format({ title: n })),
								},
								{
									id: `${i}AvgHL`,
									title: m,
							...
							(0, l.createNumberPropertyDefinition)(
								{
									value: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.variance, _.format({ title: n })),
								},
								{
									id: `${i}Variance`,
									title: S,
		...
		14542: (e, t, i) => {
			...
			class u extends c.LineDataSourceDefinitionsViewModel {
				_stylePropertyDefinitions() {
					...
					return {
						definitions: [
							(0, a.createLineStyleDefinition)(this._propertyApplier, { lineColor: e.linecolor }, c, 'Line'),
							(0, s.createOptionsPropertyDefinition)(
								{ option: (0, s.convertToDefinitionProperty)(this._propertyApplier, e.width, d.format({ title: c })) },
								{ id: `${u}Thickness`, title: n.t(null, void 0, i(54971)), options: new l.WatchedValue(p) }
							),
						],
					};
				}
		...
		73653: (e, t, i) => {
			...
			var n = i(11542),
				...
				p = i(73174),
				u = i(14608);
			const h = new r.TranslatedString('change {title} extending left', n.t(null, void 0, i(58052))),
				y = new r.TranslatedString('change {title} extending right', n.t(null, void 0, i(74867))),
				f = new r.TranslatedString('change {title} background visibility', n.t(null, void 0, i(30839))),
				...
				P = n.t(null, void 0, i(79468)),
				D = new r.TranslatedString('change {title} level {index} line visibility', n.t(null, void 0, i(51403))),
				m = new r.TranslatedString('change {title} level {index} line color', n.t(null, void 0, i(664))),
				S = new r.TranslatedString('change {title} level {index} line width', n.t(null, void 0, i(97870))),
				b = new r.TranslatedString('change {title} level {index} line style', n.t(null, void 0, i(64707))),
				C = new r.TranslatedString('change {title} level {index} line coeff', n.t(null, void 0, i(27154)));
					...
					return {
						definitions: [
							(0, c.createTextStyleDefinition)(
								...
								new r.TranslatedString(this._source.name(), this._source.translatedType()),
								{ isEditable: !0, isMultiLine: !0, alignmentVerticalItems: v, customTitles: { text: _ } }
							),
						],
					};
				}
		...
		26486: (e, t, i) => {
			...
			const c = new o.TranslatedString('change {title} source text color', n.t(null, void 0, i(45833))),
				...
				g = new o.TranslatedString('change {title} success background color', n.t(null, void 0, i(80428))),
				v = new o.TranslatedString('change {title} failure text color', n.t(null, void 0, i(58406))),
				_ = new o.TranslatedString('change {title} failure background color', n.t(null, void 0, i(91321))),
		...
		15041: (e, t, i) => {
			...
			var n = i(11542),
				...
				c = i(90490),
				d = i(91335);
			const p = new o.TranslatedString('change {title} extending left', n.t(null, void 0, i(58052))),
				...
				_stylePropertyDefinitions() {
					const e = this._source.properties().childs(),
						...
						c = (0, a.createLineStyleDefinition)(
							this._propertyApplier,
							{ showLine: l.showLine, lineColor: l.lineColor, lineWidth: l.lineWidth, lineStyle: l.lineStyle },
							i,
							t,
							{ line: g }
						),
					...
					const h = (0, s.createCheckablePropertyDefinition)(
						{
							checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, e.extendRight, u.format({ title: i })),
						},
					...
					const v = (0, s.createCheckablePropertyDefinition)(
						{
							checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, e.extendLeft, p.format({ title: i })),
						},
					...
					return {
						definitions: [
							(0, d.createTextStyleDefinition)(
								...
								new o.TranslatedString(this._source.name(), this._source.translatedType()),
								{ isEditable: !0, isMultiLine: !0, alignmentVerticalItems: v, customTitles: { text: h } }
							),
						],
					};
				}
		...
		2243: (e, t, i) => {
			...
			const u = new r.TranslatedString('change {title} stop color', o.t(null, void 0, i(26598))),
				...
				y = new r.TranslatedString('change {title} price labels visibility', o.t(null, void 0, i(343))),
				f = new r.TranslatedString('change {title} compact stats mode', o.t(null, void 0, i(49904))),
			...
			class F extends a.LineDataSourceDefinitionsViewModel {
				...
				_stylePropertyDefinitions() {
					...
					return {
						definitions: [
							...
							(0, c.createCheckablePropertyDefinition)(
								{
									checked: (0, c.convertToDefinitionProperty)(this._propertyApplier, e.compact, f.format({ title: o })),
								},
				...
				_inputsPropertyDefinitions() {
					...
					s = (0, c.createNumberPropertyDefinition)(
						{ value: (0, c.convertToDefinitionProperty)(this._propertyApplier, e.accountSize, v.format({ title: o })) },
						{
							id: `${i}AccountSize`,
							title: R,
							type: 1,
					...
					const a = (0, c.createNumberPropertyDefinition)(
							{ value: (0, c.convertToDefinitionProperty)(this._propertyApplier, e.lotSize, _.format({ title: o })) },
							{
								id: `${i}LotSize`,
								title: z,
								type: 1,
						...
						d = (0, c.createNumberPropertyDefinition)(
							{
								value: (0, c.convertToDefinitionProperty)(this._propertyApplier, e.risk, T.format({ title: o }), [
									(e) => parseFloat(e),
								]),
						...
						u = (0, c.createNumberPropertyDefinition)(
							{
								value: (0, c.convertToDefinitionProperty)(this._propertyApplier, e.entryPrice, P.format({ title: o })),
							},
						...
						y = (0, c.createNumberPropertyDefinition)(
							{
								value: (0, c.convertToDefinitionProperty)(this._propertyApplier, e.profitLevel, D.format({ title: o })),
							},
							{
						...
						C = (0, c.createNumberPropertyDefinition)(
							{ value: (0, c.convertToDefinitionProperty)(this._propertyApplier, e.stopLevel, S.format({ title: o })) },
							{
								id: `${i}StopLevelTicks`,
								title: V,
								type: 0,
						...
						x = (0, c.createNumberPropertyDefinition)(
							{
								value: (0, c.convertToDefinitionProperty)(this._propertyApplier, e.stopPrice, b.format({ title: o }), [
									(e) => e,
					...
					return { definitions: [h, g, (0, c.createPropertyDefinitionsGeneralGroup)([C, x], `${i}StopLevel`, B)] };
				}
				_coordinatesPropertyDefinitions() {
					return null;
				}
				...
				_getRiskMax(e) {
					return e === d.RiskDisplayMode.Percentage ? 100 : this._source.properties().childs().accountSize.value();
				}
				_getRiskStep(e) {
		...
		46662: (e, t, i) => {
			...
			const h = new r.TranslatedString('change {title} level {index} line visibility', o.t(null, void 0, i(51403))),
				...
				g = new r.TranslatedString('change {title} level {index} line style', o.t(null, void 0, i(64707))),
			...
			class x extends a.LineDataSourceDefinitionsViewModel {
				_stylePropertyDefinitions() {
					...
					const $ = (0, s.createTwoOptionsPropertyDefinition)(
						{
							checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.showCoeffs, P.format({ title: x })),
							option1: (0, s.convertToDefinitionProperty)(
								this._propertyApplier,
								i.horzLabelsAlign,
								D.format({ title: x })
		...
		27873: (e, t, i) => {
			...
			const c = new o.TranslatedString('change {title} VWAP line color', n.t(null, void 0, i(83030))),
				...
				y = new o.TranslatedString('change {title} upper band #1 line visibility', n.t(null, void 0, i(44828))),
				f = new o.TranslatedString('change {title} upper band #1 line color', n.t(null, void 0, i(27326))),
				g = new o.TranslatedString('change {title} upper band #1 line width', n.t(null, void 0, i(1353))),
				v = new o.TranslatedString('change {title} lower band #2 line visibility', n.t(null, void 0, i(94308))),
				_ = new o.TranslatedString('change {title} lower band #2 line color', n.t(null, void 0, i(35092))),
				T = new o.TranslatedString('change {title} lower band #2 line width', n.t(null, void 0, i(8873))),
				w = new o.TranslatedString('change {title} upper band #2 line visibility', n.t(null, void 0, i(93075))),
				P = new o.TranslatedString('change {title} upper band #2 line color', n.t(null, void 0, i(12138))),
				D = new o.TranslatedString('change {title} upper band #2 line width', n.t(null, void 0, i(7943))),
				m = new o.TranslatedString('change {title} lower band #3 line visibility', n.t(null, void 0, i(32442))),
				S = new o.TranslatedString('change {title} lower band #3 line color', n.t(null, void 0, i(68180))),
				b = new o.TranslatedString('change {title} lower band #3 line width', n.t(null, void 0, i(3476))),
				C = new o.TranslatedString('change {title} upper band #3 line visibility', n.t(null, void 0, i(15698))),
				x = new o.TranslatedString('change {title} upper band #3 line color', n.t(null, void 0, i(51780))),
				L = new o.TranslatedString('change {title} upper band #3 line width', n.t(null, void 0, i(27414))),
				A = new o.TranslatedString('change {title} background visibility', n.t(null, void 0, i(30839))),
				...
				return (0, r.createLinePropertyDefinition)(
					{
						...
						color: (0, r.getColorDefinitionProperty)(e, t.color, t.transparency ?? null, n.format({ title: d })),
			...
			class U extends l.StudyLineDataSourceDefinitionsViewModel {
				...
				_stylePropertyDefinitions() {
							...
							(0, r.createLinePropertyDefinition)(
								{
									...
									width: (0, r.convertToDefinitionProperty)(this._propertyApplier, l.linewidth, d.format({ title: n })),
								},
					...
					if (U.styles?.UpperBand_2 && U.styles?.LowerBand_2 && U.styles?.UpperBand_3 && U.styles?.LowerBand_3) {
							...
							o.push(
								(0, r.createCoordinatesPropertyDefinition)(
									{ x: d.property },
									{
										...
										title: n.t(null, { context: 'linetool point' }, i(13616)).format({ count: (l + 1).toString() }),
										...d.info,
									}
								)
							);
			...
			class u extends s.LineDataSource {
				...
				setLastPoint(e, t) {
					...
					return (
						(0, r.ensureNotNull)(i).isLog() ||
							((this._points[1] = { ...e, interval: this._model.mainSeries().interval() }), this._correctPoint(1)),
				...
				levels() {
					...
					for (let n = 0; n < i; n++) {
						...
						e.push({ index: n, visible: i.visible.value(), color: i.color.value(), width: i.width.value() });
					}
					return e;
				}
				fanLinesCount() {
		...
		18181: (e, t, i) => {
			i.r(t), i.d(t, { LineToolImage: () => V, OriginPoints: () => C, buildAbsoluteUserImageUrl: () => A });
			var n = i(50151),
				o = i(86441),
				r = i(9343),
				l = i(32679),
				...
				(0, u.runOrSigninWithFeature)(
					() => {
						T.tool.setValue('LineToolImage'),
							(P = w(m, () => {
								P?.then((e) => e()), (P = null), 'LineToolImage' === T.tool.value() && (0, T.resetToCursor)(!0);
							})),
						...
						g.enabled('popup_hints') &&
							...
							Promise.all([i.e(1737), i.e(2227), i.e(6166)])
								...
								.then((e) => {
									...
									let n = null;
									t.show(i, () => {
										null !== n && (clearTimeout(n), (n = null), d.setValue(s, !0, { forceFlush: !0 }));
									}),
										(n = setTimeout(() => {
											(n = null), t.hide();
										}, 5e3));
			...
			class V extends a.LineDataSource {
				constructor(e, t, n, o) {
					...
					(this._absoluteUserImageUrl = new s.Property(A(this.properties().childs().url.value()) ?? '')),
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([i.e(6406), i.e(3889), i.e(8009), i.e(8056), i.e(8537)]).then(i.bind(i, 65504)))
				...
				_changeOriginPoint(e) {
					const t = this.originPoint(),
						i = 4 === t ? V._correctOriginDirections[e] : V._correctOriginDirections[V._oppositePoints[t]],
					...
					(this._dOffsetX = 4 === t ? c.x - (0, n.ensureNotNull)(this.pointToScreenPoint(d)).x : void 0),
						(s.index = d.index),
						(s.price = d.price),
						(this._originPoint = e);
				}
				_createImage(e) {
					...
					(o.crossOrigin = 'anonymous'),
						...
						o.addEventListener('load', () => {
							...
							if (r.cssWidth.value() && r.cssHeight.value()) return void this._model.updateSource(this);
		...
		1183: (e, t, i) => {
			...
			class r extends o.PropertyBase {
				...
				destroy() {
					this._displayProperty.unsubscribe(this, this._displayPropertyValueChanged), this._listeners.destroy();
				}
				value() {
