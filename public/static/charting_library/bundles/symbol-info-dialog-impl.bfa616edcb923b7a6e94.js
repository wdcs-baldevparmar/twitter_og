		...
		30995: (e, t, n) => {
			...
			function h(e) {
				return o.createElement(
					o.Fragment,
					null,
					o.createElement('span', { className: i(d().background, e.statesWithoutBg && d()['states-without-bg']) }),
					e.startIcon &&
						o.createElement(a.Icon, { ...e.startIconAriaAttrs, className: d()['start-icon'], icon: e.startIcon }),
			...
			class b extends o.PureComponent {
				constructor(e) {
					super(e), (this._fullSessionScheduleViewModel = new y.FullSessionScheduleViewModel(e.source));
				}
				componentWillUnmount() {
				...
				render() {
					...
					return this.props.source.marketStatusModel()?.futuresContractExpirationTime()?.expired().value()
						? null
			...
			function N(e, t = {}) {
				...
				(0, E.showOnElement)(e, {
					below: !0,
					tooltipDelay: o,
					content: { type: 'html', data: `${a}${r ? '' : ` <span style="vertical-align: middle;">${S}</span>`}` },
				}),
						...
						render: function ({ requestResize: e }) {
							return (
								...
								o.createElement(
									...
									h(),
									a.flat().length && l && o.createElement('div', { className: i(T.separator, T.widgetSeparator) }),
									l &&
										o.createElement(
											o.Fragment,
											null,
											o.createElement(
												...
												o.createElement('span', { className: T.title }, s.t(null, void 0, n(94031))),
												o.createElement(
													v,
													{ onClick: () => u(!c), color: 'light-gray', size: 'small', startIcon: p },
						...
						? a.map((e, t) =>
								e.length
									? o.createElement(
											...
											t !== a.length - 1 && o.createElement('div', { className: i(T.separator, T.groupSeparator) })
										)
									: null
							)
						: null;
			...
			function L(e) {
				...
				return o.createElement(
					...
					{ className: T.item },
					o.createElement('span', { className: T.title }, t.title),
					o.createElement(O, { value: n, startSlot: t.startSlot, endSlot: t.endSlot, canCopy: t.canCopy, link: t.link })
				);
			}
			function O(e) {
						...
						o.createElement(w.ToolWidgetButton, {
							...
							onClick: async function () {
								await (0, _.copyToClipboard)({ text: t }),
									d.current &&
										(N(d.current, { initialDelay: 0, leaveOnMouseOut: !0, text: s.t(null, void 0, n(17254)) }), C());
							},
							icon: Z,
						}),
			...
			function re(e, t) {
				return ie(e) && void 0 !== e.pricescale
					? new te.PriceFormatter({ priceScale: e.pricescale / (0, ee.ensureDefined)(e.minmove2) }).format(
							(0, ee.ensureDefined)(e.minmove2) / e.pricescale
						)
					: null;
			}
			function se(e, t) {
				...
				if (r && i && o)
					return a
						? s.t(
								null,
								{ context: 'double fractional tick size', replace: { minmove2: String(a), pricescale: String(i / a) } },
								n(13197)
							)
						: `${o}/${i}`;
				...
				async show(e) {
					...
					const r = (function (e) {
						...
						return [
							...
							{ title: s.t(null, void 0, n(12272)), group: 1, propName: 'front_contract', visibility: le, canCopy: !0 },
							{
							...
							{ title: s.t(null, void 0, n(81314)), group: 2, propName: 'pointvalue' },
							{
								...
								getStartSlot: (e, n) => {
									const i = n?.country_code ?? e.country,
										r = e.exchange_logo;
									return t ? o.createElement(Y, { country: i, providerId: e.provider_id, sourceId: r }) : void 0;
								},
							},
							{ title: s.t(null, void 0, n(86905)), group: 2, propName: 'exchange', visibility: ce },
							{
							...
							},
							{
								...
								visibility: (t, n) => Boolean((0, J.measureUnitId)(t) && (0, J.isMeasureUnitSymbol)(t) && e.showUnit),
								formatter: (e) => e ?? '',
								defValue: '',
							},
							{
							...
							{ title: s.t(null, void 0, n(39245)), group: 2, propName: 'pip_size', getter: re, visibility: ie },
