			...
			class T extends _.LineDataSource {
				...
				topPaneViews(e) {
					return e.hasDataSource(this) && !window.TradingView.printing && this._cursorPaneView
						? (this._cursorPaneView.update((0, g.sourceChangeEvent)(this.id())), [this._cursorPaneView])
						: null;
				}
				dataAndViewsReady() {
		...
		83776: (e, t, i) => {
			...
			class h extends a.Property {
				...
				setValue(e) {
					...
					const c = (0, s.ensureNotNull)(this._lineSource.pointToScreenPoint(this._lineSource.points()[0])).add(
							new n.Point(o * h, r * h)
						),
			...
			class c extends r.InplaceTextLineDataSource {
				...
				static createProperties(e, t) {
					t &&
						...
						((t.showPercentPriceRange = t.showPriceRange), (t.showPipsPriceRange = t.showPriceRange));
					const i = new o.DefaultProperty({ defaultName: 'linetooltrendangle', state: t, theme: e });
