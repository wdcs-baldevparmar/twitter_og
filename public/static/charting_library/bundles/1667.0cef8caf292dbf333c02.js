...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	...
	{
		11667: (e, t, i) => {
			i.d(t, { LineToolRiskRewardBase: () => N, registerReversibleTool: () => E, roundValue: () => M });
			var s = i(50279),
				r = i(50151),
				n = i(11542),
				o = i(8025),
			...
			class S extends P {
				...
				setValue(e) {
					if (this._lineSource.isSourceHidden()) {
						...
						return (t[this._pointIndex].price = parseFloat(e.toString())), void this._lineSource.restorePoints(t, []);
					}
			...
			!(function (e) {
				(e[(e.InitialVersion = 1)] = 'InitialVersion'), (e[(e.CurrentVersion = 2)] = 'CurrentVersion');
			})(f || (f = {}));
			const I = new Map();
			function E(e, t) {
				I.set(e, t);
			...
			class N extends l.LineDataSource {
				constructor(e, t, s, n) {
								...
								() => {
									...
									if (a) {
										let e = (0, r.ensureNotNull)(
											o.priceRange(s, n, { targetPriceScale: a, scaleSeriesOnly: a?.isScaleSeriesOnly() })
										);
										if (a.isLog()) {
					...
					l.stopLevel.subscribe(this, this.recalculate),
						...
						(this._entryPriceAxisView = new _(this, { colorProperty: l.linecolor, priceProperty: l.entryPrice })),
						(this._stopPriceAxisView = new _(this, { colorProperty: l.stopBackground, priceProperty: l.stopPrice })),
				...
				availableCurrencies() {
					const e = (0, r.ensureDefined)(this._metaInfo?.inputs.find((e) => 'account_currency' === e.id));
				...
				priceAxisViews(e, t) {
					return this.isSourceHidden() || t !== this.priceScale() || this._model.paneForSource(this) !== e
						? null
					...
					if (1 === e && this._points.length >= 1) {
						...
						if (
							...
							const t = [],
								i = this._timePoint[0];
							t.push(i);
							const s = { price: i.price, time_t: i.time_t, offset: this._getClosePointIndex(i.offset) };
							t.push(s),
						...
						actions: [
							new C.Action({
								...
								options: {
									...
									onExecute: () => {
										const t = z.format({
											tool: (0, V.getTranslatedStringForSource)(A.TitleDisplayTarget.StatusLine, this),
										});
										e.beginUndoMacro(t);
										const i = (function (e, t) {
											const i = e.points(),
												...
												a = c.propertiesFactory(t.model().backgroundTheme().spawnOwnership(), e.properties().state()),
												l = e.linkKey().value(),
												u = l ? w.CreateLineToolSyncMode.ForceOn : w.CreateLineToolSyncMode.ForceOff,
												h = t.createLineTool({
													pane: n,
													point: i[0],
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([i.e(6406), i.e(3889), i.e(8009), i.e(8056), i.e(8537)]).then(i.bind(i, 2243)))
				...
				_recalculateRisk() {
					...
					(r = t === u.RiskDisplayMode.Percentage ? M((i / s) * 100) : M((s / 100) * r)),
						...
						e.risk.setValue(parseFloat(this._riskFormatter(t).format(r, { ignoreLocaleNumberFormat: !0 }))),
						(this._riskInChange = !1);
				}
				_recalculateAmount() {
					if (0 === this.points().length) return;
				...
				_calculateActualEntry(e, t) {
					...
					for (const e of s.rangeIterator(o, l + 1)) {
						const t = e.value;
						if (null !== t && (0, r.ensure)(t[2]) >= c && (0, r.ensure)(t[3]) <= c) return { index: e.index, price: c };
					}
					return null;
				}
				_riskFormatter(e) {
					return e === u.RiskDisplayMode.Percentage ? (0, a.getNumericFormatter)(2) : (0, a.getNumericFormatter)();
				}
				...
				_updateStudySource() {
					...
					if (
						(!i && this._studySource
							...
							: i &&
								!this._studySource &&
								((this._studySource = new RiskRewardStudyDataSource(this._model.chartApi(), t.seriesSource())),
