	...
	[9754, 1754, 9685, 2544],
	{
		...
		99054: (e, t, o) => {
			...
			function c(e) {
				...
				if (e && 1 == ++a) {
					...
					i(o, 'right', '0px');
					let e = 0;
					0, t.scrollHeight <= t.clientHeight && (e -= n()), (t.style.paddingRight = (e < 0 ? 0 : e) + 'px'), (r = !1);
				}
			}
		},
		89324: (e, t, o) => {
			...
			function c(e) {
				...
				const t = (0, l.getSymbolSearchCompleteOverrideFunction)(),
					{ defaultValue: o, showSpreadActions: r, source: c, onSearchComplete: h, trackResultsOptions: d, ...u } = e,
					v = {
						...u,
		...
		46350: (e, t, o) => {
								...
								v
									? n.createElement(
											...
											m.length
												...
												: n.createElement(y, { text: a.t(null, void 0, o(47202)), className: H.emptyState })
										)
									: n.createElement(
											n.Fragment,
											null,
			...
			class W extends B.Action {
				constructor({
					...
					super({
						...
						(this._searchOptions = { id: e, category: t, favourite: o, onFavouriteClick: n, aliases: s });
				}
			}
			var N,
				K = o(45126),
					...
					if (
							...
							t.forEach((t) => {
								n.push(
									new W({
										...
										onExecute: () => {
											(0, X.loadTheme)(e.chartWidgetCollection(), { themeName: t, standardTheme: !1 }).then(() => {
						...
						n.push(
							new W({
								...
								onExecute: () => {
									!(function (e) {
										const t = (0, Q.getCurrentTheme)().name === m.StdTheme.Dark ? m.StdTheme.Light : m.StdTheme.Dark,
											n = e
												.chartModels()
												.value()
										...
										if (n) i();
											...
											const e = a.t(null, void 0, o(78659)).format({ name: (0, J.capitalizeFirstLetter)(t) });
											(0, Y.showConfirm)({
												text: e,
			...
			const Le = O.enabled('show_average_close_price_line_and_label'),
				...
				Ae = new K.TranslatedString('change countdown to bar close visibility', a.t(null, void 0, o(39383))),
				_e = new K.TranslatedString('scale price chart only', a.t(null, void 0, o(63796))),
				ze = new K.TranslatedString('change symbol last value visibility', a.t(null, void 0, o(67453))),
				Ee = new K.TranslatedString('change high and low price labels visibility', a.t(null, void 0, o(24226))),
				ke = new K.TranslatedString('change average close price label visibility', a.t(null, void 0, o(76852))),
				...
				Re = new K.TranslatedString('change high and low price lines visibility', a.t(null, void 0, o(80692))),
				De = new K.TranslatedString('change average close price line visibility', a.t(null, void 0, o(1022))),
				Ie = new K.TranslatedString('change symbol labels visibility', a.t(null, void 0, o(73357))),
				Fe =
					(new K.TranslatedString('change pre/post market price label visibility', a.t(null, void 0, o(30870))),
					new K.TranslatedString('change symbol previous close value visibility', a.t(null, void 0, o(4729))),
					new K.TranslatedString('change previous close price line visibility', a.t(null, void 0, o(58419)))),
				Ve =
					(new K.TranslatedString('change bid and ask labels visibility', a.t(null, void 0, o(69362))),
					new K.TranslatedString('change bid and ask lines visibility', a.t(null, void 0, o(52919))),
					new K.TranslatedString('change pre/post market price lines visibility', a.t(null, void 0, o(91978))),
					new K.TranslatedString('change price line visibility', a.t(null, void 0, o(8662)))),
				Ze = new K.TranslatedString('change session breaks visibility', a.t(null, void 0, o(38413))),
				Oe =
			...
			async function Be(e) {
				const t = [],
					...
					l = ((e) => {
						const t = [],
							{ stayInDrawingMode: o, drawOnAllCharts: n, drawOnAllChartsMode: i } = ne.properties().childs();
						t.push(
							new W({
								label: ue,
								checkable: !0,
							...
							O.enabled('header_widget') &&
								...
								t.push(
									new W({
										...
										shortcutHint: e.options().indicatorsDialogShortcutEnabled ? (0, I.humanReadableHash)(47) : void 0,
									})
								),
				...
				t.push(
					...
					t.push(
						new W({
							...
							category: 'settingsActions',
							onExecute: () => {
								e.model().setProperty(G.addPlusButtonProperty, !G.addPlusButtonProperty.value(), Me);
							},
						})
					);
				...
				t.push(
					new W({
						...
						onExecute: () => {
							e.model().setProperty(y.highLowPriceLabelsVisible, !y.highLowPriceLabelsVisible.value(), Ee);
						},
					})
				),
					Le &&
				...
				t.push(
					...
					t.push(
						new W({
							...
							onExecute: () => {
								e.model().setProperty(y.highLowPriceLinesVisible, !y.highLowPriceLinesVisible.value(), Re);
							},
						})
					),
					Le &&
			...
			function Ue() {
				return Ke.lineToolsFlat.map((e) =>
					(function (e) {
						...
						return e.toLowerCase().includes('fib') && (i.aliases = [a.t(null, void 0, o(26578))]), new W(i);
					})(e.name)
				);
			}
			var Ge = o(37404);
			...
			function qe(e, t) {
				...
				return o === n ? 0 : 'drawingsActions' === n ? 1 : 'drawingsActions' === o || 'functionActions' === o ? -1 : 1;
			}
			var je = o(16216),
				$e = o(87896);
								...
								(async function (e, t) {
									...
									if (O.enabled('header_widget') && O.enabled('header_resolutions')) {
										const t = {
											...
											category: 'functionActions',
											onExecute: () => {
												(0, V.showChangeIntervalDialogAsync)({ initVal: F.linking.interval.value(), selectOnInit: !0 });
											},
										};
				...
				return (
					...
					}, [p, T, f]),
					{
						...
						handleSearchRefBlur: function (e) {
							x(), w(p), c.CheckMobile.any() || e.relatedTarget !== i.current?.getElement() || e.target.focus();
						},
						resetFocusState: x,
		...
		27317: (e, t, o) => {
			...
			class f extends n.PureComponent {
				constructor(e) {
					super(e),
						...
						(this._handleMeasure = ({ callback: e, forceRecalcPosition: t } = {}) => {
							...
							const d = i.height > h;
							if (d) {
								((0, s.ensureNotNull)(this._scrollWrapRef).style.overflowY = 'scroll'), (i = n.getBoundingClientRect());
							}
							const { width: u, height: v } = i,
								g =
									'function' == typeof o
										? o({ contentWidth: u, contentHeight: v, availableWidth: r, availableHeight: l })
										: o,
							...
							if (
								...
								t && void 0 !== this.props.closeOnScrollOutsideOffset && g.y <= this.props.closeOnScrollOutsideOffset)
							)
				...
				componentDidMount() {
					...
					const { customCloseDelegate: e = h.globalCloseDelegate, customRemeasureDelegate: t } = this.props;
				...
				render() {
					const {
						...
						{ appearingMenuHeight: M, appearingMenuWidth: A, appearingPosition: _, isMeasureValid: z } = this.state,
						E = {
							...
							n.createElement(
								...
								n.createElement(
									...
									n.createElement(
										'div',
										{
											className: l()(w.scrollWrap, !this.props.noMomentumBasedScroll && w.momentumBased),
				...
				return n.createElement(
					'div',
					{
						...
						onMouseOver: function (e) {
							if (!(null !== t.current && e.target instanceof Node && ((n = e.target), o.current?.contains(n)))) return;
							var n;
				...
				a = [
					{
						...
						sections: [
							{
								items: [{ name: 'cursor' }, { name: 'dot' }, { name: 'arrow' }, { name: 'demonstration' }, null].filter(
									l.isExistent
								),
							},
							{ items: [{ name: 'eraser' }] },
		...
		2627: (e, t, o) => {
			...
			const u = (0, h.humanReadableModifiers)(h.Modifiers.Shift, !1).trim(),
				...
				f = {
					...
					cursor: {},
					dot: {},
					demonstration: { hotKey: (0, l.hotKeySerialize)({ keys: [v], text: i.t(null, void 0, o(42633)) }) },
			...
			Object.entries(f)
				.map(([e, t]) => {
					...
					return { ...t, name: e, icon: o, localizedName: i, selectHotkey: d.lineToolsSelectHotkeys[e] };
				})
				.forEach((e) => {
					b[e.name] = e;
				});
