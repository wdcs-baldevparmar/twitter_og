(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[5378],
	{
		...
		67248: (e, t, n) => {
			...
			function f(e) {
				const { startSlot: t, iconOnly: n, children: r, endSlot: o, primaryText: a, secondaryText: i } = e;
				if (t && o && n) return c.createElement('span', { className: u(p().slot, p().startSlotWrap) }, t);
				const l = n && (t ?? o),
					s = !t && !o && !n && !r && a && i;
			...
			function v(e) {
				const {
					...
					{ isGrouped: u, cellState: m, disablePositionAdjustment: d } = (0, c.useContext)(x.ControlGroupContext),
		...
		92164: (e, t, n) => {
			...
			var r = n(50959),
				...
				s = n(94386);
			function c(e) {
				const { className: t, icon: n, title: o, description: c, buttonText: u, buttonAction: m } = e;
				return r.createElement(
					'div',
					...
					.map((e) => {
						...
						return (
							n.forEach((e) => {
								...
								if (((n.lastIndex = 0), (0, r.isString)(t) && t && t.toLowerCase() === o.toLowerCase()))
								...
								if (Array.isArray(u)) for (const e of u) if (i.test(e)) return (d = 1), void (m = e.match(i)?.index);
							}),
