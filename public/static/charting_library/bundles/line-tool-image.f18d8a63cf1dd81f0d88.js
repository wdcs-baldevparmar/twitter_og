...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	...
	{
		18181: (e, t, i) => {
			i.r(t), i.d(t, { LineToolImage: () => O, OriginPoints: () => y, buildAbsoluteUserImageUrl: () => L });
			var n = i(50151),
				r = i(86441),
				s = i(9343),
				o = i(32679),
				...
				(0, d.runOrSigninWithFeature)(
					() => {
						P.tool.setValue('LineToolImage'),
							(w = v(I, () => {
								w?.then((e) => e()), (w = null), 'LineToolImage' === P.tool.value() && (0, P.resetToCursor)(!0);
							})),
						...
						_.enabled('popup_hints') &&
							...
							Promise.all([i.e(1737), i.e(2227), i.e(6166)])
								...
								.then((e) => {
									...
									let n = null;
									t.show(i, () => {
										null !== n && (clearTimeout(n), (n = null), h.setValue(a, !0, { forceFlush: !0 }));
									}),
										(n = setTimeout(() => {
											(n = null), t.hide();
										}, 5e3));
			...
			class O extends l.LineDataSource {
				constructor(e, t, n, r) {
					...
					(this._absoluteUserImageUrl = new a.Property(L(this.properties().childs().url.value()) ?? '')),
				...
				_changeOriginPoint(e) {
					const t = this.originPoint(),
						i = 4 === t ? O._correctOriginDirections[e] : O._correctOriginDirections[O._oppositePoints[t]],
					...
					(this._dOffsetX = 4 === t ? u.x - (0, n.ensureNotNull)(this.pointToScreenPoint(h)).x : void 0),
						(a.index = h.index),
						(a.price = h.price),
						(this._originPoint = e);
				}
				_createImage(e) {
					...
					(r.crossOrigin = 'anonymous'),
						...
						r.addEventListener('load', () => {
							...
							if (s.cssWidth.value() && s.cssHeight.value()) return void this._model.updateSource(this);
