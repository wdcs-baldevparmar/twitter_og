	...
	[9443, 2544],
	{
			...
			const v = s.forwardRef((e, t) => {
				...
				return s.createElement(p.ControlSkeleton, {
					...
					middleSlot: s.createElement(
						h.MiddleSlot,
						null,
						s.createElement('textarea', { ...z, className: r(g().textarea, c, A && g().endslot), ref: t })
					),
					...(A && { endSlot: s.createElement('span', { className: r(!H && g()['with-icon']) }, A) }),
				});
			});
		...
		92399: (e, t, n) => {
			...
			function g(e) {
				const {
					...
					T = b ? s.createElement(l.StartSlot, { className: p.innerLabel, interactive: !1 }, b) : void 0,
					...
					button: (function () {
						...
						return i
							...
							: s.createElement(
									s.Fragment,
									null,
									n ?? s.createElement(_, { increaseValue: d, decreaseValue: p, defaultButtonsVisible: c, title: l })
								);
					})(),
					disabled: e.disabled,
		...
		26540: (e, t, n) => {
				...
				return o.createElement(
					...
					o.createElement(
						...
						o.createElement(d.MenuContext.Consumer, null, (e) =>
							o.createElement(u.ColorPicker, { ...y, onColorChange: f, onToggleCustom: x, menu: e })
						),
						!C && n
					)
				);
			...
			const _ = (0, C.makeSwitchGroupItem)(
				class extends o.PureComponent {
					...
					render() {
						const { name: e, checked: t, value: n, renderItemContent: r, className: a } = this.props,
							i = s(x.item, x.accessible, { [x.checked]: t, [x.focusVisible]: this.state.isFocusVisible }, a);
						return o.createElement(
							'div',
							{ className: i },
							o.createElement('input', {
				...
				return o.createElement(
					...
					o.createElement(w, {
						...
						renderItemContent: (e, t) =>
							o.createElement('div', { className: r()(E.bar, t && E.checked), style: { borderTopWidth: e } }),
					})
				);
			}
			var N = n(51056);
								...
								o.createElement(
									...
									i && 'mixed' !== i
										...
										: o.createElement(
												...
												o.createElement('div', { className: 'mixed' === i ? L.mixedColor : L.placeholder })
											),
									(void 0 !== a || s) &&
										(function () {
											...
											if (Array.isArray(t))
												return o.createElement(
													...
													o.createElement(
														'div',
														{ className: r()(L.linePropertyContainer, L.multiProperty, A(i) && L.whiteContainer) },
														t.map((t, n) =>
															o.createElement(
																'div',
																{
																	...
																	style: {
																		marginTop: A(i) && t?.marginTop ? `calc(${t.marginTop} - 2px)` : t?.marginTop,
																	},
																},
																E(t, e)
															)
		...
		1861: (e, t, n) => {
			...
			function l(e) {
				...
				if (r.dialogsOpenerManager.isOpened('SymbolSearch') || r.dialogsOpenerManager.isOpened('ChangeIntervalDialog'))
					return;
		...
		31356: (e, t, n) => {
			...
			function a(e) {
				...
				return o.createElement(
					...
					Boolean(c) &&
						o.createElement(s.PropertyTable.Cell, { placement: 'last', 'data-section-name': t }, c, u && !1, d && !1)
				);
			}
		},
		86067: (e, t, n) => {
					...
					super(...arguments),
						...
						(this._handlePosition = (e) => {
							...
							const o = (0, u.ensureNotNull)(this._container).getBoundingClientRect(),
								s = e.clientX - o.left,
								r = e.clientY - o.top;
							n({ h: t, s: (0, N.clamp)(s / o.width, 0, 1), v: (0, N.clamp)(1 - r / o.height, 0, 1) });
						}),
				...
				render() {
					...
					return o.createElement(
						...
						o.createElement(
							...
							o.createElement('div', { className: I.pointer, style: { left: 100 * n + '%', top: 100 * (1 - s) + '%' } })
						)
					);
				}
			}
		...
		59054: (e, t, n) => {
			...
			const v = o.forwardRef((e, t) => {
				const {
					...
					R = (0, o.useRef)(null),
					V = !p && o.createElement(l.EndSlot, null, o.createElement(m, { isDropped: b, disabled: f, className: D }));
				return o.createElement(c.PopupMenuDisclosureView, {
					...
					button: o.createElement(i.ControlSkeleton, {
						...
						middleSlot: o.createElement(
							l.MiddleSlot,
							null,
							o.createElement('span', { className: r()(g['button-children'], p && g.hiddenArrow, B) }, k)
						),
						endSlot: V,
					}),
					popupChildren: P,
			...
			class b extends o.PureComponent {
				constructor(e) {
					super(e),
						...
						(this._handleMeasure = ({ callback: e, forceRecalcPosition: t } = {}) => {
							...
							const d = s.height > u;
							if (d) {
								((0, a.ensureNotNull)(this._scrollWrapRef).style.overflowY = 'scroll'), (s = o.getBoundingClientRect());
							}
							const { width: p, height: h } = s,
								m =
									'function' == typeof n
										? n({ contentWidth: p, contentHeight: h, availableWidth: l, availableHeight: r })
										: n,
				...
				render() {
					const {
						...
						{ appearingMenuHeight: T, appearingMenuWidth: N, appearingPosition: I, isMeasureValid: k } = this.state,
						P = {
							...
							o.createElement(
								...
								o.createElement(
									...
									o.createElement(
										'div',
										{
											className: r()(f.scrollWrap, !this.props.noMomentumBasedScroll && f.momentumBased),
				...
				constructor(e) {
					super(e),
						(this._setValue = (e, t, n) => {
							...
							r.setProperty(m, t, p.format({ propertyName: g }), h && c.lineToolsDoNotAffectChartInvalidation);
						});
					const { property: t } = e,
						n = {};
				...
				componentDidMount() {
					...
					e.childNames().forEach((n) => {
						(0, s.ensureDefined)(e.child(n)).subscribe(this, (e) => {
							const o = e.value();
							d.logNormal(`Property "${n}" updated to value "${o}"`), this.setState({ [n]: o }), t?.(o, n);
						});
					});
				}
				componentWillUnmount() {
		...
		353: (e, t, n) => {
			...
			function i(e, t, n) {
				return (0, s.bindModel)(
					({ model: s }) =>
						o.createElement(a, { model: s, affectSave: n, property: t.property }, o.createElement(e, { ...t })),
					t
				);
			}
		},
		...
		8394: (e, t, n) => {
			...
			const b = { info: u, question: c, check: d, exclamation: p },
				y = s.forwardRef((e, t) =>
					s.createElement('span', { ...e, ref: t, className: a()(e.className, m()['no-active-state']) })
				),
				C = s.forwardRef((e, t) => {
					const {
							icon: n = 'exclamation',
			...
			(0, s.forwardRef)((e, t) => {
				const { className: n, href: o, rel: a, target: i, ...l } = e,
					c = (0, s.useMemo)(
						() => (0, s.forwardRef)((e, t) => s.createElement('a', { href: o, rel: a, target: i, ref: t, ...e })),
						[o, a, i]
					);
				...
				(0, s.forwardRef)((e, t) => {
					const { className: n, withActiveState: o, ...a } = e,
						i = (0, s.useMemo)(
							() => (0, s.forwardRef)((e, t) => s.createElement('button', { ...e, ref: t, type: 'button' })),
							[]
						);
					return s.createElement(k, {
						...a,
			...
			function P(e) {
				...
				return s.createElement(k, { icon: 'info', className: t, ariaLabel: n, tooltip: n, tabIndex: -1 });
			}
		},
		78839: (e, t, n) => {
			'use strict';
							...
							if (void 0 !== r)
								if (void 0 !== a)
									if (n.has(r)) {
										...
										let i;
										o.has(t) ? (i = (0, s.ensureDefined)(o.get(t))) : ((i = new Map()), o.set(t, i)),
		...
		24980: (e, t, n) => {
			...
			function C(e) {
				...
				return o.createElement('div', { className: c(m.inputGroup, n && m.inlineGroup, t) }, e.children);
			}
			var x = n(36565);
			function _(e = '') {
			...
			var F = n(85049),
				...
				A = n(1819);
			const H = void 0,
				q = ['1', '3', '5', '15', '30', '45', '60', '120', '180', '240', '1D', '1W', '1M', '3M', '6M', '12M'],
				z = ['1S', '5S', '10S', '15S', '30S'],
				U = ['1T', '10T', '100T', '1000T'];
			class Z extends o.PureComponent {
				...
				render() {
					const { input: e, value: t, disabled: s, hasTooltip: r } = this.props,
						...
						c = (0, W.mergeResolutions)(q, (0, W.isSecondsEnabled)() ? z : [], (0, A.isTicksEnabled)() ? U : [], l);
					return (
						c.unshift(''),
						o.createElement(P.Select, {
							...
							items:
								...
								d.map((e) => ({
									value: e,
									content: '' === e ? S.t(null, void 0, n(54613)) : (0, W.getTranslatedResolutionModel)(e).hint,
								}))),
							value: i,
							onChange: this._onChange,
							disabled: s,
			...
			class $ extends o.PureComponent {
				...
				_getColorInputWithContext(e) {
					...
					if ('properties' in a || 'tempProperties' in a) {
						const e = 'properties' in a ? a.properties().inputs[t] : a.tempProperties?.inputs.child(t);
						return o.createElement(
							Y.StylePropertyContainer,
							{ model: r, affectSave: !0, property: e },
							o.createElement(K.BasicColorSelect, { className: u()(s && m.hasTooltip), color: e, disabled: n })
						);
					}
					return null;
				}
					...
					o.createElement(
						...
						o.createElement(j.DatePicker, {
							...
							onPick: function (e) {
								if (null === e) return;
								const t = new Date(h);
								t.setFullYear(e.getFullYear()), t.setMonth(e.getMonth()), t.setDate(e.getDate()), n(v(t), i, l);
							},
							revertInvalidData: !0,
						})
					),
			...
			class ne extends o.PureComponent {
				render() {
					...
					switch (e.type) {
						case 'integer':
							return o.createElement(a.IntegerInput, { input: e, disabled: t, onChange: n, hasTooltip: c });
						case 'float':
						case 'price':
							return o.createElement(i.FloatInput, { input: e, disabled: t, onChange: n, hasTooltip: c });
						case 'bool':
							return o.createElement(l.BoolInput, { input: e, disabled: t, onChange: n, hasTooltip: c });
						case 'text':
							return o.createElement(f, { input: e, disabled: t, onChange: n, hasTooltip: c });
						case 'symbol':
							return o.createElement(b.SymbolInput, { input: e, disabled: t, onChange: n, hasTooltip: c });
						case 'session':
				...
				render() {
					...
					return o.createElement(
						...
						o.createElement(
							...
							t || o.createElement(ne, { input: (0, s.ensureDefined)(n), onChange: a, disabled: r, hasTooltip: p }),
							p && o.createElement(se.IconGroupWrapper, null, c && o.createElement(oe.InputTooltip, { title: c }), !1)
						)
					);
				}
			}
		...
		33900: (e, t, n) => {
			...
			function h(e) {
				...
				return o.createElement('span', { className: d()(p.radioButtonView, t && p.disabled, n && p.checked) });
			}
			var m = n(33560),
				g = n.n(m);
			...
			var f = n(16604),
				...
				x = n(97650);
			function _(e) {
				const { children: t, input: l, disabled: u, onChange: d, grouped: p, tooltip: h, solutionId: m } = e,
					...
					o.createElement(
						...
						o.createElement(
							...
							o.createElement(
								...
								{ colSpan: 2, placement: 'first', grouped: p, 'data-study-input-name': l?.id && `${l.id}-main-symbol` },
								o.createElement(v, {
									value: 'main-symbol',
									className: x.checkbox,
									disabled: u,
									label: o.createElement('span', { className: x.label }, r.t(null, { context: 'input' }, n(94849))),
								})
							)
						),
						o.createElement(
							...
							o.createElement(
								i.PropertyTable.Cell,
								{ placement: 'first', grouped: p, 'data-study-input-name': l?.id && `${l.id}-another-symbol-label` },
								o.createElement(v, {
									value: 'another-symbol',
									className: x.checkbox,
									disabled: u,
									label: o.createElement('span', { className: x.label }, r.t(null, { context: 'input' }, n(24716))),
								})
							),
							o.createElement(
								i.PropertyTable.Cell,
								{ placement: 'last', grouped: p, 'data-study-input-name': l?.id && `${l.id}-another-symbol-input` },
								t ||
								...
								k && o.createElement(C.IconGroupWrapper, null, h && o.createElement(y.InputTooltip, { title: h }), !1)
							)
						)
					)
				);
			...
			class E extends o.PureComponent {
				render() {
					...
					return o.createElement(
						...
						o.createElement(
							i.PropertyTable.Cell,
							{ placement: 'first', colSpan: 2, 'data-study-input-name': t?.id && `${t.id}-checkbox` },
							o.createElement(w.BoolInput, { label: e, input: t, hasTooltip: r }),
							r && o.createElement(C.IconGroupWrapper, null, n && o.createElement(y.InputTooltip, { title: n }), !1)
						)
					);
				}
			}
			...
			function M(e) {
				...
				return o.createElement(
					...
					o.createElement(
						i.PropertyTable.Cell,
						{ placement: 'first', colSpan: 2, className: B.wrap, 'data-study-input-name': t?.id && `${t.id}-textarea` },
						o.createElement(
							'div',
							{ className: B.labelWrap },
							o.createElement('span', { className: d()(B.label, a && B.hasTooltip) }, n),
							a && o.createElement(C.IconGroupWrapper, null, s && o.createElement(y.InputTooltip, { title: s }), !1)
						),
			...
			function O(e) {
				...
				return 'symbol' === t.type && t.optional
					...
					: 'bool' === t.type
						? o.createElement(E, { label: (0, l.getTranslatedInputTitle)(t.name), input: t, tooltip: n, solutionId: s })
						: 'text_area' === t.type
							? o.createElement(M, {
					...
					o.createElement(
						...
						t.children.map(
							(e, s) => (
								...
								o.createElement(O, { key: e.id, input: e, tooltip: s === t.children.length - 1 ? n : void 0 })
							)
						)
					)
				);
					...
					? (0, F.isInputInlines)(t)
						...
						: o.createElement(
								...
								o.createElement(
									...
									o.createElement(R.GroupTitleSection, { title: (0, l.getTranslatedInputTitle)(t.id), name: t.id })
								),
								t.children.map((e) =>
									(0, F.isGroup)(e)
										? o.createElement(L, { key: e.id, content: e })
										: o.createElement(O, { key: e.id, input: e, tooltip: e.tooltip, solutionId: e.solutionId })
								),
			...
			class q extends o.PureComponent {
				render() {
					...
					return o.createElement(
						...
						o.createElement(U, { study: r, model: l, property: n.inputs, inputs: t, onStudyInputChange: c }),
			...
			function U(e) {
				...
				return o.createElement(
					...
					!1,
					!1,
					c.map((e) => o.createElement(o.Fragment, { key: e.id }, o.createElement(A, { content: e }), !1))
				);
			}
			function Z(e) {
				return (
					!defaultCustomSessionIds.has(e.id) && !vbpAnchorPeriodInputsIds.has(e.id) && !tpoCustomRowSizeIds.has(e.id)
				);
			}
			function G(e, t) {
				return { id: 'val', name: t.title || H.offset, defval: e.val.value(), type: 'integer', min: t.min, max: t.max };
			}
		},
		30582: (e, t, n) => {
			'use strict';
		...
		90035: (e, t, n) => {
			...
			function h(e) {
				...
				let l;
				return (
					i.passMax || (l = a?.greaterThanMax ?? r.t(null, { replace: { max: String(s) } }, n(31331))),
			...
			class C extends o.PureComponent {
				...
				static getDerivedStateFromProps(e, t) {
					...
					return (t.focused && !n) || (t.value === o && !s) ? null : { value: o, displayValue: x(e, o) };
				}
