...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[1506],
	{
			...
			class v extends n.DefaultProperty {
				constructor(e) {
					const { levelsIterator: t = d, map: s = {}, ...r } = e,
						i = { ...a, ...s };
					r.state && (r.state = f(r.state, i, t)), super(r), (this._map = i), (this._levelsIterator = t);
				}
				state(e, t, s) {
				...
				preferences() {
					return (0, n.extractState)(this.state(this._excludedDefaultsKeys, void 0, !0), this._allDefaultsKeys);
				}
				applyTemplate(e, t) {
					this.mergeAndFire(
						(0, n.extractState)(
		...
		8532: (e, t, s) => {
			s.r(t), s.d(t, { LineToolFibTimeZone: () => d, NumConsts: () => h, StringConsts: () => p, Versions: () => u });
			var r = s(11542),
				i = s(45126),
				l = s(73305),
				n = s(15399),
			...
			class d extends a.LineDataSource {
				...
				migrateVersion(e, t, s) {
					if (1 === e) {
						...
						for (let t = 1; t <= 11; t++)
							e['level' + t].childs().linewidth.setValue(l), e['level' + t].childs().linestyle.setValue(n);
					}
				}
				pointsCount() {
					return 2;
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([s.e(6406), s.e(3889), s.e(8009), s.e(8056), s.e(8537)]).then(s.bind(s, 23720)))
