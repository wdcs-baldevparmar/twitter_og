		...
		57897: (e, t, i) => {
			...
			class l extends s.LineDataSource {
				...
				static createProperties(e, t) {
					const i = new n.DefaultProperty({ defaultName: 'linetooldisjointangle', state: t, theme: e });
				...
				_getAlertPlots() {
					...
					return (
						...
						[this._linePointsToAlertPlot(o, 'Upper', a, h), this._linePointsToAlertPlot(l, 'Lower', a, h)].filter(
							r.notNull
						)
					);
				}
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([i.e(6406), i.e(3889), i.e(8009), i.e(8056), i.e(8537)]).then(i.bind(i, 41585)))
