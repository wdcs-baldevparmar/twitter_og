		...
		27267: (e, t, i) => {
			...
			function n(e, t, i, n, r) {
				function s(r) {
					...
					const s = r.target;
					void 0 !== i && null !== t && null !== s && s.ownerDocument === n && (t.contains(s) || i(r));
				}
				return (
		...
		37020: (e, t, i) => {
			...
			function _(e) {
				...
				return {
					...
					studyData: { id: t, version: c, descriptor: { type: 'java', studyId: e.id }, packageName: y(t, d) },
					isGrayed: h,
					tags: u,
				};
			}
			function y(e, t) {
				return t?.isChartPattern ? 'tv-chart_patterns' : t?.isAuto ? 'auto-java' : m.StudyMetaInfo.getPackageName(e);
			}
			var w = i(97754),
				E = i.n(w),
				S = i(63932),
			...
			function N(e) {
				...
				return n.createElement('div', { ref: t, className: E()(R.container, i), ...r, 'data-role': 'dialog-content' });
			}
			var k = i(29646);
			function D(e) {
			...
			function W(e) {
				const t = (0, n.useContext)(F),
					...
					O = E()(M.container, l && M.mobile, c.isGrayed && M.disabled, f && M.selected, v && M.highlighted);
				return n.createElement(
					...
					n.createElement(
						...
						Boolean(N && !x) &&
							n.createElement(BadgeStatus, { type: 'ep', className: M.badge, tooltip: r.t(null, void 0, i(10640)) }),
						!1
					),
					R &&
						n.createElement(
					...
					!l && R && n.createElement('span', { className: M.likes }, compactNumberFormat(R.likesCount)),
					!1
				);
			}
			function j(e, t) {
			...
			function U(e) {
				...
				return n.createElement(
					'h3',
					{
						className: E()(O.title, 'Small' === i && O.small, 'Normal' === i && O.normal, 'Large' === i && O.large, r),
					},
					t
				);
			}
			...
			var V = i(97006),
				...
				J = i(3292);
			function z(e) {
				const { reference: t, data: s, isOpened: o, onClose: a, applyStudy: l, shouldReturnFocus: c } = e,
					[d, u] = (0, n.useState)(''),
									...
									k
										...
										: m.length
											? n.createElement(
													n.Fragment,
													null,
													n.createElement(q, null, n.createElement(U, { title: r.t(null, void 0, i(7378)) })),
													m.map((e) =>
														n.createElement(W, {
															key: e.id,
															id: K(e.id),
			...
			class de {
				...
				show(e) {
					this._wrap &&
						...
						ne.render(n.createElement(ce, { text: r.t(null, { replace: { studyTitle: e } }, i(33673)) }), this._wrap),
						this._debouncedHide());
				}
				hide() {
					this._wrap && ((this._showed = !1), ne.unmountComponentAtNode(this._wrap), this._wrap.remove());
				}
				destroy() {
			...
			class fe extends he {
				...
				async _init() {
					...
					(this._indicatorData = await (async function (e, t) {
						let i = { ...t };
						return [...pe(i, 'tv-basicstudies'), ...pe(i, 'Script$STD'), ...pe(i, 'tv-volumebyprice')]
				...
				_render() {
					...
					this._rootInstance ? this._rootInstance.render(i) : (this._rootInstance = (0, me.createReactRoot)(i, t));
				}
			}
		},
		74670: (e, t, i) => {
		...
		36189: (e, t, i) => {
			...
			function h(e) {
				const { className: t, isFilled: i, isActive: r, onClick: h, title: p, ...m } = e,
					...
					g = p ?? (i ? a.removeTitlesMap[a.RemoveTitleType.Remove] : a.removeTitlesMap[a.RemoveTitleType.Add]);
				return (
					(0, n.useLayoutEffect)(() => {
						const e = f.current;
						e instanceof HTMLElement && g && e.dispatchEvent(new CustomEvent('common-tooltip-update'));
					}, [g, f]),
					n.createElement(o.Icon, {
						...m,
						className: s()(u.favorite, 'apply-common-tooltip', i && u.checked, r && u.active, v && u.focused, t),
						onClick: h,
						icon: i ? c : d,
						title: g,
						ariaLabel: g,
