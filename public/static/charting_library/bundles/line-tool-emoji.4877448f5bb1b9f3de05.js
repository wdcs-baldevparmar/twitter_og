...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[5529],
	{
		73174: (e, t, n) => {
			...
			function S(e, t, n) {
				return { property: (0, c.convertToDefinitionProperty)(e, t.price, _), info: { typeY: 1, stepY: n } };
			}
			function f(e, t) {
				return {
					property: (0, c.convertToDefinitionProperty)(e, t.bar, P),
					info: { typeX: 0, minX: new h.WatchedValue(p), maxX: new h.WatchedValue(g), stepX: new h.WatchedValue(1) },
				};
			}
		...
		22329: (e, t, n) => {
			...
			class h extends l.LineDataSource {
				...
				startChanging(e, t) {
					...
					(this._changePointData = { centerPoint: n, initialLength: c, initialSize: a }), super.startChanging(e, t);
				}
				setPoint(e, t, n) {
					const { centerPoint: i, initialLength: r, initialSize: s } = (0, o.ensureNotNull)(this._changePointData),
						a = (0, o.ensureNotNull)(this.pointToScreenPoint(t)),
						l = this.properties().childs();
					if (0 === e || 1 === e) {
						const t = a.subtract(i).normalized();
						let n = Math.acos(-t.x);
						Math.asin(t.y) > 0 && (n = 2 * Math.PI - n), 0 === e && (n += Math.PI), l.angle.setValue(n);
					} else {
					...
					for (let e = 0; e < t.length; ++e) {
						...
						if (!((0, a.isInteger)(r.pointIndex) && d.linePointBeingEdited === r.pointIndex)) {
							...
							if (
								(o(
									l,
									{ ...r, point: new i.Point(Math.round(r.point.x * c) + P, Math.round(r.point.y * h) + P) },
									_ / 2,
									p
								),
