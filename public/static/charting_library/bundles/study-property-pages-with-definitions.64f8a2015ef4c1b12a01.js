...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[607],
	{
		73174: (e, t, i) => {
			...
			function S(e, t, i) {
				return { property: (0, u.convertToDefinitionProperty)(e, t.price, f), info: { typeY: 1, stepY: i } };
			}
			function P(e, t) {
				return {
					property: (0, u.convertToDefinitionProperty)(e, t.bar, v),
					info: { typeX: 0, minX: new p.WatchedValue(y), maxX: new p.WatchedValue(h), stepX: new p.WatchedValue(1) },
				};
			}
						...
						V = (0, r.createLinePropertyDefinition)(
							{
								...
								width: (0, r.convertToDefinitionProperty)(this._propertyApplier, s.linewidth, d.format({ title: n })),
								style: (0, r.convertToDefinitionProperty)(this._propertyApplier, s.linestyle, c.format({ title: n })),
							},
						...
						M = (0, r.createLinePropertyDefinition)(
							{
								...
								width: (0, r.convertToDefinitionProperty)(this._propertyApplier, x.linewidth, f.format({ title: n })),
								style: (0, r.convertToDefinitionProperty)(this._propertyApplier, x.linestyle, v.format({ title: n })),
							},
							{ id: `${i}UpLine`, title: w }
						),
						k = e.downLine.childs();
							...
							(0, r.createLinePropertyDefinition)(
								{
									...
									width: (0, r.convertToDefinitionProperty)(this._propertyApplier, k.linewidth, P.format({ title: n })),
									style: (0, r.convertToDefinitionProperty)(this._propertyApplier, k.linestyle, m.format({ title: n })),
								},
		...
		15306: (e, t, i) => {
			...
			const b = n.t(null, void 0, i(92516)),
				...
				I = ['1', '3', '5', '15', '30', '45', '60', '120', '180', '240', '1D', '1W', '1M'].map((e) => ({
					value: e,
							...
							for (const u of t) {
								...
								if ('resolution' === u.type)
									S = (0, l.createOptionsPropertyDefinition)(
										{ option: (0, l.convertToDefinitionProperty)(e, i[u.id], y.format({ inputName: _ })) },
									...
									S = (0, l.createSessionPropertyDefinition)(
										{ session: (0, l.convertToDefinitionProperty)(e, i[u.id], y.format({ inputName: _ })) },
										{ id: c, title: v }
									);
								else if ('bool' === u.type)
									S = (0, l.createCheckablePropertyDefinition)(
										{ checked: (0, l.convertToDefinitionProperty)(e, i[u.id], y.format({ inputName: _ })) },
										{ id: c, title: v }
									);
									...
									void 0 !== u.min && (t.min = new p.WatchedValue(u.min)),
										...
										void 0 !== u.step && isFinite(u.step) && u.step > 0 && (t.step = new p.WatchedValue(u.step)),
										(S = (0, l.createNumberPropertyDefinition)(
											{ value: (0, l.convertToDefinitionProperty)(e, i[u.id], y.format({ inputName: _ })) },
											t
										));
								} else
									S = (0, l.createTextPropertyDefinition)(
										{ text: (0, l.convertToDefinitionProperty)(e, i[u.id], y.format({ inputName: _ })) },
				...
				_stylePropertyDefinitions() {
					...
					const e = this._source.properties().childs(),
						...
						n = (0, l.createOptionsPropertyDefinition)(
							...
							{ id: 'StudyOverlayMinTick', title: G, options: new p.WatchedValue((0, V.seriesPrecisionValues)()) }
						),
					...
					return j.map((t) =>
						t.readonly
							...
							: {
									...
									value: t.value,
									title: t.title,
									disabled: (0, x.isCloseBasedSymbol)(e) && !(0, x.isSingleValueBasedStyle)(t.value),
								}
					);
				}
			}
