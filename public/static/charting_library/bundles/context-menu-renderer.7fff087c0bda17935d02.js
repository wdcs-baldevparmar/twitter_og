			...
			function i(t, e) {
				return class extends r.PureComponent {
					render() {
						...
						if (!n) return null;
						const s = r.createElement(t, { ...this.props, ref: this.props.componentRef, zIndex: 150 });
				...
				show(t) {
					this._onShow && this._onShow(),
						...
						this._render({
							...this._props,
							position: (e) => {
								const { contentWidth: n, contentHeight: r, availableWidth: o, availableHeight: i } = e;
								let u;
								if (void 0 !== t.box) u = t.box;
								else {
									u = { x: t.touches?.[0].clientX ?? t.clientX, y: t.touches?.[0].clientY ?? t.clientY, w: 0, h: 0 };
								}
								const a = t.marginX ?? 0,
									c = t.marginY ?? 0;
								let l, h;
