	...
	[8422],
	{
			...
			class g extends p.LineDataSource {
								...
								(this._cursorPaneView = new t.InplaceTextCursorPaneView(this, e)),
									this._additionalCursorDataGetters &&
										...
										null !== this._cursorPosition &&
											(this._cursorPaneView.setCursorPosition(this._cursorPosition), e.updateSource(this)));
							});
				}
				destroy() {
					this._isDarkBackground.destroy(), this._editableText.unsubscribe(), this._closeTextEditor(), super.destroy();
				}
				editableTextStyle() {
				...
				topPaneViews(e) {
					return e.hasDataSource(this) && !window.TradingView.printing && this._cursorPaneView
						? (this._cursorPaneView.update((0, _.sourceChangeEvent)(this.id())), [this._cursorPaneView])
						: null;
				}
				dataAndViewsReady() {
				...
				onSelectionChange(e) {
					...
					if (void 0 !== e) {
						...
						i === s ? (t.cursorPosition = i) : (t.selectionRange = [Math.min(i, s), Math.max(i, s)]);
					}
				...
				_saveEditedText() {
					...
					e !== t &&
						(this._editingOnCreation
							...
							: this._model.undoModel().undoHistory().pushUndoCommand(this._changeEditableTextUndoCommand(e, t)));
				}
		...
		38039: (e, t, i) => {
			...
			class a extends r.DefaultProperty {
				...
				applyTemplate(e) {
					this.mergeAndFire(
						(0, r.extractState)((0, n.default)((0, s.default)(this._factoryDefaultsSupplier()), e), this._templateKeys)
					);
				}
			}
		},
		63397: (e, t, i) => {
			...
			class D extends l.InplaceTextLineDataSource {
				...
				setPoint(e, t, i) {
					...
					switch (e) {
						case 2:
							(this._points[1].price = t.price), (this._points[0].index = t.index), (this._points[0].interval = s);
							break;
						case 3:
							(this._points[0].price = t.price), (this._points[1].index = t.index), (this._points[1].interval = s);
							break;
						case 4:
				...
				_correctRightLeftMiddlePoint(e, t, i) {
					...
					switch (((c *= h), e)) {
						case 4: {
							...
							this._points[1].price = t.price;
							const i = (0, s.ensureNotNull)(this.screenPointToPoint(new n.Point(a.x + h * c, a.y + (d * c) / 2)));
						...
						case 5: {
							...
							this._points[0].price = t.price;
							const i = (0, s.ensureNotNull)(this.screenPointToPoint(new n.Point(l.x + h * c, l.y + (d * c) / 2)));
				...
				static _configureProperties(e) {
					super._configureProperties(e),
						...
						e.addChild('textsColors', new c.LineToolColorsProperty([e.childs().textColor], e.childs().showLabel)),
