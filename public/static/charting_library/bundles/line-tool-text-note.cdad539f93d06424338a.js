...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[9123],
	{
		73174: (e, t, i) => {
			...
			function v(e, t, i) {
				return { property: (0, d.convertToDefinitionProperty)(e, t.price, f), info: { typeY: 1, stepY: i } };
			}
			function b(e, t) {
				return {
					property: (0, d.convertToDefinitionProperty)(e, t.bar, m),
					info: { typeX: 0, minX: new c.WatchedValue(g), maxX: new c.WatchedValue(p), stepX: new c.WatchedValue(1) },
				};
			}
		...
		91335: (e, t, i) => {
			...
			var o = i(11542),
				...
				n = i(32097),
				l = i(91682);
			const a = new r.TranslatedString('change {toolName} text visibility', o.t(null, void 0, i(56634))),
				...
				h = new r.TranslatedString('change {toolName} text font italic', o.t(null, void 0, i(42694))),
				u = new r.TranslatedString('change {toolName} text', o.t(null, void 0, i(66668))),
				g = new r.TranslatedString('change {toolName} labels alignment vertical', o.t(null, void 0, i(31689))),
				p = new r.TranslatedString('change {toolName} labels alignment horizontal', o.t(null, void 0, i(88277))),
				f = new r.TranslatedString('change {toolName} labels direction', o.t(null, void 0, i(61160))),
				m = new r.TranslatedString('change {toolName} text background visibility', o.t(null, void 0, i(31133))),
				x = new r.TranslatedString('change {toolName} text background color', o.t(null, void 0, i(22231))),
				v = new r.TranslatedString('change {toolName} text border visibility', o.t(null, void 0, i(58704))),
				b = new r.TranslatedString('change {toolName} text border width', o.t(null, void 0, i(35423))),
				T = new r.TranslatedString('change {toolName} text border color', o.t(null, void 0, i(36666))),
			...
			function S(e, t, i, o) {
				...
				if (
					(void 0 !== t.showText &&
						(r.checked = (0, n.convertToDefinitionProperty)(e, t.showText, a.format({ toolName: i }))),
					void 0 !== t.textColor &&
					...
					void 0 !== t.bold && (r.bold = (0, n.convertToDefinitionProperty)(e, t.bold, c.format({ toolName: i }))),
					void 0 !== t.italic &&
					...
					void 0 !== t.textOrientation &&
						(r.orientation = (0, n.convertToDefinitionProperty)(e, t.textOrientation, f.format({ toolName: i }))),
					...
					void 0 !== t.backgroundTransparency && (o = t.backgroundTransparency),
						(r.backgroundColor = (0, n.getColorDefinitionProperty)(e, t.backgroundColor, o, x.format({ toolName: i })));
				}
				return (
					...
					void 0 !== t.borderVisible &&
						(r.borderVisible = (0, n.convertToDefinitionProperty)(e, t.borderVisible, v.format({ toolName: i }))),
					void 0 !== t.borderWidth &&
						(r.borderWidth = (0, n.convertToDefinitionProperty)(e, t.borderWidth, b.format({ toolName: i }))),
					void 0 !== t.borderColor &&
						(r.borderColor = (0, n.getColorDefinitionProperty)(e, t.borderColor, null, T.format({ toolName: i }))),
		...
		38039: (e, t, i) => {
			...
			class a extends l.DefaultProperty {
				...
				applyTemplate(e) {
					this.mergeAndFire(
						(0, l.extractState)((0, r.default)((0, o.default)(this._factoryDefaultsSupplier()), e), this._templateKeys)
					);
				}
			}
		},
		...
		46902: (e, t, i) => {
			...
			class T extends h.LineDataSourceProperty {
				constructor(e) {
					super(e),
						...
						this.addChild('linesColors', new u.LineToolColorsProperty([(0, r.ensureDefined)(this.child('lineColor'))])),
						this.addChild(
							'backgroundsColors',
							new u.LineToolColorsProperty([(0, r.ensureDefined)(this.child('backgroundColor'))])
						),
						this.addChild('textsColors', new u.LineToolColorsProperty([(0, r.ensureDefined)(this.child('textColor'))]));
				}
				static create(e, t) {
					return new this({
			...
			class O extends R.BitmapCoordinatesPaneRenderer {
				constructor(e) {
					super(),
						...
						(this._textHitTest = e || new N.HitTestResult(N.HitTarget.MovePoint, { areaName: N.AreaName.Text })),
						this._textHitTest.mergeData({ activeItem: C.Label });
				}
				setData(e) {
					null === this._data ||
						(this._data.textData.text === e.textData.text && this._data.textData.fontSize === e.textData.fontSize) ||
						(this._textInfoCache = null),
						(this._data = e);
					const t = e.points[1];
				...
				getTextInfo() {
					const e = (0, r.ensureNotNull)(this._data),
						...
						a = (0, r.ensureDefined)(this._textLabelRenderer.data()?.points?.[0]).add((0, k.point)(0, 0.5 * -l.height)),
				...
				_drawImpl(e) {
					...
					const { context: i } = e,
						o = t.points[0],
						r = t.points[1];
					(i.strokeStyle = t.lineColor), (i.lineWidth = Math.max(1, Math.floor(e.horizontalPixelRatio))), i.beginPath();
					...
					(i.fillStyle = t.lineColor),
						...
						(i.lineWidth = 1);
					const s = Math.round(y.CircleRadius * e.horizontalPixelRatio + 0.5 * e.horizontalPixelRatio);
				...
				_calcTextSize() {
					...
					if (null === this._textInfoCache) {
						...
						this._textInfoCache = { textWidth: i, textHeight: t, totalWidth: i + r, totalHeight: t + r };
					}
				...
				_updateImpl(e) {
					...
					this._renderer.append(this._noteRenderer),
						...
						this._renderer.append(
							this.createLineAnchor({ points: i.map(D.mapLineSourcePaneViewPointToLineAnchorPoint) }, 0)
						),
			...
			const Q = new $.TranslatedString('change {title} line color', X.t(null, void 0, i(7455))),
				Z = new $.TranslatedString('change {title} background visibility', X.t(null, void 0, i(30839))),
				ee = new $.TranslatedString('change {title} background color', X.t(null, void 0, i(49765))),
				te = new $.TranslatedString('change {title} border visibility', X.t(null, void 0, i(19298))),
				...
				move(e, t, i) {
					if (null !== this._labelMovingDelta) {
						const t = (0, r.ensureDefined)(e.logical),
							o = { index: t.index + this._labelMovingDelta.index, price: t.price + this._labelMovingDelta.price };
						return (
							this._line.setPoint(1, o, i), this._line.updateAllViews((0, se.sourceChangeEvent)(this._line.id())), !0
						);
					}
					return !1;
				}
			...
			class ce extends _.InplaceTextLineDataSource {
				...
				_createDataSourceBackgroundColorWV() {
					return (0, o.convertPropertyToWatchedValue)(this.properties().childs().backgroundColor).ownership();
				}
			}
		},
		11402: (e, t, i) => {
