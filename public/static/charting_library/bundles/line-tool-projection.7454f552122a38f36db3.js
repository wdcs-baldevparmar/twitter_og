			...
			class x extends r.DefaultProperty {
				constructor(e) {
					const { levelsIterator: t = p, map: i = {}, ...s } = e,
						n = { ...l, ...i };
					s.state && (s.state = _(s.state, n, t)), super(s), (this._map = n), (this._levelsIterator = t);
				}
				state(e, t, i) {
				...
				preferences() {
					return (0, r.extractState)(this.state(this._excludedDefaultsKeys, void 0, !0), this._allDefaultsKeys);
				}
				applyTemplate(e, t) {
					this.mergeAndFire(
						(0, r.extractState)(
					...
					if ((super.setPoint(e, t), !this._recursiveGuard))
						try {
							if (((this._recursiveGuard = !0), 2 === e)) {
								...
								const i = (0, s.ensureNotNull)(this.pointToScreenPoint(this._points[2])).subtract(e).length();
								let o = t.subtract(e);
		...
		12120: (e, t, i) => {
			...
			class a extends n.LineToolFibWedgeBase {
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([i.e(6406), i.e(3889), i.e(8009), i.e(8056), i.e(8537)]).then(i.bind(i, 48306)))
						.ProjectionDefinitionsViewModel;
				}
				static _configureProperties(e) {
					super._configureProperties(e),
						e.addChild('linesColors', new r.LineToolColorsProperty([e.childs().trendline.childs().color]));
				}
			}
		},
	},
