	...
	[7539],
	{
					...
					this._destroyed ||
						(null === this._loadedGraphics &&
							...
							null !== this._metaInfo &&
								...
								this._studySource
									.dataCleared()
									.subscribe(this, this.updateAllViews.bind(this, (0, c.sourceChangeEvent)(this.id()))),
								this._studySource
									.dataUpdated()
									.subscribe(this, this.updateAllViews.bind(this, (0, c.sourceChangeEvent)(this.id()))),
		...
		93378: (e, t, s) => {
			...
			class a {
				...
				setPrices(e) {
					...
					const s = (e, t) => {
						const s = void 0 === e,
							r = void 0 === t;
						return ((!s && !r) || s === r) && (0, i.ensureDefined)(e).formatted === (0, i.ensureDefined)(t).formatted;
					};
							...
							(0, o.drawScaled)(
								...
								() => {
									this._cache.translate(0.5, 0.5),
										(this._cache.font = this._renderParams.fontSize + 'px ' + this._renderParams.font),
			...
			class d extends h.PriceAxisView {
				...
				_updateRendererData(e, t, s) {
					...
					if (o.isEmpty() || null === o.visibleBarsStrictRange() || (null !== a && a.isEmpty())) return;
					...
					for (let e = 0; e < o.length; e++) {
						...
						if (s <= l && (i >= l || h)) {
							...
							for (let s = 0; s < S.length; s++) {
								...
								this._prices.push({ formatted: t.formatPrice(r, n), price: r, coordinate: l, color: u });
							}
						}
					}
				}
			...
			class R extends x.BitmapCoordinatesPaneRenderer {
				constructor(e, t, s) {
					super(), (this._drawRects = []), (this._cacheProvider = e), (this._point = t), (this._label = s);
				}
				hitTest(e) {
			...
			function I(e, t, s) {
				const i = t;
				void 0 === e[i] ? (e[i] = { text: s, ids: [V(s)] }) : ((e[i].text += '/' + s), e[i].ids.push(V(s)));
			}
			class T {
				constructor(e, t) {
					(this._pivots = []),
				...
				_updateImpl() {
					...
					for (let e = 0; e < r.length; e++) {
						...
						for (const t of Object.keys(h)) {
							...
							this._pivots.push({ x1: p, x2: _, y: i, label: h[t].text, labelIds: h[t].ids, src: r[e] });
						}
					}
			...
			class L extends r.NonSeriesStudy {
				constructor(e, t, s, i, r) {
					...
					for (let e = 0; e < l.length; e++) o.childs()[l[e]].subscribe(this, () => this.processHibernate());
				}
				pricesView() {
				...
				getCache(e) {
					if (
						...
						t.horizontalPixelRatio !== s.horizontalPixelRatio || t.verticalPixelRatio !== s.verticalPixelRatio)
					) {
						this._cache && this._cache.destroy();
						const t = this._getActualCacheParams(),
							s = { horizontalPixelRatio: e.horizontalPixelRatio, verticalPixelRatio: e.verticalPixelRatio };
				...
				_createViews() {
					...
					for (let t = 0; t < e.length; t++) {
						...
						this._priceAxisViews.push(s), this._labelPaneViews.push(new p.PanePriceAxisView(s, this, this._model));
					}
					this._dataWindowView || (this._dataWindowView = new _.StudyDataWindowView(this, this._model)),
		...
		31257: (e, t, s) => {
			...
			class n extends o.Study {
				constructor(e, t, s, i, r) {
					super(e, t, s, i, r),
						(this._underlyingData = new l.PlotList((0, a.studyPlotFunctionMap)(i), a.studyEmptyPlotValuePredicate));
				}
				clearData() {
						...
						for (const { index: a, value: n } of e.rangeIterator(l, o)) {
							...
							if (r) {
								if (r.pointIndex !== c.pointIndex) {
									...
									let s = !1;
									if (
										(i && r && (s = (i.value <= r.value && r.value <= l) || (i.value >= r.value && r.value >= l)), s)
									) {
										if (r.pointIndex >= 0) {
		...
		34425: (e, t, s) => {
			...
			class n extends o.PriceAxisView {
				...
				_updateRendererData(e, t, s) {
					...
					const l = this._source.properties().childs().graphics.childs().horizlines?.childs()[this._styleId].childs();
					if (!(l && l.visible && l.visible.value() && this._isLabelVisibleAccordinglyToProperties())) return;
				...
				_isLabelVisibleAccordinglyToProperties() {
					return (
						!!this._source.model().properties().childs().scalesProperties.childs().showStudyLastValue.value() &&
			...
			class d extends h.Study {
				...
				_createStudyPlotPaneView(e) {
					return new c.StudyPlotPaneView(this, this._series, this._model, e, this._needExtendToBarsEnding());
				}
				_apiInputs() {
					return { ...super._apiInputs(), mapRightBoundaryToBarStartTime: !!this._needExtendToBarsEnding() || void 0 };
				}
			...
			class p extends d {
				constructor(e, t, s, i, r) {
					t.setThemedColors(
						(0, u.volumeProfileThemedColors)(t.childs().graphics.childs().polygons?.hasChild('histBoxBg'))
					),
						super(e, t, s, i, r);
				}
			}
			class _ extends p {
				priceRange(e, t, s) {
					...
					this.graphics()
						.hhists()
						.forEach((e, t) => {
							r = r || (0, i.ensureDefined)(this.properties().childs().graphics.childs().hhists?.childs()[t]).value();
						});
					...
					return a.isLog() ? new l.PriceRange(a.priceToLogical(o.minValue()), a.priceToLogical(o.maxValue())) : o;
				}
			}
			class y extends _ {
		...
		47988: (e, t, s) => {
			...
			function p(e) {
				...
				return e && i.push({ path: 'graphics.polygons.histBoxBg.color', colors: d.histogramBoxColor }), i;
			}
		},
		7021: (e, t, s) => {
		...
		38496: (e, t, s) => {
			...
			class L extends R.PriceAxisView {
				...
				_updateRendererData(e, t, s) {
					...
					h.showSeriesLastValue.value() &&
						...
						(e.visible = !0)),
						(t.text = ''),
						h.showSymbolLabels.value() && ((t.text = this._paneText()), (t.visible = t.text.length > 0));
				}
				_paneText() {
					let e = '';
					...
					return (
						A
							...
							: this._source.model().properties().childs().scalesProperties.childs().showSymbolLabels.value() &&
			...
			class F {
				constructor(e) {
					(this._lineRenderer = new E.HorizontalLineRenderer()), (this._visible = !1), (this._source = e);
				}
				update() {
			...
			class te {
				...
				getValues(e) {
					...
					if (
						((0, H.isNumber)(e) ||
							(l ? (e = i) : ((e = this._model.crosshairSource().appliedIndex()), (0, H.isNumber)(e) || (e = i))),
					...
					const n = o.index,
						...
						d = h[3],
						p = h[4];
					(t[0].value = X), (t[1].value = X), (t[2].value = X), (t[3].value = X), (t[7].value = ee), (t[6].value = ee);
					...
					if ((0, j.shouldBeFormattedAsPercent)(this._study) || (0, j.shouldBeFormattedAsIndexedTo100)(this._study))
						(t[7].value = ''), (t[6].value = '');
					else {
					...
					return (
						t[7].visible &&
							(t[7].color = (0, T.resetTransparency)((0, $.calculateColor)(a, this._getChangeColor(v?.change)))),
						t
					);
				}
			...
			class oe extends te {
				...
				getValues(e) {
					...
					if (this._showLastPriceAndChangeOnly()) return (t[6].visible &&= o), (t[7].visible = !1), t;
			...
			class ne extends re {
				constructor(e, t) {
					super(e, t),
						...
						this._backgroundColorSpawn.subscribe(this.update.bind(this, (0, le.sourceChangeEvent)(e.id())));
					const s = t.properties().childs().paneProperties.childs().legendProperties.childs();
					(this._visibilityProperty = (0, ae.combineProperty)(
						...
						this._visibilityProperty.subscribe(this, this.update.bind(this, (0, le.sourceChangeEvent)(e.id())));
				}
				areValuesVisible() {
			...
			class ke extends o.Study {
					...
					super(
						...
						(function (e) {
							e.hasChild('currencyId') || e.addChild('currencyId', new u.Property(null)),
								...
								(0, be.allChartStyles)().includes(e.childs().style.value()) || e.childs().style.setValueSilently(2);
							const t = e.childs();
				...
				isConvertedToOtherUnit() {
					return (0, c.isConvertedToOtherUnit)(this.symbolInfo(), this._model.unitConversionEnabled());
				}
				style() {
				...
				state(e, t) {
					...
					return (
						...
						e && ((0, i.ensureDefined)(s.data).symbols = { ___snapshot: this.symbolInfo() || void 0 }),
						s
					);
				}
				symbolTitle(e, t, s) {
				...
				sourceId() {
					return null === this._seriesSource ? super.sourceId() : (0, i.ensureNotNull)(this._seriesSource.instanceId());
				}
				moveData(e) {
				...
				firstValue() {
					...
					return (this._ownFirstValue = null !== s ? this._barFunction(s.value, 0) : null), this._ownFirstValue;
				}
				...
				lastValueData(e, t, s) {
					const i = { noData: !0 },
						r = this.priceScale();
					if (this._model.timeScale().isEmpty() || null === r || r.isEmpty() || this.data().isEmpty()) return i;
					...
					switch (o.style.value()) {
						case 0:
							y = d[1] <= d[4] ? o.barStyle.childs().upColor.value() : o.barStyle.childs().downColor.value();
							break;
						case 1:
							y = d[1] <= d[4] ? o.candleStyle.childs().upColor.value() : o.candleStyle.childs().downColor.value();
							break;
						case 9:
							y =
								d[1] <= d[4]
							...
							break;
						case 13:
							y = d[1] <= d[4] ? o.columnStyle.childs().upColor.value() : o.columnStyle.childs().downColor.value();
							break;
						case 2:
					...
					const v = { ...r.getFormattedValues(p, n, !0), noData: !1, floatCoordinate: _, coordinate: _, color: y };
					...
					return (
						...
						Ce &&
							this._setQuotesSymbol(
								(0, d.encodeExtendedSymbolOrGetSimpleSymbolString)(this._getSymbolObject(this.symbol()))
							),
						s
					);
				}
				...
				formatter() {
					return this._formatter || this._recreateFormatter(), (0, i.ensureNotNull)(this._formatter);
				}
				statusView() {
				...
				_tryCreateFormatter() {
					...
					return null !== e
						? e
						: (0, c.createSeriesFormatter)(this.symbolInfo(), this.properties().childs().minTick.value());
				}
				_tryCreateDefaultFormatter() {
					return (0, c.createSeriesFormatter)(this.symbolInfo(), 'default');
				}
				_onUnitChanged() {
					'alwaysOff' !== (0, n.currencyUnitVisibilityProperty)().value() && this._model.fullUpdate(),
				...
				_onSymbolResolved(e, t, s) {
					...
					const i = t === this.symbol() ? (0, c.extractSymbolNameFromSymbolInfo)(s, this.symbol()) : null,
				...
				_onQuotesUpdate(e, t) {
					!this._legendView ||
						...
						(this._legendView.update((0, le.sourceChangeEvent)(this.id())), this._model.updateSource(this));
				}
				_createViews() {
				...
				_titleInParts(e, t, s, i, r) {
					...
					return [
						...
						[this._getExchangeTitlePart(l, r), this._getPriceSourceTitlePart(l)].filter((e) => null !== e),
					];
				}
				_getSymbolTitlePart(e) {
					if (null === e) return Ve ? '' : this.properties().childs().inputs.childs().symbol.value();
					if (xe)
				...
				_onAllowExtendTimeScaleChanged() {
					...
					this.properties().childs().inputs.childs().extendTimeScale.setValue(t), e && this.start(!0);
				}
				...
				_checkStyle() {
					const e = this.style();
					(0, c.isCloseBasedSymbol)(this.symbolInfo()) || this.model().mainSeries().intervalObj().is1Tick()
						? (0, c.isSingleValueBasedStyle)(e) ||
							(this.setStyle(2), (this._styleToRecover = { correctedStyle: this.style(), originalStyle: e }))
