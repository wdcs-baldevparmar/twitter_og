	...
	[6780],
	{
		...
		78890: (e, t, i) => {
			...
			class p extends s.PureComponent {
				...
				_getPlaceHolderItem(e) {
					return e ? s.createElement(o.Icon, { className: d.defaultsButtonIcon, icon: u }) : m.defaults;
				}
			}
		},
		48531: (e, t, i) => {
			...
			function f(e) {
				...
				return s.createElement(
					...
					s.createElement(m.PopupMenuItem, {
						...
						label: t,
						onClick: l,
						toolbox: i && s.createElement(h.RemoveButton, { hidden: !g.mobiletouch && !n, onClick: c, icon: b }),
					})
				);
			}
			function v(e) {
		...
		75892: (e, t, i) => {
			...
			var s = i(50959),
				...
				I = i(56570),
				E = i(29521);
			const A = new S.TranslatedString('change {sourceTitle} title to {newSourceTitle}', c.t(null, void 0, i(23687)));
			class P extends s.PureComponent {
				constructor(e) {
					super(e),
					...
					const { pages: t } = this.props;
					let i;
					if (this._getActionPageById(this.props.activePageId)) i = (0, n.ensureDefined)(this.props.activePageId);
					else {
				...
				render() {
					...
					return s.createElement(u.AdaptiveConfirmDialog, {
						dataName: (0, f.isStudy)(t) ? 'indicator-properties-dialog' : 'source-properties-editor',
						dataDialogName: n,
						title: o,
						isOpened: !0,
				...
				_renderChildren(e) {
					return ({ requestResize: t }) => {
						...
						const { pages: i, source: a } = this.props,
							...
							l = (0, f.isStudy)(a) ? 'indicator-properties-dialog-tabs' : 'source-properties-editor-tabs',
		...
		66512: (e, t, i) => {
			...
			function b(e) {
				const {
					...
					S = !!(C && x && o && f.every((e) => x?.id === v.model().lineToolsGroupModel().groupForLineTool(e)?.id)),
					[T, y] = (0, s.useState)(_),
					[w, I] = (0, s.useState)(!1),
		...
		86720: (e, t, i) => {
			...
			const v = (0, a.forwardRef)((e, t) => {
				...
				return a.createElement(
					...
					m && 'string' == typeof h
						? a.createElement('span', { className: o()(b['ellipsis-children'], 'apply-overflow-tooltip') }, h)
						: h
				);
			});
			v.displayName = 'UnderlineTabsBaseButton';
			const C = (0, a.forwardRef)((e, t) => {
				const { item: i, highlighted: s, handleItemRef: n, onClick: o, 'aria-disabled': l, ...r } = e,
					c = (0, a.useCallback)(() => {
						o && o(i);
					}, [o, i]),
					u = (0, a.useCallback)(
						(e) => {
							n && n(i, e), t && 'object' == typeof t ? (t.current = e) : 'function' == typeof t && t(e);
						},
						[i, n, t]
					);
			...
			function k(e) {
				...
				return a.createElement(T.Icon, { icon: P(t), className: n(A['arrow-icon'], A[`size-${t}`], i && A.dropped) });
			}
			var B = i(33636);
			const z = 4,
				N = 4;
			...
			function J(e) {
				...
				return a.createElement(
					...
					a.createElement('div', { className: V().corner, style: { transform: `scaleX(${1 / o})` } }),
					a.createElement('div', { className: V().center, style: { transform: `scaleX(${1 - 30 / e.scale})` } }),
					a.createElement('div', { className: V().corner, style: { transform: `scaleX(${1 / o})` } })
				);
			}
			function U(e) {
				const {
					...
					{ isOpened: re, open: ce, close: ue, onButtonClick: de } = (0, d.useDisclosure)({ id: t, disabled: b }),
				...
				const Ee = (function (e, t, i = []) {
					...
					return (
						...
						(0, a.useEffect)(() => {
							if (void 0 === t) return;
							const i = e.get(t);
							return void 0 !== i ? (r(i), o.current?.observe(i), () => o.current?.disconnect()) : void 0;
						}, i),
						s
					);
				...
				return a.createElement(
					...
					a.createElement(
						'div',
						{ ...ge, className: X({ size: v, overflowBehaviour: F, className: S }), style: T, 'data-name': A },
						a.createElement(
							'div',
							{
								...pe,
							...
							ne.map((e) => a.createElement(C, { ...Se(e), ref: se(V(e)), key: e.id, item: e, fake: !0 })),
							'collapse' === F &&
								a.createElement(R, {
									size: v,
									disabled: b,
			...
			(0, a.forwardRef)((e, t) => {
				const { size: i, overflowBehaviour: s } = (0, a.useContext)(p),
					...
					S = (0, a.useCallback)(
						(e) => {
							r && r(o, e), t && 'object' == typeof t ? (t.current = e) : 'function' == typeof t && t(e);
						},
						[o, r, t]
					),
