			...
			class P extends o.DefaultProperty {
				constructor(e) {
					const { levelsIterator: t = u, map: i = {}, ...s } = e,
						n = { ...a, ...i };
					s.state && (s.state = f(s.state, n, t)), super(s), (this._map = n), (this._levelsIterator = t);
				}
				state(e, t, i) {
		...
		64002: (e, t, i) => {
			...
			class v extends c.LineDataSource {
				...
				async additionalActions(e) {
					const t = [],
						s = [
							{ title: r.t(null, void 0, i(46005)), actionId: 'Chart.LineTool.Pitchfork.ChangeTypeToOriginal' },
							{ title: r.t(null, void 0, i(70382)), actionId: 'Chart.LineTool.Pitchfork.ChangeTypeToModifiedSchiff' },
							{ title: r.t(null, void 0, i(91612)), actionId: 'Chart.LineTool.Pitchfork.ChangeTypeToInside' },
							{ title: r.t(null, void 0, i(69904)), actionId: 'Chart.LineTool.Pitchfork.ChangeTypeToSchiff' },
						];
					for (let i = 0; i < 4; i++) {
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([i.e(6406), i.e(3889), i.e(8009), i.e(8056), i.e(8537)]).then(i.bind(i, 10258)))
				...
				static _configureProperties(e) {
					...
					for (let n = 0; n <= 8; n++) {
						...
						t.push((0, s.ensureDefined)(r.child('linewidth'))), i.push((0, s.ensureDefined)(r.child('color')));
					}
