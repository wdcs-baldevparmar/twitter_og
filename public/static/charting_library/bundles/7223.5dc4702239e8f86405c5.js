(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[7223],
	{
		...
		15499: (e, t, n) => {
			...
			function f(e, t) {
				switch (e) {
					case c.Month: {
						const e = new Date(t);
						return e.setMonth(e.getMonth() - 1), `${l.prevMonth}, ${o()[e.getMonth()]} ${e.getFullYear()}`;
					}
					case c.Year:
			...
			function m(e, t) {
				switch (e) {
					case c.Month: {
						const e = new Date(t);
						return e.setMonth(e.getMonth() + 1), `${l.nextMonth}, ${o()[e.getMonth()]} ${e.getFullYear()}`;
					}
					case c.Year:
			...
			function b(e, t) {
				switch (e) {
					...
					case c.Year:
						return u.setDecades.format({ year_start: `${t.getFullYear()}`, year_end: '' + (t.getFullYear() + p - 1) });
					case c.Decades:
		...
		44313: (e, t, n) => {
			...
			function c(e) {
				...
				return s.createElement(
					...
					s.createElement(
						o.LightButton,
						{ size: 'small', variant: 'ghost', 'aria-label': r, onClick: v, disabled: h, onKeyDown: y, reference: g },
						a
					),
					s.createElement(o.LightButton, {
						startSlot: s.createElement(i.Icon, { icon: l }),
			...
			class g extends s.PureComponent {
				...
				render() {
					const e = r(
							...
							!this.props.isDisabled && (this.props.isSelected || this._isOnHighlightedEdge()) && u['accent-color'],
			...
			function y({
				...
				const [c, h] = (0, v.useRefsMap)(),
					...
					g = (0, s.useCallback)(
						(n, s) => {
							if (!n) return null;
							const r = (0, d.getCloneDateWithOffset)({ dateFrom: n, offset: s, isDisabledDate: e, level: u });
							return p(t(r));
						},
						[t, p]
					),
					...
					y = (0, s.useCallback)(
						(t, n) => {
							if (!t) return;
							const s = (0, d.getCloneDateWithOffset)({ dateFrom: t, offset: n, isDisabledDate: e, level: u });
							s && (n > 0 ? a(s) : o(s));
						},
						[e, a, o]
					),
					...
					})({ refsMap: c, verticalOffset: l, getNextKeyToFocus: g, getFirstKey: f, getLastKey: m, onGridEnd: y });
				return (
			...
			function k({
				...
				const [g, f] = (0, s.useState)(e),
					...
					N = (0, s.useCallback)(
						(e) => {
							const t = new Date(g);
							t.setMonth(e.getMonth()), (0, d.isSameMonth)(t, e) || t.setMonth(e.getMonth(), 1), f(t);
			...
			class M {
				...
				_findById(e) {
					return this._renderedMessage?.id === e ? this._renderedMessage : this._messagesQueue.find((t) => t.id === e);
				}
			...
			var x;
			function T({ viewType: e, decadesStartYear: t, viewDate: n, setPrev: r, setNext: a, switchViewType: o }) {
				const [i, l] = (0, s.useState)(null),
					u = (0, s.useCallback)(
						(e) => {
				...
				return {
					onPrevClick: (0, s.useCallback)(() => {
						u((0, p.getPrevLiveRegionConfirmation)(e, e === p.CalendarViewType.Decades ? t : n)), r(null);
					}, [r, u]),
					onNextClick: (0, s.useCallback)(() => {
						u((0, p.getNextLiveRegionConfirmation)(e, e === p.CalendarViewType.Decades ? t : n)), a(null);
					}, [a, u]),
					onSwitchViewType: (0, s.useCallback)(
						(s) => {
							u((0, p.getViewTypeLiveRegionConfirmation)(e, e === p.CalendarViewType.Year ? t : n)), o(s);
						},
						[o, u]
					),
				};
			...
			function R(e) {
				...
				const $ = (0, s.useCallback)(
						(e) => {
							x && 38 === (0, D.hashFromEvent)(e) && (e.preventDefault(), e.stopPropagation(), L(!1), x());
						},
						[x]
					),
					{
					...
					}),
					{
						...
						const n = (0, s.useRef)(null),
							r = (0, s.useCallback)(
								(t) => {
									e && D.Modifiers.Shift + 9 === (0, D.hashFromEvent)(t) && (t.preventDefault(), n.current?.focus());
								},
								[e]
							),
							a = (0, s.useCallback)(
							...
							u = (0, s.useCallback)(
								(e) => {
									e.preventDefault(), e.stopPropagation(), t ? l.current?.focus() : i.current?.focus();
								},
								[t]
							);
						return {
					...
					ce = (0, s.useMemo)(() => J[0], [J]),
					{
						...
						onNextClick: he,
						onSwitchViewType: pe,
					} = T({ viewType: B, decadesStartYear: ce, viewDate: A, setPrev: X, setNext: G, switchViewType: ee });
				return (
					...
					s.createElement(
						...
						s.createElement(c, {
							...
							currentAriaLabel: (0, p.getCurrentAriaLabel)(B, B === p.CalendarViewType.Year ? ce : A),
							currentVisibleTitle: (0, p.getCurrentVisibleTitle)(B, B === p.CalendarViewType.Decades ? ce : A),
							onPrevClick: de,
							onNextClick: he,
							onPrevKeyDown: ie,
							onMiddleKeyDown: le,
					...
					return r.createElement(
						...
						this.props.showPicker && !o
							? r.createElement(
									...
									r.createElement(f.OutsideEvent, { mouseDown: !0, handler: this.props.onHidePicker }, (t) =>
										r.createElement(
											'span',
				...
				constructor(e) {
					super(e),
						...
						(this._returnFocusToInput = (e) => {
							this.setState({ autofocusCalendar: !1 }), this._pickerInpuRef.current?.focus(), e && this._hideCalendar();
						}),
						(this._fixValue = (e) => (
						...
						(this._onBlur = (e) => {
							if (!this.props.revertInvalidData || this._pickerInputContainerRef.current?.contains(e.relatedTarget))
								return;
							const { value: t } = e.target;
							if (!this._isValid(t)) {
		...
		23935: (e, t, n) => {
			...
			function M({ dateFrom: e, offset: t, level: n = 'day', maxIterations: s = 6, isDisabledDate: r = () => !1 }) {
				...
				for (; a < i && o < l; ) {
					...
					l
						? (i.match(l.pattern)
							...
							(o += 1))
						: (t || s.push(n), i === n ? (d.push(o), (o += 1)) : ((g = n), d.push(o + c), c++), (a += 1));
				}
				const f = e.charAt(h);
				i !== l + 1 || y[f] || s.push(f);
				const m = s.join(''),
				...
				return r.createElement(
					...
					r.createElement(F, {
						...
						onKeyDown: function (t) {
							...
							13 === n &&
								(t.preventDefault(), V(w), e.keepFocusOnKeyBoardNavigation || (0, i.ensureNotNull)(s.current).blur());
							27 === n &&
								(t.preventDefault(), e.keepFocusOnKeyBoardNavigation || (0, i.ensureNotNull)(s.current).blur());
						},
		...
		82665: (e, t, n) => {
			...
			const l = function (e, t, n) {
				...
				if (!l || t < 1) return [];
				for (var u = 0, c = 0, d = Array(o(l / t)); u < l; ) d[c++] = (0, s.default)(e, u, (u += t));
				return d;
			};
		},
	},
