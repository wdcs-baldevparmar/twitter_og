			...
			class d extends l.InplaceTextLineDataSource {
				...
				static _configureProperties(e) {
					super._configureProperties(e),
						...
						e.addChild('backgroundsColors', new a.LineToolColorsProperty([e.childs().backgroundColor])),
						e.addChild('textsColors', new a.LineToolColorsProperty([e.childs().textColor], e.childs().showLabel)),
