...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[9014],
	{
		73174: (e, t, n) => {
			...
			function m(e, t, n) {
				return { property: (0, d.convertToDefinitionProperty)(e, t.price, _), info: { typeY: 1, stepY: n } };
			}
			function P(e, t) {
				return {
		...
		53749: (e, t, n) => {
			...
			var i = n(11542),
				...
				r = n(32097),
				s = n(91682);
			const a = new o.TranslatedString('change {toolName} line visibility', i.t(null, void 0, n(24550))),
				...
				h = new o.TranslatedString('change {toolName} line extending left', i.t(null, void 0, n(18773))),
				u = new o.TranslatedString('change {toolName} line left end', i.t(null, void 0, n(21474))),
				p = new o.TranslatedString('change {toolName} line extending right', i.t(null, void 0, n(43823))),
			...
			function m(e, t, n, i, o) {
				...
				return (
					void 0 !== t.showLine &&
						(m.checked = (0, r.convertToDefinitionProperty)(e, t.showLine, a.format({ toolName: n }))),
					void 0 !== t.lineWidth &&
						(m.width = (0, r.convertToDefinitionProperty)(e, t.lineWidth, l.format({ toolName: n }))),
					void 0 !== t.lineStyle &&
						(m.style = (0, r.convertToDefinitionProperty)(e, t.lineStyle, d.format({ toolName: n }))),
					void 0 !== t.lineColor &&
						(m.color = (0, r.getColorDefinitionProperty)(e, t.lineColor, null, c.format({ toolName: n }))),
					void 0 !== t.extendLeft &&
						((m.extendLeft = (0, r.convertToDefinitionProperty)(e, t.extendLeft, h.format({ toolName: n }))),
						(P.extendLeftTitle = (o && o.extendLeftTitle) || f)),
					void 0 !== t.leftEnd &&
						(m.leftEnd = (0, r.convertToDefinitionProperty)(e, t.leftEnd, u.format({ toolName: n }))),
					void 0 !== t.extendRight &&
						((m.extendRight = (0, r.convertToDefinitionProperty)(e, t.extendRight, p.format({ toolName: n }))),
						(P.extendRightTitle = (o && o.extendRightTitle) || x)),
					void 0 !== t.rightEnd &&
						(m.rightEnd = (0, r.convertToDefinitionProperty)(e, t.rightEnd, g.format({ toolName: n }))),
		...
		86622: (e, t, n) => {
			...
			var i = n(11542),
				...
				a = n(32097),
				l = n(91682);
			const d = new o.TranslatedString('change {title} background visibility', i.t(null, void 0, n(30839))),
		...
		54696: (e, t, n) => {
				...
				_drawImpl(e) {
					...
					if (2 === this._data.points.length)
						t.beginPath(),
							...
							t.lineTo(i.x, i.y),
							t.stroke(),
							this._data.leftEnd === g.LineEnd.Arrow && (0, p.drawArrow)(i, n, t, t.lineWidth, h.dpr1PixelRatioInfo),
							this._data.rightEnd === g.LineEnd.Arrow && (0, p.drawArrow)(n, i, t, t.lineWidth, h.dpr1PixelRatioInfo);
					else {
						...
						this._data.fillBack &&
							...
							this._data.leftEnd === g.LineEnd.Arrow && (0, p.drawArrow)(s, n, t, t.lineWidth, h.dpr1PixelRatioInfo),
							this._data.rightEnd === g.LineEnd.Arrow && (0, p.drawArrow)(c, i, t, t.lineWidth, h.dpr1PixelRatioInfo),
							t.stroke();
					}
				}
			}
			...
			class v extends l.LineSourcePaneView {
				...
				_updateImpl(e) {
					...
					if (4 === this._source.points().length) {
						const r = (0, i.ensureNotNull)(this._source.pointToScreenPoint(this._source.points()[0])),
			...
			class y extends r.LineDataSource {
				...
				static createProperties(e, t) {
					const n = new o.DefaultProperty({ defaultName: 'linetoolbeziercubic', state: t, theme: e });
				...
				_calculateControlPoints() {
					const e = (0, i.ensureNotNull)(this.pointToScreenPoint(this.points()[0])),
						...
						s = o.add(n),
						a = r.subtract(n);
					return [(0, i.ensureNotNull)(this.screenPointToPoint(s)), (0, i.ensureNotNull)(this.screenPointToPoint(a))];
				}
			}
		},
		35246: (e, t, n) => {
			...
			class c extends r.LineSourcePaneView {
				...
				_updateImpl(e) {
					...
					if (3 === this._source.points().length) {
						const o = (0, i.ensureNotNull)(this._source.pointToScreenPoint(this._source.points()[0])),
							s = (0, i.ensureNotNull)(this._source.pointToScreenPoint(this._source.points()[1])),
							a = (0, i.ensureNotNull)(this._source.pointToScreenPoint(this._source.points()[2])),
							l = s.subtract(o),
		...
		6298: (e, t, n) => {
			n.d(t, { BezierQuadroRenderer: () => g, buildExtendedSegments: () => p, hitTestExtendedPoints: () => u });
			var i = n(4652),
				o = n(75919),
				r = n(49857),
				s = n(56468),
			...
			function u(e, t, n) {
				for (const o of n)
					for (let n = 1; n < o.length; n++) {
						const r = o[n - 1],
							a = o[n];
						if ((0, i.distanceToSegment)(r, a, e).distance < t) return new s.HitTestResult(s.HitTarget.MovePoint);
					}
				return null;
			}
			function p(e, t) {
			...
			class g extends o.MediaCoordinatesPaneRenderer {
				...
				hitTest(e) {
					if (null !== this._data && 3 === this._data.points.length) {
						...
						if ((0, l.quadroBezierHitTest)(o, n, a, e, t) || (0, l.quadroBezierHitTest)(o, i, d, e, t))
				...
				_drawImpl(e) {
					...
					if (
						...
						this._data.fillBack &&
							...
							this._data.leftEnd === r.LineEnd.Arrow && (0, d.drawArrow)(s, t, o, o.lineWidth, a.dpr1PixelRatioInfo),
							this._data.rightEnd === r.LineEnd.Arrow && (0, d.drawArrow)(l, n, o, o.lineWidth, a.dpr1PixelRatioInfo),
							o.stroke();
					}
				}
			}
		...
		27916: (e, t, n) => {
			n.d(t, { LineSourcePaneView: () => _, createLineSourcePaneViewPoint: () => g, thirdPointCursorType: () => p });
			var i = n(19625),
				o = n(50151),
				r = n(69186),
				s = n(56468),
			...
			class _ {
				...
				_anchorRadius() {
					return (0, r.lastMouseOrTouchEventInfo)().isTouch ? u.TouchAnchorRadius : u.RegularAnchorRadius;
				}
				_lineAnchorColors(e) {
		...
		36036: (e, t, n) => {
			...
			function u(e, t, n, i) {
				const { point: o } = t,
					r = n + i / 2;
				(0, s.drawRoundRect)(e, o.x - r, o.y - r, 2 * r, 2 * r, (n + i) / 2), e.closePath(), (e.lineWidth = i);
			}
			function p(e, t, n, i) {
					...
					for (let e = 0; e < t.length; ++e) {
						...
						if (!((0, a.isInteger)(r.pointIndex) && h.linePointBeingEdited === r.pointIndex)) {
							...
							if (
								(o(
									l,
									{ ...r, point: new i.Point(Math.round(r.point.x * d) + f, Math.round(r.point.y * c) + f) },
									_ / 2,
									p
								),
