		...
		99294: (e, t, i) => {
			...
			class l extends o.InplaceTextLineDataSource {
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([i.e(6406), i.e(3889), i.e(8009), i.e(8056), i.e(8537)]).then(i.bind(i, 26360)))
				...
				static _createPropertiesImpl(e, t, i, n) {
					i &&
						...
						((i.showPercentPriceRange = i.showPriceRange), (i.showPipsPriceRange = i.showPriceRange));
					const r = new s.DefaultProperty({ theme: t, defaultName: e, state: i, useUserPreferences: n });
