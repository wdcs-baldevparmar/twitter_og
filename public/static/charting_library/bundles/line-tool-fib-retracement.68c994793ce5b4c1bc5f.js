			...
			class x extends o.DefaultProperty {
				constructor(e) {
					const { levelsIterator: t = p, map: i = {}, ...s } = e,
						r = { ...l, ...i };
					s.state && (s.state = _(s.state, r, t)), super(s), (this._map = r), (this._levelsIterator = t);
				}
				state(e, t, i) {
				...
				preferences() {
					return (0, o.extractState)(this.state(this._excludedDefaultsKeys, void 0, !0), this._allDefaultsKeys);
				}
				applyTemplate(e, t) {
					this.mergeAndFire(
						(0, o.extractState)(
		...
		33168: (e, t, i) => {
			...
			class u extends c.LineToolFibWithInplaceTextBase {
				...
				fibLevelsBasedOnLogScale() {
					return this.properties().childs().fibLevelsBasedOnLogScale.value() && !!this.priceScale()?.isLog();
				}
				template() {
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([i.e(6406), i.e(3889), i.e(8009), i.e(8056), i.e(8537)]).then(i.bind(i, 75450)))
				...
				static _configureProperties(e) {
					super._configureProperties(e);
					const t = [e.childs().trendline.childs().linewidth, e.childs().levelsStyle.childs().linewidth],
