...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[507],
	{
		74011: (t, e, i) => {
			...
			class f extends h.MediaCoordinatesPaneRenderer {
				...
				hitTest(t) {
					...
					const e = Math.max((0, d.interactionTolerance)().line, Math.ceil(this._data.linewidth / 2)),
					...
					try {
						...
						if (
							...
							if (this._data.leftend === a.LineEnd.Arrow) {
								const t = this._correctArrowPoints(this._points[1], this._points[0], e.lineWidth, s);
								(0, n.drawArrow)(t[0], t[1], e, e.lineWidth, p.dpr1PixelRatioInfo);
							}
							if (this._data.rightend === a.LineEnd.Arrow) {
								const t = this._correctArrowPoints(this._points[i - 2], this._points[i - 1], e.lineWidth, s);
								(0, n.drawArrow)(t[0], t[1], e, e.lineWidth, p.dpr1PixelRatioInfo);
							}
						}
					...
					i.forEach((t, i) => {
						...
						t.forEach((t) => {
							...
							h === i - 1 && (d = l || d),
								...
								(d < 0 && c < 0) ||
									(d > e.width() && c > e.width()) ||
									this._data.push({ x1: d, x2: c, color: r.color.value(), transparency: r.transparency.value() });
						});
					});
				}
			}
		...
		56208: (t, e, i) => {
					...
					for (const s of i.histograms) {
						...
						for (const a of s.bars) {
							...
							for (let e = 0; e < a.subBarValues.length; e++) {
								...
								if (((f = o), ((t.x >= n && t.x <= o) || (t.x >= o && t.x <= n)) && t.y >= i && t.y <= s))
			...
			function g(t, e) {
				return e === n.HHistDirection.RightToLeft && (t = t.slice()).reverse(), t.map((t) => p.format(t)).join('x');
			}
			...
			class w {
					...
					for (const n of e) {
						...
						if (s)
							...
							const t = (0, x.generateColor)(e.colors[0].value(), e.transparencies[0].value()),
								i = e.colors[1] ? (0, x.generateColor)(e.colors[1].value(), e.transparencies[1].value()) : t;
				...
				_updateDataForRenderers(t, e, i) {
					...
					t.forEach((t) => {
						...
						d.push({ height: n.max - n.min, y: n.min, subBarValues: i, displayedValues: s, styleId: r });
					}),
						d.sort((t, e) => t.y - e.y),
		...
		38332: (t, e, i) => {
			...
			class h {
				...
				_updateViewInternal() {
					...
					const l = n.firstBar(),
						h = n.lastBar(),
						d = (0, s.ensureDefined)(this._provider.properties().childs().graphics.childs().polygons),
		...
		51914: (t, e, i) => {
			...
			class l {
				...
				_updateViewInternal() {
					...
					const l = a.firstBar(),
						h = a.lastBar(),
						d = (0, s.ensureDefined)(this._provider.properties().childs().graphics.childs().vertlines);
					r.forEach((r, a) => {
