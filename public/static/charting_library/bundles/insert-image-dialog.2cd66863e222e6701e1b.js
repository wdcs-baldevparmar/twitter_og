(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[7038],
	{
		...
		67248: (e, t, n) => {
			...
			function f(e) {
				const { startSlot: t, iconOnly: n, children: r, endSlot: o, primaryText: i, secondaryText: s } = e;
				if (t && o && n) return c.createElement('span', { className: u(m().slot, m().startSlotWrap) }, t);
				const a = n && (t ?? o),
					l = !t && !o && !n && !r && i && s;
			...
			function _(e) {
				const {
					...
					{ isGrouped: u, cellState: d, disablePositionAdjustment: p } = (0, c.useContext)(v.ControlGroupContext),
					m = g({ ...l, isGrouped: u, cellState: d, disablePositionAdjustment: p }),
					h = n ?? (e.primaryText ? [e.primaryText, e.secondaryText].join(' ') : (0, y.getTextForTooltip)(e.children));
				return c.createElement(
					'button',
					{
						...E(l),
		...
		36383: (e, t, n) => {
			...
			function s(e) {
				const { click: t, mouseDown: n, touchEnd: s, touchStart: a, handler: l, reference: c } = e,
					u = (0, r.useRef)(null),
					d = (0, r.useRef)('undefined' == typeof window ? 0 : new window.CustomEvent('timestamp').timeStamp);
				return (
							...
							o.createElement(
								...
								o.createElement(
									...
									h &&
										o.createElement(
											a.Button,
											{ className: y, name: 'cancel', appearance: 'stroke', onClick: this._handleCancel },
						...
						: r.createElement(
								...
								!E || h
									? r.createElement(
											...
											(function (e) {
												return Boolean(e)
													? r.createElement('span', { className: o(y.textBlockHeadline, y.textBlockError) }, e)
													: r.createElement('span', { className: y.textBlockHeadline }, s.t(null, void 0, n(32910)));
											})(h ?? _),
						...
						(0, l.generateLink)(e)
							...
							.then((e) => {
								...
								const { data: n, filepath: o } = e,
									{ url: i } = n;
								(t.options.url = i), (f.current = e.data.fields), (y.current = i + o), t.processQueue();
							});
				}
				function S() {
