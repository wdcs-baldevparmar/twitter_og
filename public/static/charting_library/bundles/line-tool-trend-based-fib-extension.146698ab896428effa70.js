		...
		68554: (e, t, i) => {
			...
			class h extends l.LineToolFibWithInplaceTextBase {
				...
				fibLevelsBasedOnLogScale() {
					return this.properties().childs().fibLevelsBasedOnLogScale.value() && Boolean(this.priceScale()?.isLog());
				}
				template() {
				...
				static createProperties(e, t) {
					const i = new r.LevelsProperty({
						...
						state: t,
						map: { names: ['coeff', 'color', 'visible', 'linestyle', 'linewidth', 'text'], range: [0, 24] },
						theme: e,
					});
