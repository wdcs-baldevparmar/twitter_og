		...
		21986: (e, r, t) => {
			...
			class n extends o.LineToolRiskRewardBase {
				...
				static createProperties(e, r) {
					const t = new s.DefaultProperty({ defaultName: 'linetoolriskrewardlong', state: r, theme: e });
				...
				_checkStopPrice(e) {
					const r = this.stopPrice(),
						t = this.profitPrice();
					return (0, i.ensure)(e[3]) <= r ? this.stopPrice() : (0, i.ensure)(e[2]) >= t ? this.profitPrice() : null;
				}
				_orderSide() {
