	...
	[6265],
	{
		...
		81346: (e, t, l) => {
			...
			class ve extends n.PureComponent {
				...
				render() {
					const {
						...
						isRGB: l,
						isFundamental: r,
						property: { color: o, plottype: i, linewidth: s, transparency: a, trackPrice: c, display: d },
					} = this.props;
					return n.createElement(
						N.InputRow,
			...
			const Re = {
					...
					[Le.MarkLocation.Top]: { value: Le.MarkLocation.Top, content: o.t(null, void 0, l(97118)), order: 2 },
					[Le.MarkLocation.Bottom]: { value: Le.MarkLocation.Bottom, content: o.t(null, void 0, l(27567)), order: 3 },
			...
			class Ae extends n.PureComponent {
				...
				render() {
					...
					return n.createElement(
						...
						!s && !o && n.createElement(_e.BasicColorSelect, { disabled: 0 === u.value(), color: a, transparency: c }),
			...
			class et extends n.PureComponent {
				render() {
					const { id: e, shapeStyleId: t, className: l, shapeStyleChange: r, disabled: o } = this.props;
					return n.createElement(M.IconDropdown, {
						id: e,
						disabled: o,
						className: l,
			...
			class nt extends n.PureComponent {
				...
				render() {
					...
					return n.createElement(
						...
						!r && !l && n.createElement(_e.BasicColorSelect, { disabled: 0 === d.value(), color: i, transparency: s }),
						n.createElement(et, {
							id: (0, x.createDomId)(e, 'shape-style-select'),
							disabled: 0 === d.value(),
							className: te.smallStyleControl,
				...
				render() {
					...
					if ('arrows' === c) {
						...
						return i || s
							...
							: n.createElement(Pe, { id: o, property: a, isRGB: p, plot: e, palettes: t, styleProp: a });
					}
					if ('chars' === c || 'shapes' === c) {
			...
			class mt extends n.PureComponent {
				...
				render() {
					const {
						id: e,
						name: t,
						property: { color: l, linestyle: r, linewidth: o, transparency: i, value: s, visible: a },
					} = this.props;
					return n.createElement(
						N.InputRow,
					...
					return n.createElement(
						...
						n.createElement(
							...
							n.createElement(
								oe.PropertyTable.Cell,
								{ placement: 'first', colSpan: 2 },
								n.createElement(V, { id: 'chart-orders-switch', title: o.t(null, void 0, l(6532)), visible: e })
							)
						),
						n.createElement(
							oe.PropertyTable.Row,
							...
							n.createElement(
								oe.PropertyTable.Cell,
								{ placement: 'first', colSpan: 2 },
								n.createElement(V, { id: 'chart-orders-labels-switch', title: o.t(null, void 0, l(38712)), visible: t })
							)
						),
						n.createElement(
							oe.PropertyTable.Row,
							...
							n.createElement(
								oe.PropertyTable.Cell,
								{ placement: 'first', colSpan: 2 },
								n.createElement(V, { id: 'chart-orders-qty-switch', title: o.t(null, void 0, l(98721)), visible: r })
							)
						)
					);
				}
			...
			class xt extends n.PureComponent {
				...
				render() {
					const { hHistInfo: e, property: t } = this.props,
						{ percentWidth: l, direction: r, showValues: o, valuesColor: i, visible: s } = t.childs(),
						{ title: a } = e;
					return n.createElement(
						n.Fragment,
						null,
						...
						n.createElement(
							N.InputRow,
							{ label: n.createElement('div', { className: te.childRowContainer }, Pt), grouped: !0 },
						...
						n.createElement(
							N.InputRow,
							{ label: n.createElement('div', { className: te.childRowContainer }, St), grouped: !0 },
						...
						n.createElement(
							N.InputRow,
							{ label: n.createElement('div', { className: te.childRowContainer }, Tt), grouped: !0 },
				...
				_renderColors() {
					...
					return l
						...
						.map((e) =>
							n.createElement(
								N.InputRow,
								{ key: e, grouped: !0, label: n.createElement('div', { className: te.childRowContainer }, i[+e]) },
								n.createElement(_e.BasicColorSelect, { disabled: !o.value(), color: l[+e], transparency: r[+e] })
							)
						);
				}
			}
				...
				render() {
					...
					return Object.keys(s).map((t, o) => {
						...
						return 'horizlines' === e || 'vertlines' === e
							? n.createElement(kt, { key: t, title: (0, r.ensureDefined)(l.graphics[e]?.[t]).name, property: s })
							: 'lines' === e
								? n.createElement(kt, { key: t, title: (0, r.ensureDefined)(l.graphics.lines?.[t]).title, property: s })
								: 'hhists' === e
									? n.createElement(xt, {
											key: t,
						...
						n.createElement(
							...
							n.createElement(
								...
								n.createElement(
									...
									n.createElement(Nt, { id: 'pivot-points-standard-font-size-select', fontSize: e })
								)
							)
						),
						n.createElement(
			...
			const Ft = o.t(null, void 0, l(10783)),
				...
				Gt = (new i.TranslatedString('change expand blocks', o.t(null, void 0, l(85889))), o.t(null, void 0, l(81363))),
			...
			class Kt extends n.PureComponent {
				...
				render() {
					const { metaInfo: e } = this.props,
						{ graphics: t, styles: l, showLabelsOnPriceScale: o, showLegendValues: i } = this.props.property.childs(),
					...
					return n.createElement(
						...
						n.createElement(
							...
							n.createElement(
								oe.PropertyTable.Cell,
								{ placement: 'last' },
								n.createElement(_e.BasicColorSelect, { disabled: !h.value() || !m[0].value(), color: g })
							)
						),
						n.createElement(
							oe.PropertyTable.Row,
						...
						c &&
							n.createElement(
								N.InputRow,
								{ label: n.createElement('div', null, (B && (0, D.getTranslatedInputTitle)(B.name)) || '') },
								n.createElement(_e.BasicColorSelect, {
			...
			for (let e = 0; e < dl.length; e++) {
				const t = dl[e];
				pl.push({ value: t.priceScale + ',' + t.minMove + ',' + t.frac, content: t.minMove + '/' + t.priceScale });
			}
			...
			class fl extends n.PureComponent {
				...
				render() {
					...
					const l = e.properties(),
						{ precision: r, strategy: o, minTick: i, showLabelsOnPriceScale: s, showLegendValues: a } = l,
						c = t.plots.length > 0,
					...
					return n.createElement(
						...
						u && n.createElement(ul, { id: (0, x.createDomId)(t.id, 'min-tick-select'), minTick: i }),
						...
						(p || d) &&
							n.createElement(
								...
								p && n.createElement(il, { id: (0, x.createDomId)(t.id, 'precision-select'), precision: r }),
								d &&
									n.createElement(
										n.Fragment,
										null,
				...
				_bandsElement() {
					...
					return (
						...
						l &&
						t.map((e, t) => {
							if (!e.isHidden) return n.createElement(mt, { key: t, id: e.name, name: e.name, property: l[t] });
						})
					);
				}
				...
				_graphicsElement() {
					...
					return t && Object.keys(t).map((t, l) => n.createElement(Lt, { key: t, graphicType: t, study: e }));
				}
				_findPalettesByTargetId(e) {
					...
					for (const l of n) {
						if (((0, k.isPaletteColorerPlot)(l) || (0, k.isOhlcColorerPlot)(l)) && l.target === e) {
							if (i.main) {
								i.secondary = { palette: o[l.palette], paletteProps: t.properties().palettes[l.palette] };
								continue;
							}
						...
						(0, k.isUpColorerPlot)(l) &&
							...
							(0, k.isDownColorerPlot)(l) &&
								l.target === e &&
								(i.down = { palette: o[l.palette], paletteProps: t.properties().palettes[l.palette] }),
							(0, k.isCandleWickColorerPlot)(l) &&
								l.target === e &&
								(i.wick = { palette: o[l.palette], paletteProps: t.properties().palettes[l.palette] }),
							(0, k.isCandleBorderColorerPlot)(l) &&
								l.target === e &&
								(i.border = { palette: o[l.palette], paletteProps: t.properties().palettes[l.palette] });
					}
					return i;
				}
			}
			...
			class kl extends Sl.DialogRenderer {
				...
				show(e = {}) {
					...
					i.hasUserEditableInputs() && r.push({ id: 'inputs', label: o.t(null, void 0, l(21429)), Component: T }),
						i.hasUserEditableProperties(),
						i.hasUserEditableStyles() && r.push({ id: 'style', label: o.t(null, void 0, l(92516)), Component: Cl }),
						this._propertyPages ||
							r.push({
								id: 'visibilities',
				...
				_createVisibilitiesPropertyPage() {
					...
					return (0, Pl.createPropertyPage)(
						(0, El.getIntervalsVisibilitiesPropertiesDefinitions)(
							this._model,
							e,
							new i.TranslatedString(this._source.name(!0), this._source.title(Tl.TitleDisplayTarget.StatusLine, !0))
						),
						'visibility',
		...
		78890: (e, t, l) => {
			...
			class m extends n.PureComponent {
				...
				_getPlaceHolderItem(e) {
					return e ? n.createElement(i.Icon, { className: p.defaultsButtonIcon, icon: d }) : u.defaults;
				}
			}
		},
		48531: (e, t, l) => {
			...
			function g(e) {
				...
				return n.createElement(
					...
					n.createElement(u.PopupMenuItem, {
						...
						label: t,
						onClick: s,
						toolbox: l && n.createElement(h.RemoveButton, { hidden: !v.mobiletouch && !o, onClick: c, icon: y }),
					})
				);
			}
			function b(e) {
		...
		86720: (e, t, l) => {
			...
			const b = (0, r.forwardRef)((e, t) => {
				...
				return r.createElement(
					...
					u && 'string' == typeof h
						? r.createElement('span', { className: i()(y['ellipsis-children'], 'apply-overflow-tooltip') }, h)
						: h
				);
			});
			b.displayName = 'UnderlineTabsBaseButton';
			const f = (0, r.forwardRef)((e, t) => {
				const { item: l, highlighted: n, handleItemRef: o, onClick: i, 'aria-disabled': s, ...a } = e,
					c = (0, r.useCallback)(() => {
						i && i(l);
					}, [i, l]),
					d = (0, r.useCallback)(
			...
			function L(e) {
				...
				return r.createElement(S.Icon, { icon: I(t), className: o(_['arrow-icon'], _[`size-${t}`], l && _.dropped) });
			}
			var R = l(33636);
			const D = 4,
				B = 4;
			...
			function q(e) {
				...
				return r.createElement(
					...
					r.createElement('div', { className: j().corner, style: { transform: `scaleX(${1 / i})` } }),
					r.createElement('div', { className: j().center, style: { transform: `scaleX(${1 - 30 / e.scale})` } }),
					r.createElement('div', { className: j().corner, style: { transform: `scaleX(${1 / i})` } })
				);
			}
			function J(e) {
				const {
					...
					{ isOpened: ae, open: ce, close: de, onButtonClick: pe } = (0, p.useDisclosure)({ id: t, disabled: y }),
				...
				const ke = (function (e, t, l = []) {
					...
					return (
						...
						(0, r.useEffect)(() => {
							if (void 0 === t) return;
							const l = e.get(t);
							return void 0 !== l ? (a(l), i.current?.observe(l), () => i.current?.disconnect()) : void 0;
						}, l),
						n
					);
				...
				return r.createElement(
					...
					r.createElement(
						'div',
						{ ...ve, className: F({ size: b, overflowBehaviour: z, className: P }), style: S, 'data-name': _ },
						r.createElement(
							'div',
							{
								...me,
							...
							oe.map((e) => r.createElement(f, { ...Pe(e), ref: ne(j(e)), key: e.id, item: e, fake: !0 })),
							'collapse' === z &&
								r.createElement(V, {
									size: b,
									disabled: y,
			...
			function m(e) {
				...
				return r.createElement(
					...
					r.createElement('input', {
						...T,
						type: 'checkbox',
						className: o(h().input, d && h().activeStylesEnabled, i && h().checked, u && h().disabled),
						role: w,
						'aria-checked': i,
						checked: i,
						onKeyDown: (e) => {
				...
				return r.createElement(
					'label',
					{
						...
						onKeyDown: function (e) {
							...
							(13 !== t && 32 !== t) || (e.preventDefault(), E.current instanceof HTMLElement && E.current.click());
						},
						tabIndex: T,
						'data-role': 'menuitem',
			...
			function ce(e, t) {
				...
				if ((0, a.isTicksEnabled)()) {
					const n = (0, o.createCheckablePropertyDefinition)(
						{ checked: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.ticks), z, t) },
						{ id: 'IntervalsVisibilitiesTicks', title: L }
					);
					l.push(n);
				}
					...
					const n = (0, o.createRangePropertyDefinition)(
						{
							...
							to: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.secondsTo), H, t),
						},
						{
							id: 'IntervalsVisibilitiesSecond',
							title: R,
				...
				const n = (0, o.createRangePropertyDefinition)(
						{
							checked: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.minutes), F, t),
				...
				const u = (0, o.createRangePropertyDefinition)(
						{
							checked: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.weeks), K, t),
							from: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.weeksFrom), $, t),
							to: new d.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.weeksTo), Z, t),
						},
						{
							id: 'IntervalsVisibilitiesWeeks',
							title: N,
		...
		46112: (e, t, l) => {
			...
			var n = l(50151),
				...
				o = l(45126),
				i = l(12988);
			const s = new o.TranslatedString('change {propertyName} property', r.t(null, void 0, l(25167)));
			class a extends i.Property {
				...
				unsubscribe(e, t) {
					const l = (0, n.ensureDefined)(this._listenersMappers.find((l) => l.obj === e && l.method === t)?.callback);
