			...
			class v extends a.DefaultProperty {
				constructor(e) {
					const { levelsIterator: t = f, map: s = {}, ...r } = e,
						n = { ...o, ...s };
					r.state && (r.state = d(r.state, n, t)), super(r), (this._map = n), (this._levelsIterator = t);
				}
				state(e, t, s) {
				...
				preferences() {
					return (0, a.extractState)(this.state(this._excludedDefaultsKeys, void 0, !0), this._allDefaultsKeys);
				}
				applyTemplate(e, t) {
					this.mergeAndFire(
						(0, a.extractState)(
		...
		85259: (e, t, s) => {
			...
			class h extends u.LineDataSource {
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([s.e(6406), s.e(3889), s.e(8009), s.e(8056), s.e(8537)]).then(s.bind(s, 72443)))
				...
				static _configureProperties(e) {
					...
					for (let r = 1; r <= 9; r++) {
						...
						t.push((0, n.ensureDefined)(i.child('linewidth'))), s.push((0, n.ensureDefined)(i.child('color')));
					}
