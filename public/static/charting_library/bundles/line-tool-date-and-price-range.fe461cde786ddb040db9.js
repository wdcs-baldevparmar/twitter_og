	...
	[1455],
	{
		...
		70791: (e, t, i) => {
			...
			const m = (0, a.getHexColorByName)('color-tv-blue-500'),
				...
				y = new Map([
					[l.StdTheme.Light, { ...d.themedFactoryDefaultsBase.get(l.StdTheme.Light), borderColor: m }],
					[l.StdTheme.Dark, { ...d.themedFactoryDefaultsBase.get(l.StdTheme.Dark), borderColor: m }],
				]),
				...
				g = [...new Set([...f, ...b, ...c.commonLineToolPropertiesStateKeys, ...d.allPropertiesStateKeysBase])];
			...
			class T extends r.LineDataSource {
				...
				setOwnerSource(e) {
					e === this._model.mainSeries() &&
						...
						(this._volumeCalculator = new o.SeriesTimeRangeVolumeCalculator(this._model.mainSeries()))),
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([i.e(6406), i.e(3889), i.e(8009), i.e(8056), i.e(8537)]).then(i.bind(i, 14336)))
		...
		38039: (e, t, i) => {
			...
			class l extends a.DefaultProperty {
				...
				applyTemplate(e) {
					this.mergeAndFire(
						(0, a.extractState)((0, r.default)((0, s.default)(this._factoryDefaultsSupplier()), e), this._templateKeys)
					);
				}
			}
		},
