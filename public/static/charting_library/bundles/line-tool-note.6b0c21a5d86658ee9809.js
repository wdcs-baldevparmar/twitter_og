(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[3248],
	{
		73174: (e, t, o) => {
			...
			function b(e, t, o) {
				return { property: (0, d.convertToDefinitionProperty)(e, t.price, f), info: { typeY: 1, stepY: o } };
			}
			function x(e, t) {
				return {
					property: (0, d.convertToDefinitionProperty)(e, t.bar, m),
					info: { typeX: 0, minX: new c.WatchedValue(p), maxX: new c.WatchedValue(g), stepX: new c.WatchedValue(1) },
				};
			}
		...
		91335: (e, t, o) => {
			...
			var i = o(11542),
				...
				n = o(32097),
				a = o(91682);
			const l = new r.TranslatedString('change {toolName} text visibility', i.t(null, void 0, o(56634))),
				...
				h = new r.TranslatedString('change {toolName} text font italic', i.t(null, void 0, o(42694))),
				u = new r.TranslatedString('change {toolName} text', i.t(null, void 0, o(66668))),
				p = new r.TranslatedString('change {toolName} labels alignment vertical', i.t(null, void 0, o(31689))),
				g = new r.TranslatedString('change {toolName} labels alignment horizontal', i.t(null, void 0, o(88277))),
				f = new r.TranslatedString('change {toolName} labels direction', i.t(null, void 0, o(61160))),
				m = new r.TranslatedString('change {toolName} text background visibility', i.t(null, void 0, o(31133))),
				T = new r.TranslatedString('change {toolName} text background color', i.t(null, void 0, o(22231))),
				b = new r.TranslatedString('change {toolName} text border visibility', i.t(null, void 0, o(58704))),
				x = new r.TranslatedString('change {toolName} text border width', i.t(null, void 0, o(35423))),
				v = new r.TranslatedString('change {toolName} text border color', i.t(null, void 0, o(36666))),
			...
			function P(e, t, o, i) {
				...
				if (
					(void 0 !== t.showText &&
						(r.checked = (0, n.convertToDefinitionProperty)(e, t.showText, l.format({ toolName: o }))),
					void 0 !== t.textColor &&
					...
					void 0 !== t.bold && (r.bold = (0, n.convertToDefinitionProperty)(e, t.bold, c.format({ toolName: o }))),
					void 0 !== t.italic &&
					...
					void 0 !== t.textOrientation &&
						(r.orientation = (0, n.convertToDefinitionProperty)(e, t.textOrientation, f.format({ toolName: o }))),
					...
					void 0 !== t.backgroundTransparency && (i = t.backgroundTransparency),
						(r.backgroundColor = (0, n.getColorDefinitionProperty)(e, t.backgroundColor, i, T.format({ toolName: o })));
				}
				return (
					...
					void 0 !== t.borderVisible &&
						(r.borderVisible = (0, n.convertToDefinitionProperty)(e, t.borderVisible, b.format({ toolName: o }))),
					void 0 !== t.borderWidth &&
						(r.borderWidth = (0, n.convertToDefinitionProperty)(e, t.borderWidth, x.format({ toolName: o }))),
					void 0 !== t.borderColor &&
						(r.borderColor = (0, n.getColorDefinitionProperty)(e, t.borderColor, null, v.format({ toolName: o }))),
		...
		38039: (e, t, o) => {
			...
			class l extends a.DefaultProperty {
				...
				applyTemplate(e) {
					this.mergeAndFire(
						(0, a.extractState)((0, r.default)((0, i.default)(this._factoryDefaultsSupplier()), e), this._templateKeys)
					);
				}
			}
		},
		40258: (e, t, o) => {
			...
			var i = o(94784),
				...
				s = o(32097),
				d = o(91682);
			const c = new n.TranslatedString('change {title} background color', r.t(null, void 0, o(49765))),
			...
			var p,
				...
				A = o(64099);
			function B(e) {
				const { ctx: t, renderingInfo: o, left: i, top: r, width: n, height: a, point: l, caretPos: s, mode: d } = e,
			...
			class H {
				constructor(e) {
					(this._data = null),
						(this._tooltipHitTest = new y.HitTestResult(y.HitTarget.MovePoint, { ...e, areaName: y.AreaName.Text }));
				}
				setData(e) {
					this._data = e;
				}
				...
				hitTest(e, t) {
					if (null !== this._data) {
						const { point: t, left: o, top: i, width: r, height: n, tooltipVisible: a } = this._data,
							l = t.x,
							s = t.y,
							d = z.viewBox(),
							c = (0, D.box)((0, D.point)(l - d.width / 2, s - d.height), (0, D.point)(l + d.width / 2, s));
				...
				_drawTooltipOn(e, t) {
					...
					if (l) {
						...
						d &&
							...
							(e.shadowOffsetY = 2),
							(o = !0)),
							B({ ctx: e, renderingInfo: t, left: u, top: p, width: c, height: g, point: i, caretPos: T, mode: 1 }),
							e.fill(),
							o && e.restore();
					}
					s &&
						...
						(e.strokeStyle = s),
						B({ ctx: e, renderingInfo: t, left: u, top: p, width: c, height: g, point: i, caretPos: T, mode: 0 }),
						e.stroke()),
			...
			class F extends _.InplaceTextLineSourcePaneView {
				constructor(e, t, o, i, r) {
					super(e, t, o, i, r),
						...
						(this._noteRenderer = new H((0, _.inplaceEditHandlers)(this._tryActivateEditMode.bind(this, null)))),
				...
				_updateImpl(e) {
					...
					n.drawBackground.value() &&
						((l = (0, T.generateColor)(n.backgroundColor.value(), n.backgroundTransparency.value())),
			...
			const q = {
				...
				oe = [...new Set([...ee, ...te, ...Z.commonLineToolPropertiesStateKeys, 'text', 'anchored'])],
			...
			class ae extends X.InplaceTextLineDataSource {
				...
				static createProperties(e, t) {
					null != t && void 0 !== t.markerColor && void 0 === t.borderColor && (t.borderColor = t.markerColor);
