		...
		15294: (e, t, r) => {
			...
			class c extends n.PureComponent {
				render() {
					...
					return (
						this.props.label &&
							(c = n.createElement('span', { className: i, title: this.props.title }, this.props.label)),
						n.createElement('label', { className: s }, n.createElement(a.CheckboxInput, { ...r, className: e }), c)
					);
				}
			}
						...
						w(a)
							...
							: null != a &&
								(E(a) &&
									...
									})(a, o + (!a.key || (u && u.key === a.key) ? '' : ('' + a.key).replace(N, '$&/') + '/') + e)),
								t.push(a)),
						1
					);
				if (((u = 0), (s = '' === s ? '.' : s + ':'), w(e)))
					...
					for (e = l.call(e), c = 0; !(i = e.next()).done; ) u += I((i = i.value), t, o, (l = s + j(i, c++)), a);
				else if ('object' === i)
					throw (
						((t = String(e)),
						Error(
