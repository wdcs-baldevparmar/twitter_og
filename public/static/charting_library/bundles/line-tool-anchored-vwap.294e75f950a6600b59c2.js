	...
	[5500],
	{
		13099: (e, t, s) => {
			...
			class h extends d.StudyPriceAxisView {
				...
				_visible() {
					const e = this._source.properties().childs().styles.childs()[this._data.plotIndex].childs().display.value();
			...
			class I extends A.StudyLineDataSource {
				...
				isPlotVisibleAt(e, t) {
					return (this._studyProps().childs().styles.childs()[e].childs().display.value() & t) === t;
				}
				_studyProps() {
			...
			function R(e) {
				void 0 !== e && void 0 !== e.visible && ((e.display = e.visible ? 15 : 0), delete e.visible);
			}
			class L extends I {
				constructor(e, t, s, r, n) {
					s = s || (0, i.ensureNotNull)((0, V.studyMetaInfoRepository)().findByIdSync({ type: 'java', studyId: g }));
					...
					o &&
						u &&
						(A.push(new c.StudyPlotPaneView(this, w, e, o.id)), A.push(new c.StudyPlotPaneView(this, w, e, u.id))),
						d &&
							_ &&
							y &&
							f &&
						...
						this._properties.childs().areaBackground && A.splice(0, 0, new P.AreaBackgroundPaneView(this, e)),
						(this._priceAxisViews = this.metaInfo().plots.map((e) => new h(this, { plotIndex: e.id }))),
				...
				destroy() {
					this.properties().onRestoreFactoryDefaults().unsubscribeAll(this),
						this.model().properties().childs().scalesProperties.childs().showStudyLastValue.unsubscribeAll(this),
						(this._onInputsReadyCallbacks = []),
						super.destroy();
				}
				cloneable() {
				...
				priceRange(e, t, s) {
					if (!this._isReady() || this.isSourceHidden() || s.targetPriceScale !== this.priceScale()) return null;
					const r = this.plots().minMaxOnRangeCached(e, t, [{ name: this.metaInfo().plots[0].id, offset: 0 }]);
				...
				inputsForAlertState() {
					return (
						null === this._inputs && v.logWarn('Could not get inputsForAlertState if VWAP has no inputs'),
						{ ...this.inputs() }
					);
				}
				inputs() {
				...
				static createProperties(e, t) {
					const s = r.StudyMetaInfo.getStudyPropertyRootNameById(g),
						a = (0, i.ensureNotNull)((0, V.studyMetaInfoRepository)().findByIdSync({ type: 'java', studyId: g })),
						l = (0, y.createDefaultsState)(!0, s, [], (0, V.studyMetaInfoRepository)().studyVersioning());
				...
				_onInputsChanged() {
					if ((super._onInputsChanged(), this._updateAlertCreationAvailable(), null !== this._inputs)) {
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([s.e(6406), s.e(3889), s.e(8009), s.e(8056), s.e(8537)]).then(s.bind(s, 27873)))
				...
				_updateAnchorsPrice(e) {
					...
					const n = r[1];
					null != n &&
						((this._points[0].price = n), (this._timePoint[0].price = n), (this._anchorPriceCalculated = !0));
				}
				_synchronizeAlert(e) {
