		...
		8308: (e, t, s) => {
			...
			class c extends n.LineDataSource {
				...
				axisPoints() {
					...
					return e.length < 2 || t.length < 2 ? [] : [e[0], (0, i.ensureNotNull)(this.screenPointToPoint(t[1]))];
				}
				getScreenPoints() {
					const e = this.points();
				...
				levels() {
					...
					for (let r = 0; r < s; r++) {
						...
						e.push({ index: r, visible: s.visible.value(), color: s.color.value(), width: s.width.value() });
					}
					return e;
				}
				fanLinesCount() {
