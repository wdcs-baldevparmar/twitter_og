	...
	[7129, 5565],
	{
		...
		40076: (e, t, i) => {
			...
			const h = function e(t, i, o, n, r) {
				...
				for (o || (o = d), r || (r = []); ++a < l; ) {
					var h = t[a];
					i > 0 && o(h) ? (i > 1 ? e(h, i - 1, o, n, r) : (0, s.default)(r, h)) : n || (r[r.length] = h);
				}
				return r;
			};
			const u = function (e) {
			...
			class m {
				...
				resolveLinkKey(e, t, i) {
					...
					return s.set(t, n), this._pendingRequests.set(o, s), this._startRequestingDebounced(), n.promise;
				}
			...
			class w extends I.StudyStub {
				constructor(e, t, i) {
					super(e, { ...t, ownFirstValue: null }, i), (this._linkKey = new b.WatchedValue(t.linkKey ?? null));
				}
				linkKey() {
			...
			class V {
				...
				resetInvalidated(e, t, i, o) {
					...
					(this._invalidatedLineToolsAndStudyStubs = d.stillInvalidated),
						d.validated.forEach(
							s.bind(this, this._originalLineToolSharingMode, this._setOriginalLineToolSharingMode.bind(this), r)
						);
				...
				_restoreLineTool(e, t, i, o) {
					...
					if (
						(null === s && t.state.linkKey && (s = this._chartModel.lineToolByLinkKey(t.state.linkKey)),
					...
					if (!this._invalidatedLineToolsAndStudyStubs.get(t))
						if (null === e) {
							...
							if (r) {
								...
								void 0 === this._originalLineToolSharingMode.get(t) && this._setOriginalLineToolSharingMode(t, s),
