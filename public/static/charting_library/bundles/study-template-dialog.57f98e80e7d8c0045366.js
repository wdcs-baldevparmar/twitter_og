	...
	[6631],
	{
			...
			class c extends s.PureComponent {
				render() {
					...
					return (
						...
						s.createElement('label', { className: a }, s.createElement(o.CheckboxInput, { ...n, className: e }), c)
					);
				}
			}
		...
		59416: (e, t, n) => {
			...
			class o extends s.PureComponent {
				...
				render() {
					return s.createElement(a.Provider, { value: this.state.switchGroupContext }, this.props.children);
				}
							...
							i.createElement(
								...
								i.createElement(
									...
									p &&
										i.createElement(
											l.Button,
											{ className: _, name: 'cancel', appearance: 'stroke', onClick: this._handleCancel },
									...
									b &&
										i.createElement(
											...
											i.createElement(
												l.Button,
												{ className: v, disabled: u, name: 'submit', onClick: h, 'data-name': 'submit-button' },
		...
		3606: (e, t, n) => {
			...
			class C extends a.PureComponent {
				...
				_renderDialogBody() {
					return () => a.createElement(b.SlotContext.Consumer, null, (e) => ((this._manager = e), this.props.children));
				}
			}
			var f = n(30575),
				S = n(85508),
			...
			function K(e, t, n) {
				const s = (e) => {
					A.backend.invalidateStudyTemplatesList(), A.backend.getStudyTemplatesList().then((n) => t(n, W(e)));
				};
