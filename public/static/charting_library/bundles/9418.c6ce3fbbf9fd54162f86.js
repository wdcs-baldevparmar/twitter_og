(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[9418],
	{
		...
		57340: (e, t, i) => {
			...
			const h = s.forwardRef((e, t) => s.createElement(n.NavButton, { ...e, ref: t, icon: d(e.size) }));
		},
		64388: (e, t, i) => {
			'use strict';
			i.d(t, { NavButton: () => c });
			var s = i(50959),
				...
				r = (i(49406), i(21019));
			function a(e) {
				const { size: t = 'large', preservePaddings: i, isLink: s, flipIconOnRtl: o, className: a } = e;
				return n(r['nav-button'], r[`size-${t}`], i && r['preserve-paddings'], o && r['flip-icon'], s && r.link, a);
			}
			function l(e) {
			...
			(0, s.forwardRef)((e, t) => {
				...
				return s.createElement(
					c,
					{ ...r, className: a({ ...e, children: o, isLink: !0 }), reference: (0, h.isomorphicRef)(t) },
						...
						s.createElement(p.MatchMedia, { rule: u.DialogBreakpoints.TabletSmall }, (u) =>
							s.createElement(
								...
								s.createElement(
									...
									s.createElement(g.PopupContext.Consumer, null, (e) => this._renderChildren(e, u || k))
								)
							)
						)
					);
		...
		82206: (e, t, i) => {
			...
			class d extends s.PureComponent {
				...
				_createStyles() {
					const { bottom: e, left: t, width: i, right: s, top: n, zIndex: o, height: r } = this.props;
			...
			class M {
				...
				dispatch(e) {
					if ('dialog-open' === e) {
						if (null !== this._openSessionId) return void F.logError('Multiple calls to open dialog');
			...
			const B = class {
				...
				recalculateBounds() {
					const { clientWidth: e, clientHeight: t } = this._getClientDimensions(),
						...
						s = this._calculateDialogPosition?.(this._dialog, { clientWidth: e, clientHeight: t }, { vertical: i });
								...
								s.createElement(
									...
									s.createElement(
										d,
										{
											...
											className: n(
												T.dialog,
												(0, k.isOnMobileAppPage)('any') && !this.props.noMobileAppShadows && T.mobile,
					...
					if (!s.contains(document.activeElement)) {
						const e = (function (e) {
							...
							const i = (0, m.getActiveElementSelectors)(),
								s = Array.from(e.querySelectorAll(i)).filter((0, m.createScopedVisibleElementFilter)(e));
			...
			(N.contextType = E.PortalContext),
				(N.defaultProps = { boundByScreen: !0, draggable: !0, centeredOnMount: !0, shouldReturnFocus: !0 });
			...
			function o(e, t) {
				return class extends s.PureComponent {
					render() {
						...
						if (!i) return null;
						const r = s.createElement(e, { ...this.props, ref: this.props.componentRef, zIndex: 150 });
