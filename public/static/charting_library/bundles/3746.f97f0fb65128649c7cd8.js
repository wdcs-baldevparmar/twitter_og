					...
					(l = function () {}),
								...
								this.options.acceptedMimeTypes &&
									...
									!1 !== this.options.previewsContainer &&
										(this.options.previewsContainer
											? (this.previewsContainer = r.getElement(this.options.previewsContainer, 'previewsContainer'))
											: (this.previewsContainer = this.element)),
									this.options.clickable &&
										(!0 === this.options.clickable
											? (this.clickableElements = [this.element])
											: (this.clickableElements = r.getElements(this.options.clickable, 'clickable'))),
									this.init();
							}
							return (
								(function (e, t) {
								...
								(r.prototype.defaultOptions = {
									...
									addedfile: function (e) {
										...
										if (
											...
											for (s = 0, a = (d = e.previewElement.querySelectorAll('[data-dz-size]')).length; s < a; s++)
										...
										if (e.previewElement) {
											for (
												e.previewElement.classList.add('dz-error'),
													...
													o = [],
													n = 0,
													r = (s = e.previewElement.querySelectorAll('[data-dz-errormessage]')).length;
												n < r;
												n++
											)
									...
									uploadprogress: function (e, t, i) {
										...
										if (e.previewElement) {
											for (
												l = [], r = 0, s = (o = e.previewElement.querySelectorAll('[data-dz-uploadprogress]')).length;
												r < s;
												r++
											)
												'PROGRESS' === (n = o[r]).nodeName ? l.push((n.value = t)) : l.push((n.style.width = t + '%'));
											return l;
										}
									},
								...
								(t = function () {
									var e, t, i, n, r, s, o;
									for (
										n = arguments[0], s = 0, o = (i = 2 <= arguments.length ? u.call(arguments, 1) : []).length;
										s < o;
										s++
									)
								...
								(r.prototype.filesize = function (e) {
									var t, i, n, r, s, o, l;
									for (i = n = null, t = o = 0, l = (s = ['TB', 'GB', 'MB', 'KB', 'b']).length; o < l; t = ++o)
								...
								(r.prototype.removeAllFiles = function (e) {
									var t, i, n, s;
									for (null == e && (e = !1), i = 0, n = (s = this.files.slice()).length; i < n; i++)
										...
										((n = document.createElement('img')).onload =
											...
											function () {
												...
												if (
													((e.width = n.width),
													(e.height = n.height),
													null == (l = r.options.resize.call(r, e)).trgWidth && (l.trgWidth = l.optWidth),
								...
								(r.prototype.processFiles = function (e) {
									var t, i, n;
									for (i = 0, n = e.length; i < n; i++)
										((t = e[i]).processing = !0), (t.status = r.UPLOADING), this.emit('processing', t);
								...
								(r.prototype.uploadFiles = function (e) {
									...
									(o = function () {
										...
										for (r = [], t = 0, n = e.length; t < n; t++)
											(i = e[t]),
												r.push(
													P._errorProcessing(e, y || P.options.dictResponseError.replace('{{statusCode}}', b.status), b)
												);
										return r;
									}),
									(F = (function (t) {
										return function (n) {
											...
											if (null != n)
												...
												for (r = !0, s = 100, l = 0, p = e.length; l < p; l++)
													(100 === (i = e[l]).upload.progress && i.upload.bytesSent === i.upload.total) || (r = !1),
														(i.upload.progress = s),
									...
									if (
										...
										for (
											...
											if (
												...
												for (L = 0, D = (N = d.options).length; L < D; L++) (g = N[L]).selected && s.append(c, g.value);
											else
								...
								(r.prototype._finished = function (e, t, i) {
									...
									for (s = 0, o = e.length; s < o; s++)
										((n = e[s]).status = r.SUCCESS), this.emit('success', n, t, i), this.emit('complete', n);
									if (
								...
								(r.prototype._errorProcessing = function (e, t, i) {
									var n, s, o;
									for (s = 0, o = e.length; s < o; s++)
										((n = e[s]).status = r.ERROR), this.emit('error', n, t, i), this.emit('complete', n);
									if (
										(this.options.uploadMultiple &&
						...
						(t.getElements = function (e, t) {
							...
							if (e instanceof Array) {
								...
								for (n = [], s = 0, l = (a = document.querySelectorAll(e)).length; s < l; s++) (i = a[s]), n.push(i);
						...
						(t.isValidFile = function (e, t) {
							var i, n, r, s, o;
							if (!t) return !0;
							for (t = t.split(','), i = (n = e.type).replace(/\/.*$/, ''), s = 0, o = t.length; s < o; s++)
						...
						(r = function (e, t) {
							...
							if (
								...
								return (
									n[i](l + 'DOMContentLoaded', s, !1), n[i](l + 'readystatechange', s, !1), e[i](l + 'load', s, !1)
								);
							}
						}),
