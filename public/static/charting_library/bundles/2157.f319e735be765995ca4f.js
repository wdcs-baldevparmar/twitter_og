	...
	[2157],
	{
		...
		10772: (e, t, n) => {
			...
			class x extends o.PureComponent {
				...
				render() {
					const e = this.context?.current ? this.context.current === this.props.action.id : this.props.isSubMenuOpened;
							...
							o.createElement(
								...
								o.createElement(
									...
									o.createElement(
										...
										!v && E
											? E.map(({ text: e, ...t }, n) => o.createElement('span', { key: n, style: t }, e))
											: (v ?? p)
									),
									this._toolbox(l),
									e &&
				...
				return s
					...
					: o.createElement(
							...
							o.createElement(
								'span',
								{ className: r()(m.label) },
								!N && C ? C.map(({ text: e, ...t }, n) => o.createElement('span', { key: n, style: t }, e)) : (N ?? y)
							),
							!!S &&
								o.createElement(a.Icon, {
									onClick: function () {
				...
				return (
					...
					o.createElement(
						...
						o.createElement(
							...
							o.createElement(
								p,
								{ className: r(v.drawer, d[`position${t}`], m), ref: E, 'data-name': e['data-name'] },
								u
							)
						)
					)
		...
		36189: (e, t, n) => {
			...
			function h(e) {
				const { className: t, isFilled: n, isActive: s, onClick: h, title: m, ...p } = e,
					...
					f = m ?? (n ? i.removeTitlesMap[i.RemoveTitleType.Remove] : i.removeTitlesMap[i.RemoveTitleType.Add]);
				return (
					(0, o.useLayoutEffect)(() => {
						const e = v.current;
						e instanceof HTMLElement && f && e.dispatchEvent(new CustomEvent('common-tooltip-update'));
					}, [f, v]),
					o.createElement(a.Icon, {
						...p,
						className: r()(d.favorite, 'apply-common-tooltip', n && d.checked, s && d.active, b && d.focused, t),
						onClick: h,
						icon: n ? c : u,
						title: f,
						ariaLabel: f,
		...
		96040: (e, t, n) => {
			...
			function d(e) {
				...
				return s.createElement(i.Icon, {
					...f,
					'data-name': v,
					className: a()(u.button, 'apply-common-tooltip', r && u.active, p && u.hidden, g && u.focused, t),
					icon: b || c,
					onClick: d,
					onMouseDown: h,
