		...
		90921: (e, t, i) => {
			...
			class l extends s.LineDataSource {
				...
				static createProperties(e, t) {
					const i = new n.DefaultProperty({ defaultName: 'linetoolflatbottom', state: t, theme: e });
				...
				_getAlertPlots() {
					...
					return (
						...
						[this._linePointsToAlertPlot(p, 'Upper', a, h), this._linePointsToAlertPlot(l, 'Lower', d, h)].filter(
							r.notNull
						)
					);
				}
