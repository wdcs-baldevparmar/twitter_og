	...
	[4862, 2544],
	{
		...
		67029: (e, t, n) => {
			...
			function v(e, t) {
				const {
					...
					{ isGrouped: x, cellState: N, disablePositionAdjustment: k = !1 } = (0, o.useContext)(l.ControlGroupContext),
				...
				return o.createElement(h.ControlSkeleton, {
					...
					middleSlot: o.createElement(
						...
						o.createElement('input', {
							...q,
							className: r(f().input, f()[`size-${A}`], F, j && f()['with-start-slot'], V && f()['with-end-slot']),
							disabled: z,
							readOnly: W,
							ref: G,
						})
		...
		48027: (e, t, n) => {
			...
			function i(e) {
				...
				return { ...e, intent: i || (l ? 'primary' : 'default'), highlight: s ?? l, onFocus: u, onBlur: d };
			}
		},
		125: (e, t, n) => {
			'use strict';
		...
		36383: (e, t, n) => {
			...
			function s(e) {
				const { click: t, mouseDown: n, touchEnd: s, touchStart: a, handler: l, reference: c } = e,
					u = (0, o.useRef)(null),
					d = (0, o.useRef)('undefined' == typeof window ? 0 : new window.CustomEvent('timestamp').timeStamp);
				return (
		...
		47930: (e, t, n) => {
			'use strict';
			n.d(t, { formatTime: () => h, isValidTimeOptionsDateStyle: () => d, isValidTimeOptionsRange: () => u });
			...
			function h(e, t, n = 'year', c = 'day', u) {
				const d = (function (e = 'year', t = 'day', n = {}) {
						...
						const c = { ...('numeric' === n.dateStyle ? i : r), ...s },
							...
							d = {
								...o,
								fractionalSecondDigits: void 0 === u ? void 0 : Math.floor(Math.min(Math.max(1, u), 3)),
								timeZone: n.timeZone,
			...
			function h(e) {
				...
				return o.createElement(
					c,
					{
						...
						role: 'row',
						id: I?.(E),
						className: i()(d.itemRow, g && d.active, _ && d.mobile, b && T && null === S && d.focused, w),
						tabIndex: C,
					...
					o.createElement(
						...
						o.createElement(
							'div',
							{ className: i()(d.title, g && d.active, _ && d.mobile), 'data-name': 'list-item-title' },
							t
						),
					...
					o.createElement(l.RemoveButton, {
						id: I?.(E, x.remove),
						role: 'cell',
						className: i()(d.removeButton, d.actionButton, b && S === x.remove && d.focused, b && T && d.showOnFocus),
						isActive: g,
		...
		3085: (e, t, n) => {
			...
			function p(e) {
				...
				(0, o.useEffect)(() => {
					...
					return (
						y ? (f && f(), e && (e.addEventListener('mousemove', F), e.addEventListener('mouseup', z))) : g && g(),
						() => {
				...
				return o.createElement(
					...
					o.createElement(
						'div',
						{
							...
							onMouseDown: function (e) {
								e.preventDefault(), (w.current = W(e.nativeEvent, (0, a.ensureNotNull)(_.current))), S(!0);
							},
						},
			...
			function v(e) {
				...
				return o.createElement(
					'div',
					{ ...y, ref: t, className: r(n, f.scrollWrap), style: { visibility: b || _ || S ? 'visible' : 'hidden' } },
					C &&
						o.createElement(p, {
							size: i - T,
							scrollSize: l - T,
				...
				return (
					(0, o.useLayoutEffect)(() => {
						...
						return (
							...
							() => {
								e.removeEventListener('active-descendant-focus', t), e.removeEventListener('active-descendant-blur', t);
							}
						);
					}, t),
					[s, n]
		...
		11386: (e, t, n) => {
			...
			const I = new c.TranslatedString('remove all line tools for {symbol}', l.t(null, void 0, n(58407))),
				M = (e) =>
					l.t(null, { plural: '{drawingsCount} drawings', count: e }, n(90755)).format({ drawingsCount: e.toString() }),
		...
		34489: (e, t, n) => {
			...
			function H(e) {
				...
				return o.createElement(
					...
					!t && o.createElement('div', { className: m(z.title, z.withoutIcon) }, p.t(null, void 0, n(88616)), h),
					o.createElement(
						'div',
						{ className: z.buttons },
			...
			const Oe = (e) => e.nodes,
				...
				Ge = (0, Le.createSelector)([(e) => e.disabled, Ae, We], (e, t, n) => !t.ids.includes(n) && e.includes(n)),
			...
			function* nt(e) {
				...
				!Ze(yield (0, E.select)()) && t.length > 0 && (yield (0, E.put)(De(t[0])), yield (0, E.put)(xe(t[0])));
			}
			function* ot(e) {
				for (;;) {
			...
			function* at(e = () => !0, t) {
				...
				u.map((e) => e.id).includes(d.id)
					...
					: h &&
						e(u, d, o) &&
						(yield (0, E.put)(((e, t, n) => ({ type: ae, node: e, dropType: t, boundBox: n }))(d, o, i)));
			}
			function* lt(e) {
			...
			function dt(e, t, n, o) {
				...
				-1 === o && 'previous' === t && (o = r);
				let s = 0;
				for (; !i || (Math.abs(s) < r && (a = i).level > 1 && !Ve(e, (0, M.ensureDefined)(a.parentId))); )
			...
			function* ht(e = {}) {
				const {
					...
					c = [(0, E.fork)(lt, o), (0, E.fork)(ct, n), (0, E.fork)(st, i, l), (0, E.fork)(it, i, s), (0, E.fork)(rt)];
				for (t && c.push((0, E.fork)(t)), r && c.push((0, E.fork)(ut, r)), l && c.push((0, E.fork)(ot, l)); ; ) {
						...
						case Y: {
							...
							for (const e of n) {
								...
								if (r.hasOwnProperty(t)) {
									!(0, mt.deepEquals)(r[t].children, e.children)[0] && (r[t] = { ...r[t], children: [...e.children] });
								} else {
									r[t] = e;
									const { parentId: n } = e;
			...
			const Ot = (e) => {
					...
					return (
						(wt.CheckMobile.any() || wt.CheckMobile.isIPad()) && ((C = n), (E = { onMouseOut: Bt, onMouseOver: Bt })),
						o.createElement(
							'div',
							{
								className: m(Rt.wrap, n && Rt.selected, v && Rt.childOfSelected, a && Rt.disabled, i && Rt.expandable),
								onClick:
									1 === _ && 0 === y
										? T
										: function (e) {
			...
			const fn = o.forwardRef(function (e, t) {
				...
				(0, o.useEffect)(() => {
					...
					(0, o.useEffect)(() => {
						const e = (e) => {
							...
							t = (e) => {
								a && ![I.Modifiers.Mod, I.Modifiers.Shift].includes((0, I.modifiersFromEvent)(e)) && i();
							};
						return (
				...
				const Q = (0, o.useCallback)((e) => {
						...
						return (
							...
							'isSticky' in r &&
								r.isSticky &&
								(t = { ...t, zIndex: ee.current?.scrollTop && t.top && +t.top <= ee.current?.scrollTop ? 2 : 5 }),
				...
				const oe = (0, o.useRef)(null),
					...
					ie = (0, o.useMemo)(
						() => ({ id: K, nodeRenderer: l, getContainerElement: V, onClick: p, isShowStuck: A, readOnly: h }),
						[K, l, V, A, p, h]
					),
					se = (0, o.useRef)(null),
					ae = (0, o.useRef)({
						startScroll(e) {
							const t = () => {
								null !== ee.current && ((se.current = requestAnimationFrame(t)), ee.current.scrollBy({ top: e }));
							};
							this.stopScroll(), t();
						},
						stopScroll() {
							...
							o.createElement(
								'div',
								{
									...
									onKeyDown: function (e) {
										...
										(38 === t || (void 0 !== n && 'previous' === n[t])) && (e.preventDefault(), w());
								...
								o.createElement(Yt.OverlayScrollContainer, { ...J, className: hn.overlayScrollWrap }),
			...
			const gn = (0, V.connect)(
					...
					const t = (0, o.useRef)(null),
						[{ isOver: n }, r] = (0, yt.useDrop)({
							accept: 'node',
							drop: (n, o) => {
								('touch' === e.drag || wt.isFF) && t.current?.stopScroll(), o.getItem().dropSelection();
							},
							hover: (n, o) => {
								...
								((n, o, r) => {
									const i = Math.abs(n - r),
										s = Math.abs(n - o);
									if ((s > 40 && i > 40) || (i <= 40 && s <= 40)) return void t.current?.stopScroll();
									var a, l, c, u;
									(a = s > 20 && s <= 40),
										(c = i <= 20),
										(u = s <= 20),
				...
				return (
					...
					(0, o.useEffect)(
						() => (
							null !== g &&
								l &&
								(p && (p.current = performance.now()), g.dispatch(((e) => ({ type: Y, nodes: e }))(l))),
							() => {}
						),
						[g, l]
					),
			...
			function so(e) {
				const {
					...
					[z, W] = (0, o.useState)(!1),
					[H, j] = ((0, Hn.useWatchedValueReadonly)({ watchedValue: f.getChartLayout() }), (0, o.useState)(!1)),
					V = (0, o.useRef)(null);
				(0, o.useEffect)(() => {
					const e = {};
				...
				let J = null;
				return (
					C && C.type === On.Svg && (J = o.createElement(D.Icon, { icon: C.content || '', className: no.icon })),
					o.createElement(
						'span',
						{
							className: m(
							...
							onClick:
								1 === v
									...
									: function (e) {
											...
											if (V.current)
												e.preventDefault(), clearTimeout(V.current), (V.current = null), f.openProperties(u), j(!1);
											else {
												const e = f.selection().selected();
												V.current = setTimeout(() => {
													(V.current = null), s && !H && 1 === e.length && f.rename(u, () => _(!0)), j(!1);
												}, ro);
											}
										},
							onContextMenu: 0 === v ? X : void 0,
							'data-tooltip': P ? p.t(null, { replace: { modificationDate: P } }, n(63944)) : void 0,
						},
						!Z &&
							o.createElement(
								o.Fragment,
								...
								o.createElement(
									'span',
									{ className: m(no.title, f.isMain(u) && no.main, (!u.isVisible() || !B) && no.disabled), ...G },
									U
								),
								o.createElement(
									'span',
									...
									o.createElement(Wn, {
										icon: Y,
										className: m(no.button, !B && no.warn, (K || !N || !B) && no.visible, 'apply-common-tooltip'),
										onClick: B
											? function (e) {
													if (e.defaultPrevented) return;
			...
			const Fo = new wo.TranslatedString('show {title}', p.t(null, void 0, n(51382))),
				...
				jo = new wo.TranslatedString('change {sourceTitle} title to {newSourceTitle}', p.t(null, void 0, n(23687))),
			...
			function Uo(e) {
				return e instanceof Do.DataSource && e.showInObjectTree() ? go(e.id(), e.instanceId()) : null;
			}
			function Ko(e) {
			...
			class Yo {
						...
						(0, Eo.isLineTool)(t)
							...
							: (0, ko.isSymbolSource)(t)
								...
								: (0, To.isStudy)(t)
									...
									: (this._title = new Co.WatchedValue(t.title(Lo.TitleDisplayTarget.DataWindow)).spawn());
					const n = this._undoModel.lineBeingCreated();
					null !== n && n === t && n.isSynchronizable() && Bo.isToolCreatingNow.subscribe(this._updateSyncState);
				}
				destroy() {
				...
				isLocked() {
					return !!(0, Eo.isLineTool)(this._dataSource) && this._dataSource.properties().frozen.value();
				}
				onVisibilityChanged() {
					return this._dataSource.properties().visible.listeners();
				}
				onLockChanged() {
					return (0, Eo.isLineTool)(this._dataSource) ? this._dataSource.properties().frozen.listeners() : Zo;
				}
				getIcon() {
					const e = l,
				...
				modificationDateChanged() {
					return (0, Eo.isLineTool)(this._dataSource) ? this._dataSource.serverUpdateTimeChanged() : Zo;
				}
			...
			class $o {
				...
				childrenIds() {
					...
					return e.sort((e, t) => t.zorder() - e.zorder()), new Set(e.map((e) => go(e.id(), e.instanceId())));
				}
				hasChildren() {
					return !0;
				}
			...
			class Jo {
				...
				canBeGroupped(e) {
					...
					const t = [];
					if ((e.forEach((e) => e.addSourcesToArray(t)), t.some((e) => !(0, Eo.isLineTool)(e) || !e.boundToSymbol())))
						return !1;
					const n = this._undoModel.model(),
				...
				contextMenuActions(e, t, n) {
					...
					return (
						...
						o.contextMenuActionsForSources(r, (0, M.ensureNotNull)(this._undoModel.paneForSource(r[0])))
					);
				}
				insertBefore(e, t) {
			...
			class yr {
						...
						: r
							? (this._removeSourcesPromise?.cancel(),
								(this._removeSourcesPromise = er(
									(0, sr.confirmRemovingLockedLineTools)(sr.DeleteLockedLineToolReason.RemoveSelected)
								)),
								this._removeSourcesPromise.promise.then((e) => {
									t(e);
								}))
				...
				canNodeWithIdBeUnmerged(e) {
					...
					return null !== t && (0, tr.isPriceDataSource)(t) && this._model.isUnmergeAvailableForSource(t);
				}
				unmergeSelectionUp() {
				...
				copySelection() {
					const e = this._getSelectedEntities(),
						t = e.map((e) => (0, M.ensureNotNull)(this._model.dataSourceForId(vo(e.id()).persistentId)));
					this._chart.value().chartWidgetCollection().clipboard.uiRequestCopy(t), yn('Copy', Sn(e));
				}
				cloneSelection() {
					const e = this._getSelectedEntities(),
						t = e.map((e) => (0, M.ensureNotNull)(this._model.dataSourceForId(vo(e.id()).persistentId)));
					t.every(Eo.isLineTool) && (this._controller.cloneLineTools([...t], !1), yn('Clone', Sn(e)));
				}
				rename(e, t) {
				...
				async openContextMenu(e, t, n) {
					...
					if (r.length > 0) {
						...
						let a;
						(a = i
							? { menuName: 'ObjectTreeContextMenu', detail: { type: 'series', id: o.instanceId() } }
							: (0, Eo.isLineTool)(o)
								? { menuName: 'ObjectTreeContextMenu', detail: { type: 'shape', id: o?.id() ?? null } }
								: s
									? { menuName: 'ObjectTreeContextMenu', detail: { type: 'groupOfShapes', id: t || null } }
									: { menuName: 'ObjectTreeContextMenu', detail: { type: 'study', id: o?.id() || null } }),
				...
				getNextNodeIdAfterRemove(e) {
					...
					return 1 === i.length ? this.getNextNodeIdAfterRemove(o.parentId) : this._takeNextOrPrevElement(i, e);
				}
				isContextMenuOpened() {
				...
				_getSelectedEntities() {
					...
					return (
						t.length &&
							hr.logWarn(`Detected dangling sources in selection. They will be ignored: ${JSON.stringify(t)}`),
						e
					);
				}
				_getEntityById(e) {
			...
			class Cr extends Sr.DialogRenderer {
				constructor() {
					...
					(this._activeChartWidget = e.activeChartWidget.value()), (this._viewModel = new yr(e.activeChartWidget));
				}
				hide() {
					this._handleClose();
				}
		...
		41590: (e, t, n) => {
			...
			var h;
			function p(e) {
				const { position: t = 'Bottom', onClose: n, children: u, reference: h, className: p, theme: f = d } = e,
				...
				return (
					...
					o.createElement(
						...
						o.createElement(
							...
							v === g.currentDrawer && o.createElement('div', { className: d.backdrop, onClick: n }),
							o.createElement(
								m,
								{ className: i(f.drawer, d[`position${t}`], p), ref: b, 'data-name': e['data-name'] },
								u
							)
						)
					)
		...
		36189: (e, t, n) => {
			...
			function h(e) {
				const { className: t, isFilled: n, isActive: r, onClick: h, title: p, ...m } = e,
					...
					v = p ?? (n ? a.removeTitlesMap[a.RemoveTitleType.Remove] : a.removeTitlesMap[a.RemoveTitleType.Add]);
				return (
					(0, o.useLayoutEffect)(() => {
						const e = f.current;
						e instanceof HTMLElement && v && e.dispatchEvent(new CustomEvent('common-tooltip-update'));
					}, [v, f]),
					o.createElement(s.Icon, {
						...m,
						className: i()(d.favorite, 'apply-common-tooltip', n && d.checked, r && d.active, g && d.focused, t),
						onClick: h,
						icon: n ? c : u,
						title: v,
						ariaLabel: v,
				...
				const n = (0, o.useRef)(null),
					...
					[d, h] = (0, o.useState)({
						...
						onHorizontalChange: function (e) {
							h((t) => ({ ...t, scrollPosLeft: e })), ((0, r.ensureNotNull)(l.current).scrollLeft = e);
						},
						visible: c,
					}),
					p = (0, o.useCallback)(() => {
			...
			class b extends o.PureComponent {
				constructor(e) {
					super(e),
						...
						(this._handleMeasure = ({ callback: e, forceRecalcPosition: t } = {}) => {
							...
							const d = r.height > u;
							if (d) {
								((0, s.ensureNotNull)(this._scrollWrapRef).style.overflowY = 'scroll'), (r = o.getBoundingClientRect());
							}
							const { width: h, height: p } = r,
								m =
									'function' == typeof n
										? n({ contentWidth: h, contentHeight: p, availableWidth: l, availableHeight: i })
										: n,
				...
				render() {
					const {
						...
						{ appearingMenuHeight: I, appearingMenuWidth: M, appearingPosition: D, isMeasureValid: x } = this.state,
						N = {
			...
			function _(e) {
				...
				return o.createElement(
					'div',
					{
						...
						onMouseOver: function (e) {
							if (!(null !== t.current && e.target instanceof Node && ((o = e.target), n.current?.contains(o)))) return;
							var o;
		...
		96040: (e, t, n) => {
			...
			function d(e) {
				...
				return r.createElement(a.Icon, {
					...v,
					'data-name': f,
					className: s()(u.button, 'apply-common-tooltip', i && u.active, m && u.hidden, _ && u.focused, t),
					icon: g || c,
					onClick: d,
					onMouseDown: h,
		...
		47308: (e, t, n) => {
			...
			function _(e, t, n) {
				...
				const q = (0, b.useResizeObserver)(([e]) => {
					...
					{ isOpened: X, open: ee, close: te, onButtonClick: ne } = (0, p.useDisclosure)({ id: r, disabled: y }),
					{
						tabsBindings: oe,
						tablistBinding: re,
			...
			function B(e) {
				const { item: t, highlighted: n, handleItemRef: r, reference: i, onClick: s, 'aria-disabled': a, ...l } = e,
					c = (0, o.useCallback)(
						(e) => {
			...
			function H(e) {
				const { isHighlighted: t, size: n, variant: r, children: i, disabled: s } = e,
					a = { size: n ?? I, variant: r ?? M, isHighlighted: t, isCollapsed: !0, disabled: s ?? !1 };
			...
			function c(e, t) {
				return (n) => {
					...
					const y = b === o.Top ? -1 * g : g,
						...
						C = { x: S - (m === s.FromRightToLeft ? c : 0) + f, y: w - (_ === i.FromBottomToTop ? u : 0) + y };
		...
		56388: (e, t, n) => {
			...
			const a = o.forwardRef(function (e, t) {
				...
				return o.createElement(i.ToolWidgetButton, { id: a, 'data-name': a, ...l, ref: t, className: r(n, s.button) });
			});
		},
		16829: (e, t, n) => {
			'use strict';
		...
		6190: (e, t, n) => {
			...
			const d = (0, o.forwardRef)(function (e, t) {
				const { onKeyDown: n, orientation: d, blurOnEscKeydown: h = !0, blurOnClick: p = !0, ...m } = e,
