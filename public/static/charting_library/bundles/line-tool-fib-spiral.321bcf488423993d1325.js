	...
	[8090],
	{
		73174: (e, t, i) => {
			...
			function P(e, t) {
				return {
					...
					info: { typeX: 0, minX: new d.WatchedValue(p), maxX: new d.WatchedValue(_), stepX: new d.WatchedValue(1) },
				};
			}
		...
		22717: (e, t, i) => {
			...
			class v extends u.LineDataSourceProperty {
				constructor(e) {
					super(e),
						this.addChild('linesColors', new p.LineToolColorsProperty([(0, o.ensureDefined)(this.child('linecolor'))])),
						this.addChild('linesWidths', new p.LineToolWidthsProperty([(0, o.ensureDefined)(this.child('linewidth'))]));
				}
				static create(e, t) {
					return new this({
							...
							(0, W.createLinePropertyDefinition)(
								{
									...
									width: (0, W.convertToDefinitionProperty)(this._propertyApplier, e.linewidth, N.format({ title: n })),
									style: (0, W.convertToDefinitionProperty)(this._propertyApplier, e.linestyle, B.format({ title: n })),
								},
								{ id: `${i}Line`, title: z }
							),
		...
		27916: (e, t, i) => {
			i.d(t, { LineSourcePaneView: () => m, createLineSourcePaneViewPoint: () => _, thirdPointCursorType: () => p });
			var n = i(19625),
				r = i(50151),
				o = i(69186),
				s = i(56468),
			...
			class m {
				...
				_anchorRadius() {
					return (0, o.lastMouseOrTouchEventInfo)().isTouch ? u.TouchAnchorRadius : u.RegularAnchorRadius;
				}
				_lineAnchorColors(e) {
		...
		38039: (e, t, i) => {
			...
			class l extends s.DefaultProperty {
				...
				applyTemplate(e) {
					this.mergeAndFire(
						(0, s.extractState)((0, r.default)((0, n.default)(this._factoryDefaultsSupplier()), e), this._templateKeys)
					);
				}
			}
		},
