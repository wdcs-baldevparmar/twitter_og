	...
	[2232],
	{
		...
		64732: (t, e, i) => {
			...
			class d {
				...
				setDirection(t) {
					return (this._direction = t), this._line.updateAllViewsAndRedraw(u(this._line.id())), this;
				}
				setActive(t) {
				...
				setCancellable(t) {
					return (this._cancellable = t), this._line.updateAllViewsAndRedraw(u(this._line.id())), this;
				}
				getCancellable() {
				...
				setPrice(t) {
					if (this._line.points().length > 0) {
						...
						(e.price = t), this._line.setPoint(0, e), this._line.updateAllViewsAndRedraw(u(this._line.id()));
					}
				...
				setText(t) {
					return (this._data.bodyText = t || ''), this._line.updateAllViewsAndRedraw(u(this._line.id())), this;
				}
				setTooltip(t) {
				...
				setQuantity(t) {
					return (this._data.quantityText = t || ''), this._line.updateAllViewsAndRedraw(u(this._line.id())), this;
				}
				getExtendLeft() {
				...
				setLineLength(t, e = 'percentage') {
					...
					return (
						this._line.properties().lineLength.setValue(i), this._line.properties().lineLengthUnit.setValue(e), this
					);
				}
				getLineLengthUnit() {
				...
				callOnMoving() {
					this.isFunction(this._onMovingCallback) && this._onMovingCallback.call(this, this._onMovingData);
				}
				onContextMenu(t, e) {
					return (
						e
							? this.isFunction(e) && ((this._onContextMenuData = t), (this._onContextMenuCallback = e))
			...
			class p extends o {
				...
				addPoint(t, e) {
					return this._points.push(t), (this._lastPoint = null), this._normalizePoints(), this.createServerPoints(), !0;
				}
				name() {
					return 'Order';
				}
				...
				static createProperties(t, e) {
					var i = new s({ defaultName: 'linetoolorder', state: e, useUserPreferences: !1, theme: t });
