	...
	[5516, 9685],
	{
		...
		40894: (e, t, a) => {
			...
			function c(e) {
				const { onClick: t, isFilled: a, isActive: n, ...c } = e,
					...
					m = a ? r.removeTitlesMap[r.RemoveTitleType.Remove] : r.removeTitlesMap[r.RemoveTitleType.Add];
				return (
					(0, i.useLayoutEffect)(() => {
						const e = d.current;
			...
			function v(e) {
				...
				return n.createElement(
					...
					n.createElement('input', {
						...E,
						type: 'checkbox',
						className: s(m().input, c && m().activeStylesEnabled, o && m().checked, u && m().disabled),
						role: _,
						'aria-checked': o,
						checked: o,
						onKeyDown: (e) => {
				...
				return n.createElement(
					'label',
					{
						...
						onKeyDown: function (e) {
							...
							(13 !== t && 32 !== t) || (e.preventDefault(), k.current instanceof HTMLElement && k.current.click());
						},
						tabIndex: E,
						'data-role': 'menuitem',
		...
		95230: (e, t, a) => {
				...
				return n.createElement('div', {
					...
					onKeyDown: (0, M.createSafeMulticastEventHandler)(function (e) {
						...
						Array.from(n.querySelectorAll('[role="radio"]:not([disabled]):not([aria-disabled])')).filter(
							(0, I.createScopedVisibleElementFilter)(n)
						)).sort(x.navigationOrderComparator);
						var n;
			...
			class W extends n.PureComponent {
					...
					return n.createElement(_.MatchMedia, { rule: y.DialogBreakpoints.TabletSmall }, (e) => {
						...
						return n.createElement(
							...
							n.createElement(
								...
								{
									arrow: Boolean(b),
									content: b ? void 0 : n.createElement(p, null, n.createElement(o.Icon, { icon: c.SERIES_ICONS[s] })),
				...
				_renderPopupMenuItem(e, t, a) {
					...
					return n.createElement(A.AccessibleMenuItem, {
						...
						'aria-selected': t,
						isDisabled: O(e),
						label: n.createElement('div', { className: F.label }, (0, E.getTranslatedChartStyleName)(e) || '', !1, !1),
			...
			function Z(e) {
				...
				return n.createElement(z, { 'aria-label': t, ...a, tag: 'button', tabIndex: s, ref: i, 'data-tooltip': t });
			}
			var K = a(51768),
				q = a(76460),
				j = a(1393);
			...
			function ce(e) {
				...
				return (
					...
					Promise.all(t).then(
						(e) => (he.logNormal('Requesting favorites info finished'), e.reduce((e, t) => e.concat(t), []))
					)
				);
			}
			var de = a(32755),
			...
			function pe(e) {
				const { className: t } = e;
				return n.createElement('div', { className: m()(ve.spinnerWrap, t) }, n.createElement(me.Loader, null));
			}
			var ge = a(16829),
				be = a(76422),
				Se = a(39681),
				...
				constructor(e, t) {
					super(e, t),
						...
						(this._handleSelectIndicator = (e) => {
							(e = (0, se.ensureDefined)(e)), this._trackFavoriteAction('Favorite indicator from toolbar');
						...
						(0, f.validateRegistry)(t, { favoriteScriptsModel: s.any, chartWidgetCollection: s.any.isRequired });
														...
														? this.state.infos.map((t) =>
																n.createElement(A.AccessibleMenuItem, {
																	...
																	label: n.createElement(
																		'span',
																		{
																			className: m()(!e && Ce.label, e && Ce.smallWidthLabel, 'apply-overflow-tooltip'),
																		},
																		fe(t)
																	),
																})
						...
						n.createElement(A.AccessibleMenuItem, {
							...
							toolbox: (function () {
								const e = n.createElement(Re.MenuRemoveButton, {
									...
									t = n.createElement(N.MenuFavoriteButton, { key: 'favorite', isActive: s, isFilled: l, onClick: y });
								return [r && e, h && t];
							})(),
			...
			class Xe extends n.PureComponent {
					...
					super(e, t),
						...
						(this._handleAddInterval = (e, t) => {
							...
							if (s) {
								...
								if (e.interval.isMinuteHours()) return void i.set({ ...n, [Ee.SpecialResolutionKind.Hours]: !1 });
								const t = e.guiResolutionKind;
								if (t === Ee.ResolutionKind.Days || t === Ee.ResolutionKind.Weeks || t === Ee.ResolutionKind.Months)
				...
				render() {
					const { isShownQuicks: e, id: t } = this.props,
						{ activeInterval: a, customs: i, lastNotQuicked: s, isAddIntervalDialogOpened: o } = this.state,
						l = this._getQuicks(),
				...
				_createMenuItems(e, t, a, i) {
					const n = e.map((e, n, s) => this._renderResolutionsGroup(e, 1 === s.length, t, n + 1 + a, i));
					return (function (e) {
						let t = !1;
						return e.filter((e, a, i) => {
							let n = !0;
							return (
								e.type === C.PopupMenuSeparator && ((0 !== a && a !== i.length - 1) || (n = !1), t && (n = !1)),
					...
					super(e, t),
						(this._handleClick = () => {
							...
							const n = (function () {
								...
								return delete t.show_popup_button, (e.hash = `#${encodeURIComponent(JSON.stringify(t))}`), e.toString();
							})();
							i.withModel(null, () => {
					...
					super(e, t),
						...
						(this._handleClick = (e) => {
							...
							(0, K.trackEvent)('GUI', 'Chart Header Toolbar', 'chart properties'),
								a.showGeneralChartProperties(void 0, { shouldReturnFocus: (0, q.isKeyboardClick)(e) });
						}),
						(0, f.validateRegistry)(t, { chartWidgetCollection: s.any.isRequired }),
			...
			function mt(e) {
				...
				return n.createElement(
					...
					i
						? n.createElement(me.Loader, { className: ut.loader, size: 'small', staticPosition: !0 })
			...
			const Ct = i.enabled('widget'),
				...
				wt = (0, rt.mergeThemes)(oe.DEFAULT_POPUP_MENU_ITEM_THEME, { shortcut: bt.shortcut, withIcon: bt.withIcon }),
				ft =
			...
			class xt extends n.PureComponent {
				...
				componentDidUpdate(e, t) {
					e.isProcessing &&
						...
						!e.recentItems?.length && this.props.recentItems?.length && this._menuRef.current?.update(),
						!e.isProcessing &&
							this.props.isProcessing &&
			...
			function Gt(e) {
				const { serverSnapshot: t, clientSnapshot: i, hideShortcuts: s } = e,
					...
					C = (0, n.useCallback)(async () => {
						...
						try {
							await (0, ot.writePromiseUsingApi)(t, 'image/png'), be.emit('onClientScreenshotCopiedToClipboard');
						} catch (t) {
						...
						async (e = !1) => {
							...
							try {
								if (e) await y(a);
									...
									await (0, ot.writePromiseUsingApi)(e, 'text/plain'), be.emit('onServerScreenshotCopiedToClipboard');
								}
								return !0;
							} catch (e) {
								return y(a), !0;
					...
					f =
						...
						(0, n.useCallback)(async () => {
							...
							e.Twitter.shareSnapshotInstantly(i.symbol, i.imageUrl), S.current && (p(!1), (0, Ue.globalCloseMenu)());
						}, [t]));
				return n.createElement(
					n.Fragment,
					null,
			...
			class da extends n.PureComponent {
					...
					super(e, t),
						(this._openSymbolSearchDialog = async (e) => {
							...
							try {
								...
								let t = this._isSpread(this.state.symbol) ? this.state.symbol : this.state.shortName;
								...
								await new oa().show({
									...
									footer: Ie.mobiletouch
										? void 0
										: n.createElement(na.SymbolSearchDialogFooter, null, l.t(null, void 0, a(50021))),
								});
							} catch (e) {}
						}),
						(this._isSpread = (e) => !1),
				...
				render() {
					...
					return n.createElement(g.ToolbarButton, {
						id: e,
						className: m()(t, i.enabled('uppercase_instrument_names') && ra.uppercase, ra.smallLeftPadding),
						theme: ha,
						icon: la,
				...
				return n.createElement(
					...
					n.createElement(A.AccessibleMenuItem, {
						...
						toolbox: n.createElement(
							...
							Boolean(d) &&
								l &&
								n.createElement(N.MenuFavoriteButton, { key: 'favorite', isFilled: Boolean(o), onClick: f })
						),
					}),
					s &&
						n.createElement(oe.PopupMenuItem, {
							theme: _,
							label: n.createElement(va, { className: m()(pa.description, r && pa.descriptionTabletSmall) }, s),
							onClick: y,
							isHovered: b,
							isActive: u,
							'data-name': v,
			...
			function Na(e) {
				...
				return n.createElement(
					...
					d &&
						n.createElement(n.Fragment, null, n.createElement(C.PopupMenuSeparator, null), n.createElement(pe, null)),
					!d &&
						(c
				...
				return n.createElement(
					...
					i.length > 0 &&
						n.createElement(
							...
							null,
							n.createElement(C.PopupMenuSeparator, null),
							n.createElement(ge.ToolWidgetMenuSummary, { className: Aa.menuItemHeader }, l.t(null, void 0, a(83300))),
							i.map((e) => o(e))
						),
					i.length > 0 &&
						t.length > 0 &&
					...
					0 === i.length &&
						...
						n.createElement(
							...
							null,
							n.createElement(C.PopupMenuSeparator, null),
							n.createElement(ge.ToolWidgetMenuSummary, { className: Aa.menuItemHeader }, l.t(null, void 0, a(46838))),
							t.map((e) => o(e))
						)
				);
			}
			...
			class Ua {
				constructor(e, t) {
					...
					(this._state = new Oa.WatchedValue({ isLoading: !1, studyTemplatesList: n, recents: a })),
						...
						this._recentStudyTemplatesService?.getOnChange().subscribe(this, this._handleRecentsChange),
				...
				destroy() {
					this._studyTemplates.getOnChange().unsubscribe(this, this._handleTemplatesChange),
						this._recentStudyTemplatesService?.getOnChange().unsubscribe(this, this._handleRecentsChange);
				}
				state() {
			...
			var Wa = a(63472),
				Pa = a(66114);
			function La(e) {
				const { className: t, children: a, item: i, onApply: s, isActive: o, href: l, target: r } = e,
					h = i.name ?? ' ',
			...
			class Za extends n.PureComponent {
				constructor(e, t) {
					...
					(this._model = new Ua(i, a)), (this.state = { ...this._model.state().value(), isActive: !1 });
				}
				componentDidMount() {
