			...
			class o {
				...
				_createBar() {
					...
					const a = e * (1 + (0.5 - i) * t),
						o = r - a / 2,
						h = o + a;
					return { o: (o + Math.random() * a) / s, h: h / s, l: o / s, c: (o + Math.random() * a) / s };
				}
			}
			var h = s(44672);
			class l extends r.LineDataSource {
				constructor(e, t, i, r) {
					...
					n.childs().averageHL.subscribe(this, this._regenerate),
						...
						this.properties().onRestoreFactoryDefaults().subscribe(this, this._handleRestoringFactoryDefaults),
				...
				generateBars(e) {
					this._segments.length <= e && this._segments.push(new o(this, e)), this._segments[e].generate();
				}
				addPoint(e, t, s) {
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([s.e(6406), s.e(3889), s.e(8009), s.e(8056), s.e(8537)]).then(s.bind(s, 9786)))
