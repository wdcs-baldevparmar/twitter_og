	...
	[8890],
	{
		...
		64388: (e, t, n) => {
			...
			var i = n(50959),
				...
				a = (n(49406), n(21019));
			function l(e) {
				const { size: t = 'large', preservePaddings: n, isLink: i, flipIconOnRtl: s, className: l } = e;
				return o(a['nav-button'], a[`size-${t}`], n && a['preserve-paddings'], s && a['flip-icon'], i && a.link, l);
			}
			function r(e) {
			...
			(0, i.forwardRef)((e, t) => {
				...
				return i.createElement(
					c,
					{ ...a, className: l({ ...e, children: s, isLink: !0 }), reference: (0, d.isomorphicRef)(t) },
		...
		70493: (e, t, n) => {
			'use strict';
			n.r(t),
				n.d(t, { confirmModule: () => z, renameModule: () => O, showSimpleDialog: () => U, warningModule: () => L });
			var i = n(50959),
				o = n(11542),
				s = n(97754),
				a = n(64388),
									...
									i.createElement(
										...
										o &&
											...
											i.createElement(
												...
												o.map((e, t) => i.createElement(x, { ...e, key: e.name, reference: 0 === t ? N : void 0 }))
											)
									),
									S &&
			...
			function k(e) {
				...
				return i.createElement(
					...
					(function () {
						...
						if ('html' in e)
							return i.createElement('div', { className: T.label, dangerouslySetInnerHTML: { __html: e.html } });
						return null;
					})(),
			...
			const z = function (e) {
					...
					return i.createElement(S, {
						...
						onClose: s,
						actions: [
							{ name: 'yes', title: a || o.t(null, void 0, n(55512)), intent: l || 'success', handler: u },
							{
								name: 'no',
								type: 'button',
				...
				U = function (e, t, n) {
					...
					const a = document.createElement('div'),
						...
						r = (0, P.createReactRoot)(
							i.createElement(v.SlotContext.Provider, { value: n || null }, i.createElement(t, { ...e, onClose: l })),
							a
						);
		...
		82206: (e, t, n) => {
				...
				render() {
					...
					return i.createElement(
						...
						i.createElement(
							...
							{ value: this._manager },
							u && i.createElement('div', { onClick: this.props.onClickBackdrop, className: c.backdrop }),
							i.createElement(
								'div',
								{
									...p,
								...
								i.createElement(
									...
									i.createElement(
										u,
										{
											...
											className: o(
												B.dialog,
												(0, N.isOnMobileAppPage)('any') && !this.props.noMobileAppShadows && B.mobile,
					...
					if (!i.contains(document.activeElement)) {
						const e = (function (e) {
							...
							const n = (0, g.getActiveElementSelectors)(),
								i = Array.from(e.querySelectorAll(n)).filter((0, g.createScopedVisibleElementFilter)(e));
			...
			(P.contextType = D.PortalContext),
				(P.defaultProps = { boundByScreen: !0, draggable: !0, centeredOnMount: !0, shouldReturnFocus: !0 });
			...
			function s(e, t) {
				return class extends i.PureComponent {
					render() {
						...
						if (!n) return null;
						const a = i.createElement(e, { ...this.props, ref: this.props.componentRef, zIndex: 150 });
