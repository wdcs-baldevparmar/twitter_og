...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[8056],
	{
		73174: (e, t, i) => {
			...
			function m(e, t, i) {
				return { property: (0, c.convertToDefinitionProperty)(e, t.price, y), info: { typeY: 1, stepY: i } };
			}
			function _(e, t) {
				return {
		...
		53749: (e, t, i) => {
			...
			const s = new r.TranslatedString('change {toolName} line visibility', n.t(null, void 0, i(24550))),
				...
				p = new r.TranslatedString('change {toolName} line extending left', n.t(null, void 0, i(18773))),
				h = new r.TranslatedString('change {toolName} line left end', n.t(null, void 0, i(21474))),
				u = new r.TranslatedString('change {toolName} line extending right', n.t(null, void 0, i(43823))),
			...
			function m(e, t, i, n, r) {
				...
				return (
					void 0 !== t.showLine &&
						(m.checked = (0, o.convertToDefinitionProperty)(e, t.showLine, s.format({ toolName: i }))),
					void 0 !== t.lineWidth &&
						(m.width = (0, o.convertToDefinitionProperty)(e, t.lineWidth, a.format({ toolName: i }))),
					void 0 !== t.lineStyle &&
						(m.style = (0, o.convertToDefinitionProperty)(e, t.lineStyle, c.format({ toolName: i }))),
					void 0 !== t.lineColor &&
						(m.color = (0, o.getColorDefinitionProperty)(e, t.lineColor, null, d.format({ toolName: i }))),
					void 0 !== t.extendLeft &&
						((m.extendLeft = (0, o.convertToDefinitionProperty)(e, t.extendLeft, p.format({ toolName: i }))),
						(_.extendLeftTitle = (r && r.extendLeftTitle) || v)),
					void 0 !== t.leftEnd &&
						(m.leftEnd = (0, o.convertToDefinitionProperty)(e, t.leftEnd, h.format({ toolName: i }))),
					void 0 !== t.extendRight &&
						((m.extendRight = (0, o.convertToDefinitionProperty)(e, t.extendRight, u.format({ toolName: i }))),
						(_.extendRightTitle = (r && r.extendRightTitle) || g)),
					void 0 !== t.rightEnd &&
						(m.rightEnd = (0, o.convertToDefinitionProperty)(e, t.rightEnd, f.format({ toolName: i }))),
		...
		56641: (e, t, i) => {
			...
			const p = new o.TranslatedString('change {title} extend lines', r.t(null, void 0, i(76295))),
				h = new o.TranslatedString('change {title} level {index} line visibility', r.t(null, void 0, i(51403))),
				u = new o.TranslatedString('change {title} level {index} line color', r.t(null, void 0, i(664))),
				f = new o.TranslatedString('change {title} level {index} line width', r.t(null, void 0, i(97870))),
				y = new o.TranslatedString('change {title} level {index} line style', r.t(null, void 0, i(64707))),
				v = new o.TranslatedString('change {title} level {index} line coeff', r.t(null, void 0, i(27154))),
				g = new o.TranslatedString('change {title} all lines color', r.t(null, void 0, i(59577))),
				m = new o.TranslatedString('change {title} background visibility', r.t(null, void 0, i(30839))),
				_ = new o.TranslatedString('change {title} background transparency', r.t(null, void 0, i(13783))),
