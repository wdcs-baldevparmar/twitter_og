...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[7127],
	{
		...
		27172: (e, t, s) => {
			s.r(t),
				s.d(t, { LineToolTrendBasedFibTime: () => d, NumConsts: () => p, StringConsts: () => h, Versions: () => u });
			var r = s(11542),
				i = s(45126),
				n = s(29875),
				l = s(15399),
			...
			class d extends n.LineDataSource {
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([s.e(6406), s.e(3889), s.e(8009), s.e(8056), s.e(8537)]).then(s.bind(s, 46662)))
