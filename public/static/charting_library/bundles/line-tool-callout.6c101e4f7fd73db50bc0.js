			...
			class c extends d.InplaceTextLineDataSource {
					...
					switch (t) {
						...
						case 1:
							...
							if (isFinite(n) && isFinite(r)) {
								...
								const t = this._timeScale.indexToCoordinate(n + 2 * r) - this._timeScale.indexToCoordinate(n) - 8 - 2;
				...
				setPoints(t) {
					...
					if ((this._calculateBarOffset(), this._normalizePoints(), isFinite(i) && isFinite(s))) {
						const t = this._timeScale.indexToCoordinate(i + 2 * s) - this._timeScale.indexToCoordinate(i) - 8 - 2;
						if (!isFinite(t)) return;
				...
				restoreData(t) {
					t.barOffset ? (this._barOffset = t.barOffset) : this._calculateBarOffset(), this.calculatePoint2();
				}
				setPriceScale(t) {
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([i.e(6406), i.e(3889), i.e(8009), i.e(8056), i.e(8537)]).then(i.bind(i, 29908)))
