			...
			class f extends a.StudyLineDataSource {
				constructor(e, t, s, r, a) {
					super(
						e,
						(s =
							s ?? (0, i.ensureNotNull)((0, h.studyMetaInfoRepository)().findByIdSync({ type: 'java', studyId: _ }))),
						'linreg_',
				...
				static createProperties(e, t) {
					const n = r.StudyMetaInfo.getStudyPropertyRootNameById(_),
						s = (0, i.ensureNotNull)((0, h.studyMetaInfoRepository)().findByIdSync({ type: 'java', studyId: _ })),
						a = (0, u.createDefaultsState)(!0, n, [], (0, h.studyMetaInfoRepository)().studyVersioning());
				...
				_studyInputs(e) {
					...
					return null === n || null === s
						...
						: { ...this.properties().childs().inputs.state(), 'first bar time': 1e3 * n, 'last bar time': 1e3 * s };
				}
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([n.e(1190), n.e(3889), n.e(8009), n.e(4482), n.e(607)]).then(n.bind(n, 42838)))
				...
				static _configureProperties(e) {
					...
					const t = e.childs().styles.childs(),
						n = [t.upLine.childs().linewidth, t.downLine.childs().linewidth, t.baseLine.childs().linewidth];
