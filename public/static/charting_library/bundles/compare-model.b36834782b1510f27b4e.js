	...
	[7271],
	{
		...
		81319: (e, t, s) => {
			...
			class r {
				...
				name() {
					return (0, n.isAllSearchSourcesSelected)(this) ? o.t(null, void 0, s(34040)) : this._exchange.name;
				}
				description() {
		...
		56217: (e, t, s) => {
			...
			class v {
						...
						const i = Array.from(new Set(n));
						{
							...
							Promise.all(t).then((t) =>
								this._handleInitProcess(
									...
									(e, t, s, o) =>
										'symbol_resolved' === e.method ? _(e.params[1], s, o) : p(t, s, o, this._getSymbolDescription(t))
								)
							);
						}
					});
				...
				_getSymbolDescription(e) {
					return this._defaultSymbolsDescriptions.size ? (this._defaultSymbolsDescriptions.get(e) ?? '') : '';
				}
			}
			v._snapshoter = null;
		},
