	...
	[2183],
	{
					...
					for (let e = 0; e < t.length; ++e) {
						...
						if (!((0, a.isInteger)(r.pointIndex) && c.linePointBeingEdited === r.pointIndex)) {
							...
							if (
								(o(
									l,
									{ ...r, point: new n.Point(Math.round(r.point.x * d) + g, Math.round(r.point.y * u) + g) },
									P / 2,
									p
								),
				...
				_fillInformationAboutPointsAndCursors(e, t) {
					...
					this._inputs.forEach((i, o) => {
						...
						if (Array.isArray(i)) {
							...
							null !== n &&
								null !== o &&
								((d = this._convertTimeToCoordinate(n)), (u = this._convertPriceToCoordinate(o)), (c = !1));
						} else {
							const n = this._getInputValue(i.id);
							null !== n &&
								('time' === i.type
									? ((d = this._convertTimeToCoordinate(n)), (u = e / 2), (r = a.PaneCursorType.HorizontalResize))
									: ((d = t / 2), (u = this._convertPriceToCoordinate(n)), (r = a.PaneCursorType.VerticalResize)));
						}
						null !== d &&
							null !== u &&
							this._points.push(
		...
		98255: (e, t, i) => {
			...
			var n = i(19625),
				...
				l = i(95173),
				d = i(50546);
			const u = { color: n.colorsPalette['color-cold-gray-500'], linewidth: 1, linestyle: o.LINESTYLE_SOLID };
