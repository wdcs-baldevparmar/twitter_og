...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[3710],
	{
		73174: (e, t, i) => {
			...
			function y(e, t, i) {
				return { property: (0, c.convertToDefinitionProperty)(e, t.price, v), info: { typeY: 1, stepY: i } };
			}
			function m(e, t) {
				return {
					property: (0, c.convertToDefinitionProperty)(e, t.bar, _),
					info: { typeX: 0, minX: new d.WatchedValue(p), maxX: new d.WatchedValue(f), stepX: new d.WatchedValue(1) },
				};
			}
		...
		53749: (e, t, i) => {
			...
			var n = i(11542),
				...
				o = i(32097),
				l = i(91682);
			const s = new r.TranslatedString('change {toolName} line visibility', n.t(null, void 0, i(24550))),
				...
				u = new r.TranslatedString('change {toolName} line extending left', n.t(null, void 0, i(18773))),
			...
			function y(e, t, i, n, r) {
				...
				return (
					void 0 !== t.showLine &&
						(y.checked = (0, o.convertToDefinitionProperty)(e, t.showLine, s.format({ toolName: i }))),
					void 0 !== t.lineWidth &&
						(y.width = (0, o.convertToDefinitionProperty)(e, t.lineWidth, a.format({ toolName: i }))),
					void 0 !== t.lineStyle &&
						(y.style = (0, o.convertToDefinitionProperty)(e, t.lineStyle, c.format({ toolName: i }))),
					void 0 !== t.lineColor &&
						(y.color = (0, o.getColorDefinitionProperty)(e, t.lineColor, null, d.format({ toolName: i }))),
					void 0 !== t.extendLeft &&
						((y.extendLeft = (0, o.convertToDefinitionProperty)(e, t.extendLeft, u.format({ toolName: i }))),
						(m.extendLeftTitle = (r && r.extendLeftTitle) || _)),
					void 0 !== t.leftEnd &&
						(y.leftEnd = (0, o.convertToDefinitionProperty)(e, t.leftEnd, h.format({ toolName: i }))),
					...
					void 0 !== t.rightEnd &&
						(y.rightEnd = (0, o.convertToDefinitionProperty)(e, t.rightEnd, f.format({ toolName: i }))),
		...
		15399: (e, t, i) => {
			...
			class v extends l.DefaultProperty {
				...
				preferences() {
					return (0, l.extractState)(this.state(this._excludedDefaultsKeys, void 0, !0), this._allDefaultsKeys);
				}
				applyTemplate(e, t) {
					this.mergeAndFire(
						(0, l.extractState)(
		...
		72609: (e, t, i) => {
			...
			class u extends a.InplaceTextLineSourcePaneView {
				...
				_updateLabelForLevel(e) {
					...
					return l && (a += ' (' + i.formatPrice(e.price, n) + ')'), this._updateRendererLabel(e, t, a), t;
				}
				_updateRendererLabel(e, t, i) {
					if (!i && void 0 === e.decorator) return null;
					const { leftPoint: n, rightPoint: o, horzAlign: l, extendLeft: a, extendRight: c, ...u } = e,
		...
		49145: (e, t, i) => {
			...
			var n = i(50151),
				...
				p = i(91682),
				f = i(95166);
			const v = new o.TranslatedString('change {title} level {index} line visibility', r.t(null, void 0, i(51403))),
				...
				m = new o.TranslatedString('change {title} level {index} line coeff', r.t(null, void 0, i(27154))),
				P = new o.TranslatedString('change {title} all lines color', r.t(null, void 0, i(59577))),
				x = new o.TranslatedString('change {title} background visibility', r.t(null, void 0, i(30839))),
				T = new o.TranslatedString('change {title} background transparency', r.t(null, void 0, i(13783))),
				w = new o.TranslatedString('change {title} full circles visibility', r.t(null, void 0, i(30484))),
			...
			class I extends h.LineDataSourceDefinitionsViewModel {
				_stylePropertyDefinitions() {
					...
					const k = (0, u.createCheckablePropertyDefinition)(
						{
							checked: (0, u.convertToDefinitionProperty)(this._propertyApplier, t.showCoeffs, _.format({ title: l })),
						},
						{ id: `${r}Levels`, title: D }
					);
					e.push(k);
					const A = (0, u.createCheckablePropertyDefinition)(
						{
							checked: (0, u.convertToDefinitionProperty)(this._propertyApplier, t.fullCircles, w.format({ title: l })),
						},
