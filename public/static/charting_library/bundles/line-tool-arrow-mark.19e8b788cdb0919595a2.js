	...
	[569],
	{
		27621: (e, r, t) => {
			...
			class u extends l {
				...
				textAlignParams() {
					return { horzAlign: o.HorizontalAlign.Left, vertAlign: o.VerticalAlign.Middle, offsetX: 22, offsetY: 3 };
				}
			...
			class p extends l {
				...
				textAlignParams() {
					return { horzAlign: o.HorizontalAlign.Center, vertAlign: o.VerticalAlign.Top, offsetX: 0, offsetY: 20 };
				}
				static createProperties(e, r) {
			...
			class w extends l {
				...
				textAlignParams() {
					return { horzAlign: o.HorizontalAlign.Center, vertAlign: o.VerticalAlign.Bottom, offsetX: 0, offsetY: 20 };
				}
				static createProperties(e, r) {
