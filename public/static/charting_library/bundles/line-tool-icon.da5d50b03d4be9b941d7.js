	...
	[7806],
	{
		...
		15510: (e, t, i) => {
			...
			class V extends u.LineDataSourceProperty {
				constructor(e) {
					super(e), this.addChild('backgroundsColors', new v.LineToolColorsProperty([this.childs().color]));
				}
				static create(e, t, i) {
					return new this({
			...
			class _ extends o.LineToolSvgIconBase {
				...
				async _loadViews() {
					const [{ getSvgContentForCharCode: e, getSvgRenderer: t }, { IconPaneView: n }] = await Promise.all([
		...
		38039: (e, t, i) => {
			...
			class a extends r.DefaultProperty {
				...
				applyTemplate(e) {
					this.mergeAndFire(
						(0, r.extractState)((0, s.default)((0, n.default)(this._factoryDefaultsSupplier()), e), this._templateKeys)
					);
				}
			}
		},
		22329: (e, t, i) => {
			...
			class u extends l.LineDataSource {
				...
				setPoint(e, t, i) {
					const { centerPoint: n, initialLength: o, initialSize: r } = (0, s.ensureNotNull)(this._changePointData),
