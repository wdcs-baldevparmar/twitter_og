(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[769],
	{
				...
				(u = function (d) {
					...
					var n =
						...
						l = function (d) {
							...
							return !!i(e.target) || 1 < e.touches.length || (e.preventDefault && e.preventDefault(), !1);
						},
						s = function () {
							setTimeout(function () {
						...
						if (n) {
							...
							if (
								...
								(c = [].concat(e(c), [s])),
									...
									o || (document.addEventListener('touchmove', l, u ? { passive: !1 } : void 0), (o = !0));
							}
						} else {
							(v = t),
								setTimeout(function () {
									if (void 0 === f) {
										...
										d &&
											0 < e &&
											((f = document.body.style.paddingRight), (document.body.style.paddingRight = e + 'px'));
									}
						...
						(d.clearAllBodyScrollLocks = function () {
							n
								? (c.forEach(function (d) {
									...
									o && (document.removeEventListener('touchmove', l, u ? { passive: !1 } : void 0), (o = !1)),
									(c = []),
									(r = -1))
								: (s(), (c = []));
						}),
						(d.enableBodyScroll = function (d) {
							if (n) {
								...
								(d.ontouchstart = null),
									...
									o &&
										0 === c.length &&
										(document.removeEventListener('touchmove', l, u ? { passive: !1 } : void 0), (o = !1));
							} else
		...
		34314: (d) => {
			d.exports = { wrapper: 'wrapper-M14KUVdG', emojiItem: 'emojiItem-M14KUVdG', hovered: 'hovered-M14KUVdG' };
		},
		25474: (d) => {
			d.exports = { wrapper: 'wrapper-hoWtpNyh', isActive: 'isActive-hoWtpNyh', button: 'button-hoWtpNyh' };
		},
		7110: (d) => {
		...
		59369: (d, e, u) => {
					...
					(0, t.useLayoutEffect)(() => {
						const d = (0, n.ensureNotNull)(e.current),
							u = () => {
								...
								if (0 === u.length || (u[0].parentElement && !m(u[0].parentElement, (0, n.ensureNotNull)(e.current)))) {
									const t = (function (d) {
									...
									if (null === t) return;
									if (((0, r.becomeMainElement)(t), u.length > 0)) for (const d of u) (0, r.becomeSecondaryElement)(d);
								}
							};
						return (
						...
						function (e) {
							...
							if (d) {
								...
								Array.from(m.querySelectorAll('button:not([disabled]):not([aria-disabled])')).filter(
									(0, a.createScopedVisibleElementFilter)(m)
								)).sort(c.navigationOrderComparator)),
									(i = r.indexOf(t));
							var m;
			...
			function s(d) {
				return Array.from(d.querySelectorAll('[data-role="row"]')).filter((0, a.createScopedVisibleElementFilter)(d));
			}
			function m(d, e) {
		...
		37558: (d, e, u) => {
			...
			class c extends t.PureComponent {
				...
				componentDidUpdate(d, e) {
					!e.stack.length && this.state.stack.length && ((0, n.setFixedBodyState)(!0), (this._isBodyFixed = !0)),
						e.stack.length &&
		...
		41590: (d, e, u) => {
			...
			var s;
			function m(d) {
				const { position: e = 'Bottom', onClose: u, children: i, reference: s, className: m, theme: h = l } = d,
				...
				return (
					...
					t.createElement(
						...
						t.createElement(
							...
							p === b.currentDrawer && t.createElement('div', { className: l.backdrop, onClick: u }),
							t.createElement(
								v,
								{ className: c(h.drawer, l[`position${e}`], m), ref: g, 'data-name': d['data-name'] },
								i
							)
						)
					)
			...
			const v = (0, t.forwardRef)((d, e) => {
				...
				return t.createElement(i.TouchScrollContainer, { className: c(l.drawer, u), tabIndex: -1, ref: e, ...n });
			});
		},
		88160: (d, e, u) => {
			'use strict';
		...
		47291: (d, e, u) => {
			...
			function b(d) {
				...
				return t.createElement(
					h.Provider,
					{ value: (0, t.useMemo)(() => ({ size: o, onSelect: r, ItemComponent: f, RowComponent: i }), [o, r, f, i]) },
			...
			const p = t.memo((d) => {
				const { style: e, index: u, data: n } = d,
					c = n[u],
					{ size: o, onSelect: r, ItemComponent: l, RowComponent: s = f.EmojisRow } = (0, i.useEnsuredContext)(h);
				return 'title' === c.type
					? t.createElement('div', { style: e }, t.createElement(a, { title: c.relatedTitle }))
					: t.createElement(
							'div',
							{ style: e },
							t.createElement(s, { emojis: c.content, itemSize: o, onEmojiClick: r, ItemComponent: l })
						);
			});
		},
		38297: (d, e, u) => {
							...
							(function (d, e) {
								...
								return (
									d.forEach(({ title: d, emojis: t }) => {
										...
										let n = [];
										for (const c of t)
											n.length < e ? n.push(c) : (u.push({ type: 'emojiRow', relatedTitle: d, content: n }), (n = [c]));
			...
			function l(d) {
				...
				return t.createElement(
					...
					u.map(({ title: d, content: u }) =>
						t.createElement(f, { key: d, tab: d, className: a, isActive: e === d, onTabClick: n }, u)
					)
				);
			}
		},
		...
		43790: (d, e, u) => {
			...
			const f = 34;
			function i(d) {
				const { className: e, emoji: u, size: n = f, onClick: i, ItemComponent: l = o.EmojiItem } = d,
		...
		57177: (d, e, u) => {
			...
			u.d(e, { becomeMainElement: () => n, becomeSecondaryElement: () => c }),
				(function (d) {
					(d.MainElement = 'roving-tabindex:main-element'), (d.SecondaryElement = 'roving-tabindex:secondary-element');
				})(t || (t = {}));
		},
		6190: (d, e, u) => {
			'use strict';
			...
			const l = (0, t.forwardRef)(function (d, e) {
				const { onKeyDown: u, orientation: l, blurOnEscKeydown: s = !0, blurOnClick: m = !0, ...v } = d,
		...
		19365: (d, e, u) => {
			...
			function n(d, e) {
				let u = '';
				return (
					t.default.parse(d, (d) => ((u = t.default.base + ('svg' === e ? `svg/${d}.svg` : `72x72/${d}.png`)), !1)), u
				);
			}
			...
			const t = (function () {
				...
				function m(d, e) {
					for (var t, n, c, o, r, f, i, m, v, h, b, p, g, w = l(d, []), E = w.length; E--; ) {
						for (c = !1, o = document.createDocumentFragment(), f = (r = w[E]).nodeValue, m = 0; (i = u.exec(f)); ) {
							if (
								...
								(t = e.attributes(b, p))))
									t.hasOwnProperty(n) && 0 !== n.indexOf('on') && !h.hasAttribute(n) && h.setAttribute(n, t[n]);
								(h.className = e.className), (h.alt = b), (h.src = g), (c = !0), o.appendChild(h);
							}
							h || o.appendChild(a(b, !1)), (h = null);
						}
						c && (m < f.length && o.appendChild(a(f.slice(m), !0)), r.parentNode.replaceChild(o, r));
					}
					return d;
				}
				function v(d, e) {
