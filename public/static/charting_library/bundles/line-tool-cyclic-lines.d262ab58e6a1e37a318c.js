	...
	[9445],
	{
		...
		53749: (e, t, i) => {
			...
			var n = i(11542),
				...
				r = i(32097),
				s = i(91682);
			const l = new o.TranslatedString('change {toolName} line visibility', n.t(null, void 0, i(24550))),
				...
				h = new o.TranslatedString('change {toolName} line extending left', n.t(null, void 0, i(18773))),
				u = new o.TranslatedString('change {toolName} line left end', n.t(null, void 0, i(21474))),
				p = new o.TranslatedString('change {toolName} line extending right', n.t(null, void 0, i(43823))),
			...
			function S(e, t, i, n, o) {
				...
				return (
					void 0 !== t.showLine &&
						(S.checked = (0, r.convertToDefinitionProperty)(e, t.showLine, l.format({ toolName: i }))),
					void 0 !== t.lineWidth &&
						(S.width = (0, r.convertToDefinitionProperty)(e, t.lineWidth, a.format({ toolName: i }))),
					void 0 !== t.lineStyle &&
						(S.style = (0, r.convertToDefinitionProperty)(e, t.lineStyle, d.format({ toolName: i }))),
					void 0 !== t.lineColor &&
						(S.color = (0, r.getColorDefinitionProperty)(e, t.lineColor, null, c.format({ toolName: i }))),
					void 0 !== t.extendLeft &&
						((S.extendLeft = (0, r.convertToDefinitionProperty)(e, t.extendLeft, h.format({ toolName: i }))),
						(v.extendLeftTitle = (o && o.extendLeftTitle) || m)),
					void 0 !== t.leftEnd &&
						(S.leftEnd = (0, r.convertToDefinitionProperty)(e, t.leftEnd, u.format({ toolName: i }))),
					void 0 !== t.extendRight &&
						((S.extendRight = (0, r.convertToDefinitionProperty)(e, t.extendRight, p.format({ toolName: i }))),
						(v.extendRightTitle = (o && o.extendRightTitle) || g)),
					void 0 !== t.rightEnd &&
						(S.rightEnd = (0, r.convertToDefinitionProperty)(e, t.rightEnd, _.format({ toolName: i }))),
		...
		9093: (e, t, i) => {
			...
			class p extends a.LineSourcePaneView {
				...
				_updateImpl(e) {
					...
					if (null === a) return;
					if (l > 0) {
						for (let e = n.index; e <= a.lastBar(); e += l) this._coordinates.push(t.indexToCoordinate(e));
					} else {
						for (let e = n.index; e >= a.firstBar(); e += l) this._coordinates.push(t.indexToCoordinate(e));
					}
			...
			class I extends y.LineDataSourceProperty {
				constructor(e) {
					super(e),
						this.addChild('linesColors', new T.LineToolColorsProperty([(0, f.ensureDefined)(this.child('linecolor'))])),
						this.addChild('linesWidths', new T.LineToolWidthsProperty([(0, f.ensureDefined)(this.child('linewidth'))]));
				}
				static create(e, t) {
					return new this({
		...
		27916: (e, t, i) => {
			i.d(t, { LineSourcePaneView: () => f, createLineSourcePaneViewPoint: () => _, thirdPointCursorType: () => p });
			var n = i(19625),
				o = i(50151),
				r = i(69186),
				s = i(56468),
		...
		38039: (e, t, i) => {
			...
			class l extends s.DefaultProperty {
				...
				applyTemplate(e) {
					this.mergeAndFire(
						(0, s.extractState)((0, o.default)((0, n.default)(this._factoryDefaultsSupplier()), e), this._templateKeys)
					);
				}
			}
		},
		36036: (e, t, i) => {
			...
			function u(e, t, i, n) {
				const { point: o } = t,
					r = i + n / 2;
				(0, s.drawRoundRect)(e, o.x - r, o.y - r, 2 * r, 2 * r, (i + n) / 2), e.closePath(), (e.lineWidth = n);
			}
			function p(e, t, i, n) {
					...
					for (let e = 0; e < t.length; ++e) {
						...
						if (!((0, l.isInteger)(r.pointIndex) && h.linePointBeingEdited === r.pointIndex)) {
							...
							if (
								(o(
									a,
									{ ...r, point: new n.Point(Math.round(r.point.x * d) + m, Math.round(r.point.y * c) + m) },
									f / 2,
									p
								),
