			...
			class d extends a.InplaceTextLineDataSource {
				constructor(e, t, n, s) {
					super(e, t ?? d.createProperties(e.backgroundTheme().spawnOwnership()), n, s),
						...
						this.setAdditionalCursorData(this._additionalCursorData.bind(this), this._positionToCoordinate.bind(this));
				}
				destroy() {
				...
				paneViews(e) {
					if (((e = (0, n.ensureDefined)(e)), !this.isMultiPaneEnabled() && this._model.paneForSource(this) !== e))
						return null;
