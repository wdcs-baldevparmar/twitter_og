	...
	[7078],
	{
		...
		56080: (e, t, i) => {
			...
			class W extends l.PureComponent {
				constructor(e) {
					super(e),
						...
						(this._handleApplyDefaults = () => {
							...
							(0, w.loadTheme)(t, { themeName: i, standardTheme: !0, applyOverrides: !0, onlyActiveChart: !0 });
						}),
						(this._handleSaveAs = () => {
							if (F) {
						...
						(this._handleListboxFocus = (e) => {
							e.target instanceof HTMLElement && (0, x.handleAccessibleMenuFocus)(e, this._reference);
						}),
				...
				_getThemeItems(e) {
					const { isApplyToAllVisible: t, chartWidgetCollection: i, applyToAllCallback: n } = this.props,
						{ themes: a } = this.state;
					return l.createElement(
						l.Fragment,
						null,
				...
				constructor(e) {
					super(e),
						(this._renderChildren = ({ requestResize: e, isSmallWidth: t }) => (
							...
							l.createElement('div', { className: le.content }, this._renderTabs(t), this._renderTabContent(t))
						)),
						...
						(this._selectPage = (e, t) => {
							...
							e !== i &&
								...
								null !== e &&
									(t || h().setValue(ae, e.id), e.definitions.subscribe(this._onChangeActivePageDefinitions)),
			...
			class ue extends re.DialogRenderer {
				constructor(e) {
					super(),
						(this._handleClose = () => {
							this._rootInstance?.unmount(), this._setVisibility(!1), this._onClose && this._onClose();
						}),
						(this._handleSubmit = () => {}),
						(this._handleCancel = () => {
