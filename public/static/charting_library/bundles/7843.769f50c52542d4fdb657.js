		...
		27267: (e, o, t) => {
			...
			function l(e, o, t, l, i) {
				function n(i) {
					...
					const n = i.target;
					void 0 !== t && null !== o && null !== n && n.ownerDocument === l && (o.contains(n) || t(i));
				}
				return (
			...
			function d(e) {
				...
				return l.createElement(
					Y,
					{
						...
						id: o,
						role: t,
						className: i(h, R.item, p && R.withIcon, { [R.isActive]: x, [R.isDisabled]: T || b, [R.hovered]: z }),
						title: d,
						href: A,
						target: k,
						rel: P,
					...
					(void 0 !== w || f) &&
						l.createElement('span', { className: R.shortcut }, (ee = w) && ee.split('+').join(' + ')),
					void 0 !== E &&
						l.createElement(
							'span',
							{
			...
			function h(e) {
				...
				return l.createElement(s.PopupMenuItem, {
					...
					onKeyDown: function (e) {
						...
						(13 !== o && 32 !== o) || (e.preventDefault(), i.current instanceof HTMLElement && i.current.click());
					},
					'data-role': 'menuitem',
		...
		2627: (e, o, t) => {
			...
			const d = (0, h.humanReadableModifiers)(h.Modifiers.Shift, !1).trim(),
				...
				p = {
					...
					LineToolGannFixed: {},
					LineToolGannFan: {},
					LineToolGannSquare: { hotKey: (0, n.hotKeySerialize)({ keys: [d], text: i.t(null, void 0, t(83042)) }) },
					LineToolHeadAndShoulders: {},
					LineToolHorzLine: { hotKey: (0, n.hotKeySerialize)({ keys: [u, 'H'], text: '{0} + {1}' }) },
					LineToolHorzRay: {},
					LineToolIcon: {},
					LineToolImage: {},
					LineToolEmoji: {},
					...
					LineToolProjection: {},
					LineToolRay: {},
					LineToolRectangle: { hotKey: (0, n.hotKeySerialize)({ keys: [d], text: i.t(null, void 0, t(10539)) }) },
					LineToolCircle: {},
					...
					LineToolVertLine: { hotKey: (0, n.hotKeySerialize)({ keys: [u, 'V'], text: '{0} + {1}' }) },
					LineToolCrossLine: {},
					LineToolHighlighter: {},
					LineToolGhostFeed: {},
					LineToolTable: {},
					...
					cursor: {},
					dot: {},
					demonstration: { hotKey: (0, n.hotKeySerialize)({ keys: [u], text: i.t(null, void 0, t(42633)) }) },
					...
					measure: { hotKey: (0, n.hotKeySerialize)({ keys: [d], text: i.t(null, void 0, t(92949)) }) },
			...
			Object.entries(p)
				.map(([e, o]) => {
					...
					return { ...o, name: e, icon: t, localizedName: i, selectHotkey: v.lineToolsSelectHotkeys[e] };
				})
				.forEach((e) => {
					L[e.name] = e;
				});
