	...
	[4273],
	{
		...
		42214: (e, t, s) => {
			...
			const m = { ...u.nonThemedFactoryDefaultsBase, extendTop: !1, extendBottom: !1 },
				...
				f = [...new Set([...y, ...p, ...c.commonLineToolPropertiesStateKeys, ...u.allPropertiesStateKeysBase])];
			...
			class b extends r.LineDataSource {
				...
				async _getPropertyDefinitionsViewModelClass() {
					return (await Promise.all([s.e(6406), s.e(3889), s.e(8009), s.e(8056), s.e(8537)]).then(s.bind(s, 14336)))
		...
		38039: (e, t, s) => {
			...
			class a extends l.DefaultProperty {
				...
				applyTemplate(e) {
					this.mergeAndFire(
						(0, l.extractState)((0, r.default)((0, i.default)(this._factoryDefaultsSupplier()), e), this._templateKeys)
					);
				}
			}
		},
