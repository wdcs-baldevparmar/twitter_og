...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[319],
	{
		73174: (e, t, i) => {
			...
			function _(e, t, i) {
				return { property: (0, c.convertToDefinitionProperty)(e, t.price, g), info: { typeY: 1, stepY: i } };
			}
			function T(e, t) {
				return {
					property: (0, c.convertToDefinitionProperty)(e, t.bar, x),
					info: { typeX: 0, minX: new h.WatchedValue(p), maxX: new h.WatchedValue(m), stepX: new h.WatchedValue(1) },
				};
			}
		...
		91335: (e, t, i) => {
			...
			var o = i(11542),
				...
				r = i(32097),
				l = i(91682);
			const s = new n.TranslatedString('change {toolName} text visibility', o.t(null, void 0, i(56634))),
				...
				d = new n.TranslatedString('change {toolName} text font italic', o.t(null, void 0, i(42694))),
				u = new n.TranslatedString('change {toolName} text', o.t(null, void 0, i(66668))),
				p = new n.TranslatedString('change {toolName} labels alignment vertical', o.t(null, void 0, i(31689))),
				m = new n.TranslatedString('change {toolName} labels alignment horizontal', o.t(null, void 0, i(88277))),
				g = new n.TranslatedString('change {toolName} labels direction', o.t(null, void 0, i(61160))),
				x = new n.TranslatedString('change {toolName} text background visibility', o.t(null, void 0, i(31133))),
				f = new n.TranslatedString('change {toolName} text background color', o.t(null, void 0, i(22231))),
				_ = new n.TranslatedString('change {toolName} text border visibility', o.t(null, void 0, i(58704))),
				T = new n.TranslatedString('change {toolName} text border width', o.t(null, void 0, i(35423))),
				b = new n.TranslatedString('change {toolName} text border color', o.t(null, void 0, i(36666))),
			...
			function P(e, t, i, o) {
				...
				if (
					...
					void 0 !== t.bold && (n.bold = (0, r.convertToDefinitionProperty)(e, t.bold, h.format({ toolName: i }))),
					void 0 !== t.italic &&
					...
					void 0 !== t.textOrientation &&
						(n.orientation = (0, r.convertToDefinitionProperty)(e, t.textOrientation, g.format({ toolName: i }))),
					...
					void 0 !== t.backgroundTransparency && (o = t.backgroundTransparency),
						(n.backgroundColor = (0, r.getColorDefinitionProperty)(e, t.backgroundColor, o, f.format({ toolName: i })));
				}
				return (
					...
					void 0 !== t.borderVisible &&
						(n.borderVisible = (0, r.convertToDefinitionProperty)(e, t.borderVisible, _.format({ toolName: i }))),
					void 0 !== t.borderWidth &&
						(n.borderWidth = (0, r.convertToDefinitionProperty)(e, t.borderWidth, T.format({ toolName: i }))),
					void 0 !== t.borderColor &&
						(n.borderColor = (0, r.getColorDefinitionProperty)(e, t.borderColor, null, b.format({ toolName: i }))),
		...
		23720: (e, t, i) => {
			...
			var o = i(50151),
				...
				h = i(91682),
				d = i(95166);
			const u = new r.TranslatedString('change {title} level {index} line visibility', n.t(null, void 0, i(51403))),
				p = new r.TranslatedString('change {title} level {index} line color', n.t(null, void 0, i(664))),
				m = new r.TranslatedString('change {title} level {index} line width', n.t(null, void 0, i(97870))),
				g = new r.TranslatedString('change {title} level {index} line style', n.t(null, void 0, i(64707))),
				x = new r.TranslatedString('change {title} level {index} line coeff', n.t(null, void 0, i(27154))),
				f = new r.TranslatedString('change {title} all lines color', n.t(null, void 0, i(59577))),
				_ = new r.TranslatedString('change {title} background visibility', n.t(null, void 0, i(30839))),
				T = new r.TranslatedString('change {title} background transparency', n.t(null, void 0, i(13783))),
				...
				P = [
					{ id: a.VerticalAlign.Bottom, value: a.VerticalAlign.Top, title: n.t(null, void 0, i(97118)) },
					{ id: a.VerticalAlign.Middle, value: a.VerticalAlign.Middle, title: n.t(null, void 0, i(68833)) },
					{ id: a.VerticalAlign.Top, value: a.VerticalAlign.Bottom, title: n.t(null, void 0, i(27567)) },
				],
				S = [
					{ id: a.HorizontalAlign.Left, value: a.HorizontalAlign.Left, title: n.t(null, void 0, i(11626)) },
					{ id: a.HorizontalAlign.Center, value: a.HorizontalAlign.Center, title: n.t(null, void 0, i(24197)) },
					{ id: a.HorizontalAlign.Right, value: a.HorizontalAlign.Right, title: n.t(null, void 0, i(50421)) },
				];
			class V extends s.LineDataSourceDefinitionsViewModel {
				_stylePropertyDefinitions() {
					...
					const D = (0, l.createTwoOptionsPropertyDefinition)(
						{
							checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.showLabels, b.format({ title: s })),
						...
						{ id: `${n}Labels`, title: w, optionsItems1: new c.WatchedValue(S), optionsItems2: new c.WatchedValue(P) }
					);
		...
		95166: (e, t, i) => {
			...
			class r extends n.Property {
				...
				unsubscribe(e, t) {
					const i = (0, o.ensureDefined)(this._listenersMappers.find((i) => i.obj === e && i.method === t)?.callback);
		...
		38039: (e, t, i) => {
			...
			class s extends l.DefaultProperty {
				...
				applyTemplate(e) {
					this.mergeAndFire(
						(0, l.extractState)((0, n.default)((0, o.default)(this._factoryDefaultsSupplier()), e), this._templateKeys)
					);
				}
			}
		},
		56176: (e, t, i) => {
			...
			const { colorWhite: A, colorColdGray200: R, colorColdGray650: H, colorColdGray900: W } = c.colors,
				E = {
				...
				k = [...new Set([...M, ...N, 'rowsCount', 'colsCount', 'cells.*', 'columnWidths.*', 'rowHeights.*'])],
			...
			class F extends g.LineDataSourceProperty {
				constructor(e) {
					if ((super(e), (this._tableTextCache = new y(14)), !e.state)) {
						...
						this.recreateCellsPropsByState({ rowsCount: e, colsCount: t, cells: i, columnWidths: o, rowHeights: n });
					}
					this.addChild('linesColors', new _.LineToolColorsProperty([(0, o.ensureDefined)(this.child('borderColor'))])),
						this.addChild('textsColors', new _.LineToolColorsProperty([(0, o.ensureDefined)(this.child('textColor'))])),
						this.addChild(
							'backgroundsColors',
						...
						f = u / i;
					{
						...
						for (const i of c.cells) {
							const { bottom: o, rowIndex: l } = i[0],
								s = o / r;
							if (
								((t = (0, Q.pointInBox)(e, (0, n.box)((0, n.point)(g, s - d), (0, n.point)(f, s + d))) ? l : null),
								null !== t)
							)
								break;
						}
						for (const t of c.cells[0]) {
							const { right: o, columnIndex: r } = t,
								l = o / i;
							if (
								((h = (0, Q.pointInBox)(e, (0, n.box)((0, n.point)(l - d, m), (0, n.point)(l + d, x))) ? r : null),
								null !== h)
							)
								break;
						}
						if (s && (null !== h || null !== t)) {
							...
							return new $.HitTestResult(
								a && h !== l.column && t !== l.row ? $.HitTarget.MovePoint : $.HitTarget.ChangePoint,
								{ cursorType: i, activeItem: e, pointIndex: (0, o.ensureNotNull)(ne(e)), nonDiscreteIndex: !0 }
							);
						}
					}
			...
			class ae extends X.InplaceTextLineSourcePaneView {
				constructor(e, t, i, o, r, l) {
					super(e, t, o, r, l),
						...
						(this._tryActivateEditMode = (e, t) => {
							this.closeTextEditor(), this._source.setInplaceEditableCellIndexes(e), super._tryActivateEditMode(e, t);
						}),
						...
						this._source.setAdditionalCursorData(
							() => {
								...
								return e
									...
									: { color: this._source.editableTextStyle().cursorColor, lineSpacing: 0, lineHeight: 0 };
							},
							(e) => {
				...
				renderer(e) {
					return (this._lastRenderingInfo = e), this._invalidated && this._updateImpl(e), this._renderer;
				}
				lastRenderingInfo() {
				...
				_updateImpl(e) {
					...
					if (!this._points || (this._source.isFixed() && void 0 === this._source.fixedPoint())) return;
					const i = this._source.isFixed() ? [(0, o.ensureDefined)(this._source.fixedPoint())] : this._points;
					...
					if (
						(a ? this._source.model().selection().dataSources()[0] : this._source.model().hoveredSource()) ===
						this._source
					) {
					...
					(this._anchorPoints[O.TopLeft].point = (0, n.point)(_, T)),
						...
						this._renderer.append(
							this.createLineAnchor({ points: this._anchorPoints, clickHandler: this._anchorClickHandler }, 0)
						),
				...
				_activateEditMode(e) {
					...
					const t = this._getTextEditableRenderer();
					null !== t && (t.setCursorType(this._textCursorType()), this._updateInplaceText(t.getTextInfo()));
				}
						...
						if (
							...
							for (let o = 0; o < t.texts.length; o++) {
								...
								for (let e = 0; e < n.length; e++) {
									const i = (0, X.inplaceEditHandlers)(this._tryActivateEditMode.bind(this, [o, e]));
									l.push(i),
										r.push(
							...
							t.texts.forEach((e, l) => {
								e.forEach((e, s) => {
									...
									r === a &&
										...
										a.isOutOfScreen(n, i) ? this.closeTextEditor() : this._updateInplaceText(a.getTextInfo())),
										a.setData(c),
				...
				_setTextRendererPositions(e, t) {
					...
					this._cellsTextRenderers.forEach((t, l) => {
						t.forEach((t, s) => {
							...
							t.setPoint((0, n.point)((a + ('right' === i ? c - a : 'center' === i ? (c - a) / 2 : 0)) / o, h / r));
							const u = t.data();
							null !== u &&
								t.setData({ ...u, boxWidth: (c - a) / o - 1, boxHeight: Math.max((d - h) / r, t.measure().height) });
						});
					});
				}
				_rawPrecalculatedData(e, t) {
					const i = this._cellsTextRenderers.map((t, i) =>
						...
						o = e.columnWidths.map((i, o) => D(e.leftTop.x, e.columnWidths, o, t.horizontalPixelRatio)),
						r = i.map((o, n) => D(e.leftTop.y, i, n, t.verticalPixelRatio)),
						l = i.map((t, i) =>
							e.columnWidths.map((t, n) => {
								const [l, s] = o[n],
									[a, c] = r[i];
								return { left: l, right: s, top: a, bottom: c, columnIndex: n, rowIndex: i, text: e.texts[i][n] };
							})
						);
					return {
			...
			var ce = i(11542),
				...
				ge = i(64147),
				xe = i(23720);
			const fe = new he.TranslatedString('change {title} background color', ce.t(null, void 0, i(49765))),
				_e = new he.TranslatedString('change {title} border color', ce.t(null, void 0, i(69437))),
				Te = new he.TranslatedString('change {title} texts alignment', ce.t(null, void 0, i(71665))),
			...
			class Oe extends a.InplaceTextLineDataSource {
				...
				async additionalActions(e, t = 'Default') {
					...
					return (
						'Default' === t &&
							(o = (await Promise.all([i.e(1629), i.e(620)]).then(i.bind(i, 99758))).tableActions(this, e)),
						{ actions: o, placement: 'BeforeAll' }
					);
				}
				editableTextProperties() {
					return { text: this.properties().childs().editableText, textColor: this.properties().childs().textColor };
				}
				cellText(e, t) {
				...
				changePointUndoText(e) {
					...
					return null === t && null === i ? s.changePointUndoText : null === t ? ke : null === i ? Be : Fe;
				}
				startChanging(e, t) {
				...
				setPoint(e, t, i, r) {
					...
					switch (e) {
						case O.TopLeft:
							R ? this.addFixedPoint(u) : this._setPoint(0, { ...t, price: W, index: H, interval: c }),
								r ||
									(this._properties.setColumnWidthValues(this._correctColumnWidths(Ne(g, x, p + E), h)),
					...
					if (e >= O.ResizeVirtualAnchorBase) {
						...
						if (null !== i) {
							...
							for (let e = 0; e < g.length; e++)
								t = Math.max(t, S(this.cellText(i, e), P(g[e], this._tableTextCache), this._tableTextCache));
					...
					const t = this.properties().rowHeightValues(),
						...
						n = t.map((t, n) => {
							...
							for (let e = 0; e < this.properties().childs().colsCount.value(); e++) {
								const t = S(this.cellText(n, e), P(i[e], this._tableTextCache), this._tableTextCache);
				...
				_changeEditableTextUndoCommand(e, t) {
					return new Ie(this._model, this, e, t, (0, o.ensureNotNull)(this._inplaceEditCellIndexes));
				}
				async _getPropertyDefinitionsViewModelClass() {
					return we;
				}
				_createDataSourceBackgroundColorWV() {
					return (0, l.convertPropertyToWatchedValue)(this.properties().childs().backgroundColor).ownership();
				}
				static _addCollectedProperties(e) {}
				_topLeftPoint() {
					return this.isFixed()
						? (0, o.ensureNotNull)(this.screenPointToPoint((0, o.ensureDefined)(this._fixedPoint), !0))
						: this._points[0];
				}
				_correctColumnWidths(e, t) {
					const i = (this._tablePaneView?.lastRenderingInfo() ?? Ve.dpr1PixelRatioInfo).horizontalPixelRatio,
