			...
			class v extends n.PureComponent {
				constructor(e) {
					super(e),
						...
						(this._handleMeasure = ({ callback: e, forceRecalcPosition: t } = {}) => {
							...
							const d = i.height > c;
							if (d) {
								((0, r.ensureNotNull)(this._scrollWrapRef).style.overflowY = 'scroll'), (i = n.getBoundingClientRect());
							}
							const { width: h, height: p } = i,
								m =
									'function' == typeof s
										? s({ contentWidth: h, contentHeight: p, availableWidth: a, availableHeight: o })
										: s,
				...
				render() {
					const {
						...
						{ appearingMenuHeight: R, appearingMenuWidth: M, appearingPosition: W, isMeasureValid: T } = this.state,
						O = {
							...
							n.createElement(
								...
								n.createElement(
									...
									n.createElement(
										'div',
										{
											className: o()(g.scrollWrap, !this.props.noMomentumBasedScroll && g.momentumBased),
				...
				return n.createElement(
					'div',
					{
						...
						onMouseOver: function (e) {
							if (!(null !== t.current && e.target instanceof Node && ((n = e.target), s.current?.contains(n)))) return;
							var n;
