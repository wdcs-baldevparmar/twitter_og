	...
	[3999],
	{
		...
		36189: (e, t, n) => {
			...
			function d(e) {
				const { className: t, isFilled: n, isActive: r, onClick: d, title: v, ...h } = e,
					...
					f = v ?? (n ? i.removeTitlesMap[i.RemoveTitleType.Remove] : i.removeTitlesMap[i.RemoveTitleType.Add]);
				return (
					(0, o.useLayoutEffect)(() => {
						const e = p.current;
					...
					o.createElement(a.Icon, {
						...h,
						className: l()(m.favorite, 'apply-common-tooltip', n && m.checked, r && m.active, g && m.focused, t),
						onClick: d,
						icon: n ? s : u,
						title: f,
						ariaLabel: f,
			...
			function d(e) {
				...
				return o.createElement(
					X,
					{
						...
						id: t,
						role: n,
						className: r(u, S.item, x && S.withIcon, { [S.isActive]: b, [S.isDisabled]: w || C, [S.hovered]: M }),
						title: d,
						href: z,
						target: A,
						rel: F,
					...
					(void 0 !== g || f) &&
						o.createElement('span', { className: S.shortcut }, (ee = g) && ee.split('+').join(' + ')),
					void 0 !== y &&
						o.createElement(
							'span',
							{
		...
		96040: (e, t, n) => {
			...
			function m(e) {
				...
				return r.createElement(i.Icon, {
					...f,
					'data-name': p,
					className: a()(u.button, 'apply-common-tooltip', l && u.active, h && u.hidden, E && u.focused, t),
					icon: g || s,
					onClick: m,
					onMouseDown: d,
		...
		19365: (e, t, n) => {
			...
			function r(e, t) {
				let n = '';
				return (
					o.default.parse(e, (e) => ((n = o.default.base + ('svg' === t ? `svg/${e}.svg` : `72x72/${e}.png`)), !1)), n
				);
			}
