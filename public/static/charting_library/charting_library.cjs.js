...
(exports.ActionId = void 0),
	...
	(function (e) {
		(e.Stocks = 'stocks'), (e.Futures = 'futures'), (e.Forex = 'forex'), (e.Crypto = 'crypto'), (e.Others = 'others');
	})(v || (v = {})),
	(function (e) {
		e.Symbol = 'symbol';
	})(f || (f = {})),
	...
	((D = exports.ConnectionStatus || (exports.ConnectionStatus = {}))[(D.Connected = 1)] = 'Connected'),
	...
	((z = exports.OrderTicketFocusControl || (exports.OrderTicketFocusControl = {}))[(z.LimitPrice = 1)] = 'LimitPrice'),
	...
	((q = exports.OrderOrPositionMessageType || (exports.OrderOrPositionMessageType = {})).Information = 'information'),
	(q.Warning = 'warning'),
	(q.Error = 'error'),
	(function (e) {
	...
	((ge = exports.TradedGroupHorizontalAlignment || (exports.TradedGroupHorizontalAlignment = {}))[(ge.Left = 0)] =
		'Left'),
...
const Ve = class {
	...
	async _create() {
		const e = this._options.enabled_features?.includes('iframe_loading_same_origin') ?? !1,
			t = e || (this._options.enabled_features?.includes('iframe_loading_compatibility_mode') ?? !1),
...
'undefined' != typeof window && ((window.TradingView = window.TradingView || {}), (window.TradingView.version = ke));
const Fe =
